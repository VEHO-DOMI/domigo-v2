# Grammar generation brief — g4-u04 (MORE! 4, Unit 4)

<!-- domigo:gen grammar g4-u04 bank=ed0525f1c242 prompt=4b9164076103 -->
...
### `g4u04.s.reported-questions` — Questions in reported speech (Indirekte Fragen)

Reporting questions: drop do/does/did, change the tense one step back as in reported statements, and use statement word order. Keep the question word for wh-questions; use if (or whether) for yes/no questions.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [no-do-statement-order]: In reported questions there is no do/does/did and no inversion. Use statement word order (subject before verb) and backshift the tense, just like in reported statements (Unit 3).
  - DE: In indirekten Fragen gibt es kein do/does/did und keine Inversion. Verwende die Aussagesatz-Wortstellung (Subjekt vor Verb) und verschiebe die Zeit zurück, genau wie in der indirekten Rede (Unit 3).
  - ""Where do you live?" -> She asked me where I lived." — ""Wo wohnst du?" -> Sie fragte mich, wo ich wohnte."
  - ""Why do you have a dog with you?" -> He asked me why I had a dog with me." — ""Warum hast du einen Hund dabei?" -> Er fragte mich, warum ich einen Hund dabeihatte."
- rule [keep-question-word]: For wh-questions, keep the question word (why, where, who, when, how, what) and follow it with subject + backshifted verb.
  - DE: Bei W-Fragen behältst du das Fragewort (why, where, who, when, how, what) und stellst danach Subjekt + zurückverschobenes Verb.
  ...
  - ""When can you start?" -> They asked me when I could start." — ""Wann kannst du anfangen?" -> Sie fragten mich, wann ich anfangen könnte."
- rule [if-for-yes-no]: For yes/no questions, use if (or whether) and backshift the tense (German: ob ...).
  - DE: Bei Ja/Nein-Fragen verwendest du if (oder whether) und verschiebst die Zeit zurück (deutsch: ob ...).
  - ""Do you like working with people?" -> He asked me if I liked working with people." — ""Arbeitest du gern mit Menschen?" -> Er fragte mich, ob ich gern mit Menschen arbeitete."
...
common errors:
- Keeping question word order (inversion) in the reported question: ✗ "He asked where did I work." → ✓ "He asked where I worked."
- Keeping do/does/did in the reported question: ✗ "She asked me did I like pizza." → ✓ "She asked me if I liked pizza."
- Adding that before if/whether: ✗ "He asked that if I was ready." → ✓ "He asked if I was ready."

SB box `g4/sb/More 4 SB Unit 4.txt#grammar-1` — Questions in reported speech:
```
...
- `m4-u4-reported-questions-gf-001` [gap-fill, d1]: p="She asked me ___ I liked pizza." c="if" a=["if","whether"] ds=["that","do","what"]
- `m4-u4-reported-questions-gf-002` [gap-fill, d2]: p="He asked where I ___." c="lived" a=["lived"] ds=["did live","do live","living"]
- `m4-u4-reported-questions-gf-003` [gap-fill, d2]: p="The teacher asked us ___ we had finished our homework." c="whether" a=["whether","if"] ds=["that","have","did"]
- `m4-u4-reported-questions-gf-004` [gap-fill, d3]: p="She wanted to know what time the film ___." c="started" a=["started"] ds=["did start","does start","starting"]
- `m4-u4-reported-questions-gf-005` [gap-fill, d4]: p="He asked me how long I ___ English." c="had been learning" a=["had been learning","had been studying"] ds=["have been learning","was learning","did learn"]
- `m4-u4-reported-questions-gf-006` [gap-fill, d3]: p="Mum asked me ___ I was going after school." c="where" a=["where"] ds=["if","that","what place"]
- `m4-u4-reported-questions-mc-001` [multiple-choice, d3]: p="Choose the correct reported question: 'Do you have a pet?' she asked him." c="She asked him if he had a pet." a=["She asked him if he had a pet."] ds=["She asked him did he have a pet.","She asked him that he had a pet.","She asked him if did he have a pet."]
- `m4-u4-reported-questions-mc-002` [multiple-choice, d2]: p="Choose the correct reported question: 'Where did you buy that jacket?' Tom asked Lisa." c="Tom asked Lisa where she had bought that jacket." a=["Tom asked Lisa where she had bought that jacket."] ds=["Tom asked Lisa where did she buy that jacket.","Tom asked Lisa where she did buy that jacket.","Tom asked Lisa that where she had bought that jacket."]
- `m4-u4-reported-questions-mc-003` [multiple-choice, d5]: p="Choose the correct reported question: 'Will you come to my party?' she asked me." c="She asked me if I would come to her party." a=["She asked me if I would come to her party."] ds=["She asked me if will I come to her party.","She asked me that I would come to her party.","She asked me if I would come to my party."]
- `m4-u4-reported-questions-ec-001` [error-correction, d1]: p="Find and fix the mistake: He asked where did I live." c="He asked where I lived." a=["He asked where I lived.","He asked where I live.","He asked me where I lived."] ds=[]
- `m4-u4-reported-questions-ec-002` [error-correction, d2]: p="Find and fix the mistake: She asked me that I was hungry." c="She asked me if I was hungry." a=["She asked me if I was hungry.","She asked me whether I was hungry.","She asked if I was hungry.","She asked whether I was hungry."] ds=[]
- `m4-u4-reported-questions-ec-003` [error-correction, d4]: p="Find and fix the mistake: The doctor asked if was I feeling better." c="The doctor asked if I was feeling better." a=["The doctor asked if I was feeling better.","The doctor asked whether I was feeling better.","The doctor asked if I was feeling better"] ds=[]
- `m4-u4-reported-questions-tf-001` [transformation, d3]: p="At the doctor's office, Dr Smith asked about your health. Tell your mum: 'She asked me ___ I ___ (be) feeling OK.'" c="if ... was" a=["if ... was","whether ... was","if/whether ... was"] ds=[]
- `m4-u4-reported-questions-tf-002` [transformation, d4]: p="Your teacher wants to know about your weekend. Later you tell a friend: 'He asked me what I ___ (do) at the weekend.'" c="had done" a=["had done"] ds=[]
- `m4-u4-reported-questions-tf-003` [transformation, d5]: p="At a job interview, the interviewer asked about your languages. Tell your dad: 'She asked me how many languages I ___ (can) speak.'" c="could" a=["could"] ds=[]
- `m4-u4-reported-questions-tr-001` [translation, d2]: p="🇩🇪 Er fragte mich, ob ich Geschwister habe." c="He asked me if I had siblings." a=["He asked me if I had siblings.","He asked me whether I had siblings.","He asked me if I had brothers and sisters.","He asked me whether I had brothers and sisters.","He asked me if I had any siblings.","He asked whether I had siblings."] ds=[]
- `m4-u4-reported-questions-tr-002` [translation, d4]: p="🇩🇪 Sie wollte wissen, wo ich gestern war." c="She wanted to know where I had been yesterday." a=["She wanted to know where I had been yesterday.","She wanted to know where I had been the day before.","She wanted to know where I was yesterday.","She wanted to know where I had been the previous day."] ds=[]
- `m4-u4-reported-questions-sb-001` [sentence-building, d1]: p="Put the words in the correct order: asked / she / was / if / me / I / tired" c="She asked me if I was tired." a=["She asked me if I was tired.","She asked me whether I was tired."] ds=[]
- `m4-u4-reported-questions-mt-001` [matching, d3]: p="Match the direct question with its correct reported form:" c="{\"1\":\"d\",\"2\":\"a\",\"3\":\"e\",\"4\":\"b\",\"5\":\"c\"}" a=["{\"1\":\"d\",\"2\":\"a\",\"3\":\"e\",\"4\":\"b\",\"5\":\"c\"}"] ds=["1: Do you like sport?|2: Where is the station?|3: Can you swim?|4: What time is it?|5: Are you happy?","a: He asked where the station was.|b: She asked what time it was.|c: He asked if I was happy.|d: She asked if I liked sport.|e: They asked if I could swim."]
- `m4-u4-reported-questions-qf-001` [question-formation, d3]: p="Your friend said: 'I went to London.' You want to know why. Report your question starting with: I asked him..." c="I asked him why he had gone to London." a=["I asked him why he had gone to London.","I asked him why he went to London.","I asked him why he had gone to London"] ds=[]
- `m4-u4-reported-questions-gf-007` [gap-fill, d1]: p="\"Do you play football?\" — He asked me ___ I played football." c="if" a=["if","whether"] ds=["that","do","what"]
- `m4-u4-reported-questions-gf-008` [gap-fill, d2]: p="\"Where is the library?\" — She asked me where the library ___." c="was" a=["was"] ds=["is","were","had been"]
- `m4-u4-reported-questions-gf-009` [gap-fill, d3]: p="\"What are you doing?\" — My mum asked me what I ___ doing." c="was" a=["was"] ds=["am","were","had been"]
- `m4-u4-reported-questions-gf-010` [gap-fill, d3]: p="\"Have you ever been to Paris?\" — She wanted to know ___ I ___ ever been to Paris." c="if ... had" a=["if ... had","whether ... had"] ds=["that ... had","if ... have","whether ... was"]
- `m4-u4-reported-questions-gf-011` [gap-fill, d4]: p="\"How much does this cost?\" — I asked the shop assistant how much it ___." c="cost" a=["cost"] ds=["did cost","costs","costed"]
- `m4-u4-reported-questions-gf-012` [gap-fill, d5]: p="\"Will you come to my party on Saturday?\" — He asked me ___ I ___ come to ___ party on Saturday." c="if ... would ... his" a=["if ... would ... his","whether ... would ... his"] ds=["that ... would ... his","if ... will ... his","if ... would ... my"]
- `m4-u4-reported-questions-mc-004` [multiple-choice, d2]: p="Which is the correct reported form of: \"Where do you live?\"" c="She asked me where I lived." a=["She asked me where I lived."] ds=["She asked me where did I live.","She asked me where do I live.","She asked me where I did live."]
- `m4-u4-reported-questions-mc-005` [multiple-choice, d4]: p="Original: \"Can I borrow your pen?\" — Which reported question is correct?" c="He asked if he could borrow my pen." a=["He asked if he could borrow my pen."] ds=["He asked if could he borrow my pen.","He asked that he could borrow my pen.","He asked if he can borrow my pen."]
- `m4-u4-reported-questions-mc-006` [multiple-choice, d5]: p="Original: \"Why didn't you come to the party?\" — Which reported form is correct?" c="She asked me why I hadn't come to the party." a=["She asked me why I hadn't come to the party."] ds=["She asked me why didn't I come to the party.","She asked me why I didn't come to the party.","She asked me why hadn't I come to the party."]
- `m4-u4-reported-questions-ec-004` [error-correction, d2]: p="Find and fix the mistake: He asked me where did I buy my shoes." c="He asked me where I had bought my shoes." a=["He asked me where I had bought my shoes.","He asked me where I bought my shoes.","He asked me where I had bought my shoes"] ds=[]
- `m4-u4-reported-questions-ec-005` [error-correction, d3]: p="Find and fix the mistake: She asked me that I liked chocolate." c="She asked me if I liked chocolate." a=["She asked me if I liked chocolate.","She asked me whether I liked chocolate.","She asked me if I liked chocolate"] ds=[]
- `m4-u4-reported-questions-ec-006` [error-correction, d4]: p="Find and fix the mistake: The teacher asked us what were we doing." c="The teacher asked us what we were doing." a=["The teacher asked us what we were doing.","The teacher asked us what we were doing"] ds=[]
- `m4-u4-reported-questions-tf-004` [transformation, d3]: p="A tourist asked you: \"Is there a supermarket near here?\" Report the question. Start with: The tourist asked me..." c="The tourist asked me if there was a supermarket near there." a=["The tourist asked me if there was a supermarket near there.","The tourist asked me whether there was a supermarket near there.","The tourist asked me if there was a supermarket nearby."] ds=[]
- `m4-u4-reported-questions-tf-005` [transformation, d5]: p="Your friend asked you yesterday: \"How many languages can you speak?\" Report the question. Start with: My friend asked me..." c="My friend asked me how many languages I could speak." a=["My friend asked me how many languages I could speak.","My friend asked me how many languages I could speak"] ds=[]
- `m4-u4-reported-questions-tr-003` [translation, d3]: p="🇩🇪 Sie fragte mich, ob ich Geschwister habe." c="She asked me if I had brothers and sisters." a=["She asked me if I had brothers and sisters.","She asked me whether I had brothers and sisters.","She asked me if I had siblings.","She asked me whether I had any siblings."] ds=[]
- `m4-u4-reported-questions-tr-004` [translation, d4]: p="🇩🇪 Er wollte wissen, wann der Zug abfaehrt." c="He wanted to know when the train left." a=["He wanted to know when the train left.","He wanted to know when the train departed.","He wanted to know when the train was leaving."] ds=[]
- `m4-u4-reported-questions-sb-002` [sentence-building, d2]: p="Put the words in the correct order: asked / she / me / if / liked / I / music" c="She asked me if I liked music." a=["She asked me if I liked music.","She asked me if I liked music"] ds=[]
- `m4-u4-reported-questions-sb-003` [sentence-building, d4]: p="Put the words in the correct order: teacher / asked / the / what / us / had / we / the / done / weekend / at" c="The teacher asked us what we had done at the weekend." a=["The teacher asked us what we had done at the weekend.","The teacher asked us what we had done at the weekend"] ds=[]
- `m4-u4-reported-questions-mt-002` [matching, d3]: p="Match each direct question with its correct reported form. 1: \"Do you like cats?\" 2: \"Where is the station?\" 3: \"Can you help me?\" 4: \"What did you eat?\"" c="{\"1\":\"c\",\"2\":\"a\",\"3\":\"d\",\"4\":\"b\"}" a=["{\"1\":\"c\",\"2\":\"a\",\"3\":\"d\",\"4\":\"b\"}"] ds=["a: He asked where the station was.","b: He asked what I had eaten.","c: He asked if I liked cats.","d: He asked if I could help him."]
- `m4-u4-reported-questions-qf-002` [question-formation, d4]: p="Your new neighbour said: \"I have a dog.\" You want to know the dog's name. Report your question starting with: I asked her..." c="I asked her what her dog's name was." a=["I asked her what her dog's name was.","I asked her what the name of her dog was.","I asked her what her dog was called."] ds=[]
...
Write `content/corpus/units/g4-u04/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g4u04.s.reported-questions",
