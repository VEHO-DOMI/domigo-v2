# Grammar generation brief — g3-u07 (MORE! 3, Unit 7)

<!-- domigo:gen grammar g3-u07 bank=c74971b27547 prompt=4b9164076103 -->
...
### `g3u07.s.present-perfect-for-since` — Present perfect with for / since (Present perfect mit for / since (Dauer und Zeitpunkt))

The present perfect (have/has + past participle) for actions and states that started in the past and continue now, with for for a length of time (German lang) and since for a starting point.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [use-started-continues]: Use the present perfect (have/has + past participle) for actions and states that started in the past and still continue in the present.
  - DE: Du verwendest das Present perfect (have/has + Partizip Perfekt) für Handlungen und Zustände, die in der Vergangenheit begonnen haben und bis jetzt andauern.
  - "I've been friends with Alessia for two years." — "Ich bin seit zwei Jahren mit Alessia befreundet."
  - "He's been in the family for 800 years." — "Er ist seit 800 Jahren in der Familie."
- rule [for-duration]: Use for with a length of time - whenever you could say lang in German: for years, for two months, for a week.
  - DE: Du verwendest for bei einer Zeitspanne - immer dann, wenn du im Deutschen lang sagen könntest: for years, for two months, for a week.
  - "You haven't used it for years." — "Du hast es jahrelang nicht benutzt."
  - "I've had those books for years." — "Ich habe diese Bücher seit Jahren."
- rule [since-starting-point]: Use since with a starting point - a moment when the action began: since Christmas, since 2015, since I was seven.
  - DE: Du verwendest since bei einem Anfangspunkt - dem Moment, in dem die Handlung begann: since Christmas, since 2015, since I was seven.
  - "I've had those toys since Christmas." — "Ich habe diese Spielsachen seit Weihnachten."
  - "I've had them since I was seven." — "Ich habe sie, seit ich sieben war."

common errors:
- Confusing for (duration) and since (point in time): ✗ "I've lived here since three years." → ✓ "I've lived here for three years."
- Using the present simple instead of the present perfect with for/since: ✗ "I live here for five years." → ✓ "I've lived here for five years."
- Using for with a specific point in time: ✗ "I've known her for 2015." → ✓ "I've known her since 2015."

SB box `g3/sb/More 3 SB Unit 7.txt#grammar-1` — Present perfect with for / since:
```
...
- `m3-u7-present-perfect-for-since-gf-001` [gap-fill, d1]: p="I have lived in Vienna ___ ten years." c="for" a=["for"] ds=["since","from","ago"]
- `m3-u7-present-perfect-for-since-gf-002` [gap-fill, d1]: p="She has been my best friend ___ primary school." c="since" a=["since"] ds=["for","from","during"]
- `m3-u7-present-perfect-for-since-gf-003` [gap-fill, d2]: p="They have known each other ___ 2018." c="since" a=["since"] ds=["for","from","in"]
- `m3-u7-present-perfect-for-since-gf-004` [gap-fill, d2]: p="We haven't seen our cousins ___ a long time." c="for" a=["for"] ds=["since","from","during"]
- `m3-u7-present-perfect-for-since-gf-005` [gap-fill, d3]: p="He has had that phone ___ last Christmas." c="since" a=["since"] ds=["for","from","at"]
- `m3-u7-present-perfect-for-since-gf-006` [gap-fill, d3]: p="My sister has played the piano ___ she was six years old." c="since" a=["since"] ds=["for","when","from"]
- `m3-u7-present-perfect-for-since-mc-001` [multiple-choice, d2]: p="Which sentence is correct?" c="I have lived here for five years." a=["I have lived here for five years."] ds=["I have lived here since five years.","I live here for five years.","I lived here since five years."]
- `m3-u7-present-perfect-for-since-mc-002` [multiple-choice, d3]: p="Which sentence is correct?" c="She has worked there since September." a=["She has worked there since September."] ds=["She works there since September.","She has worked there for September.","She worked there since September."]
- `m3-u7-present-perfect-for-since-mc-003` [multiple-choice, d4]: p="Which sentence is correct?" c="They haven't eaten anything since breakfast." a=["They haven't eaten anything since breakfast."] ds=["They haven't eaten anything for breakfast.","They don't eat anything since breakfast.","They didn't eat anything since breakfast."]
- `m3-u7-present-perfect-for-since-ec-001` [error-correction, d3]: p="Find and fix the mistake: I have known her since three years." c="I have known her for three years." a=["I have known her for three years.","I have known her for three years","I've known her for three years.","I've known her for three years"] ds=[]
- `m3-u7-present-perfect-for-since-ec-002` [error-correction, d4]: p="Find and fix the mistake: He lives in Salzburg since 2019." c="He has lived in Salzburg since 2019." a=["He has lived in Salzburg since 2019.","He has lived in Salzburg since 2019","He's lived in Salzburg since 2019.","He's lived in Salzburg since 2019"] ds=[]
- `m3-u7-present-perfect-for-since-ec-003` [error-correction, d4]: p="Find and fix the mistake: We are friends for ten years." c="We have been friends for ten years." a=["We have been friends for ten years.","We have been friends for ten years","We've been friends for ten years.","We've been friends for ten years"] ds=[]
- `m3-u7-present-perfect-for-since-tf-001` [gap-fill, d2]: p="Your exchange student asks how long you've studied English. Answer in one sentence: 'I ________ (learn) English ________ 2019.'" c="have learnt ... since" a=["have learnt ... since","have learned ... since","have learnt, since","have learned, since","'ve learnt ... since","'ve learned ... since"] ds=["have learnt ... for","has learnt ... since","learnt ... since"]
- `m3-u7-present-perfect-for-since-tf-002` [gap-fill, d3]: p="You're writing a message to a new classmate about your best friend. Complete: 'She ________ (be) my best friend ________ three years.'" c="has been ... for" a=["has been ... for","has been, for"] ds=["has been ... since","have been ... for","was ... for"]
- `m3-u7-present-perfect-for-since-tf-003` [gap-fill, d5]: p="Tell your pen pal about your home: 'We ________ (live) here ________ September.'" c="have lived ... since" a=["have lived ... since","have lived, since","'ve lived ... since"] ds=["have lived ... for","has lived ... since","lived ... since"]
- `m3-u7-present-perfect-for-since-tr-001` [translation, d3]: p="🇩🇪 Ich wohne seit fuenf Jahren in Graz." c="I have lived in Graz for five years." a=["I have lived in Graz for five years.","I've lived in Graz for five years.","I have lived in Graz for five years","I've lived in Graz for five years"] ds=[]
- `m3-u7-present-perfect-for-since-tr-002` [translation, d4]: p="🇩🇪 Er spielt seit Montag kein Fussball." c="He hasn't played football since Monday." a=["He hasn't played football since Monday.","He has not played football since Monday.","He hasn't played football since Monday","He has not played football since Monday"] ds=[]
- `m3-u7-present-perfect-for-since-sb-001` [sentence-building, d2]: p="Put the words in the correct order: for / lived / three / they / here / years / have" c="They have lived here for three years." a=["They have lived here for three years.","They have lived here for three years"] ds=[]
- `m3-u7-present-perfect-for-since-mt-001` [matching, d5]: p="Match each time expression with 'for' or 'since':\n1. ___ two hours\n2. ___ last summer\n3. ___ a long time\n4. ___ 2020\n5. ___ three weeks\n6. ___ I was a child\na. for\nb. since" c="{\"1\":\"a\",\"2\":\"b\",\"3\":\"a\",\"4\":\"b\",\"5\":\"a\",\"6\":\"b\"}" a=["{\"1\":\"a\",\"2\":\"b\",\"3\":\"a\",\"4\":\"b\",\"5\":\"a\",\"6\":\"b\"}"] ds=[]
- `m3-u7-present-perfect-for-since-cp-001` [context-picker, d2]: p="Tom moved to Vienna in 2020. He still lives there. Which sentence is correct?" c="Tom has lived in Vienna since 2020." a=["Tom has lived in Vienna since 2020."] ds=["Tom has lived in Vienna since six years.","Tom has lived in Vienna for 2020.","Tom lived in Vienna since 2020."]
- `m3-u7-present-perfect-for-since-gf-020` [gap-fill, d1]: p="I have lived here ___ ten years." c="for" a=["for"] ds=["since","from","during"]
- `m3-u7-present-perfect-for-since-gf-021` [gap-fill, d1]: p="She has known him ___ 2019." c="since" a=["since"] ds=["for","from","in"]
- `m3-u7-present-perfect-for-since-gf-022` [gap-fill, d2]: p="We have been friends ___ primary school." c="since" a=["since"] ds=["for","from","during"]
- `m3-u7-present-perfect-for-since-gf-023` [gap-fill, d2]: p="Tom has played the guitar ___ three months." c="for" a=["for"] ds=["since","from","already"]
- `m3-u7-present-perfect-for-since-gf-024` [gap-fill, d3]: p="They haven't seen each other ___ last Christmas." c="since" a=["since"] ds=["for","from","at"]
- `m3-u7-present-perfect-for-since-gf-025` [gap-fill, d4]: p="My grandma has had that car ___ I was born." c="since" a=["since"] ds=["for","when","from"]
- `m3-u7-present-perfect-for-since-mc-020` [multiple-choice, d2]: p="Choose the correct sentence:" c="I have lived in Vienna since 2020." a=["I have lived in Vienna since 2020."] ds=["I have lived in Vienna for 2020.","I have lived in Vienna since five years.","I have lived in Vienna for last summer."]
- `m3-u7-present-perfect-for-since-mc-021` [multiple-choice, d3]: p="Which sentence uses 'for' correctly?" c="She has studied English for six years." a=["She has studied English for six years."] ds=["She has studied English for 2018.","She has studied English for last Monday.","She has studied English for she was ten."]
- `m3-u7-present-perfect-for-since-mc-022` [multiple-choice, d4]: p="Which sentence is correct?" c="He has been ill since last Friday." a=["He has been ill since last Friday."] ds=["He has been ill for last Friday.","He is ill since last Friday.","He has been ill since a week."]
- `m3-u7-present-perfect-for-since-ec-020` [error-correction, d2]: p="Find and fix the mistake: I have known her since three years." c="for three years" a=["for three years","I have known her for three years.","I have known her for three years"] ds=[]
- `m3-u7-present-perfect-for-since-ec-021` [error-correction, d3]: p="Find and fix the mistake: She is in hospital since Monday." c="has been in hospital" a=["has been in hospital","She has been in hospital since Monday.","She has been in hospital since Monday"] ds=[]
- `m3-u7-present-perfect-for-since-ec-022` [error-correction, d4]: p="Find and fix the mistake: We have waited for 8 o'clock." c="since 8 o'clock" a=["since 8 o'clock","We have waited since 8 o'clock.","We have waited since 8 o'clock"] ds=[]
- `m3-u7-present-perfect-for-since-tf-020` [gap-fill, d3]: p="Your friend asks how long you've had your pet. Answer using 'for': 'I ________ (have) my cat ________ five years.'" c="have had ... for" a=["have had ... for","have had...for","'ve had ... for","'ve had...for"] ds=["has had ... for","had had ... for","had ... for"]
- `m3-u7-present-perfect-for-since-tf-021` [gap-fill, d4]: p="You are telling your pen pal about your home. Rewrite with 'since': 'We moved here in 2018. We still live here.' → 'We ________ here ________ 2018.'" c="have lived ... since" a=["have lived ... since","have lived...since","'ve lived ... since","'ve lived...since"] ds=["have lived ... for","has lived ... since","lived ... since"]
- `m3-u7-present-perfect-for-since-tr-020` [translation, d3]: p="Translate: Ich lerne seit zwei Jahren Englisch." c="I have been learning English for two years." a=["I have been learning English for two years.","I have been learning English for two years","I have learned English for two years.","I have learned English for two years","I have learnt English for two years.","I've been learning English for two years."] ds=[]
- `m3-u7-present-perfect-for-since-tr-021` [translation, d4]: p="Translate: Er wohnt seit September in Wien." c="He has lived in Vienna since September." a=["He has lived in Vienna since September.","He has lived in Vienna since September","He's lived in Vienna since September.","He has been living in Vienna since September."] ds=[]
- `m3-u7-present-perfect-for-since-sb-020` [sentence-building, d2]: p="Put the words in the correct order: for / played / has / she / tennis / years / three" c="She has played tennis for three years." a=["She has played tennis for three years.","She has played tennis for three years"] ds=[]
- `m3-u7-present-perfect-for-since-sb-021` [sentence-building, d3]: p="Put the words in the correct order: haven't / since / they / each other / seen / July" c="They haven't seen each other since July." a=["They haven't seen each other since July.","They haven't seen each other since July"] ds=[]
- `m3-u7-present-perfect-for-since-mt-020` [matching, d3]: p="Match each time expression with 'for' or 'since'. 1: ___ two hours 2: ___ last summer 3: ___ a long time 4: ___ 2015 5: ___ Monday" c="{\"1\":\"a\",\"2\":\"b\",\"3\":\"a\",\"4\":\"b\",\"5\":\"b\"}" a=["{\"1\":\"a\",\"2\":\"b\",\"3\":\"a\",\"4\":\"b\",\"5\":\"b\"}"] ds=["a: for","b: since"]
- `m3-u7-present-perfect-for-since-cp-020` [context-picker, d3]: p="Your friend started learning Spanish in September. It's now March. Which sentence is correct?" c="She has been learning Spanish since September." a=["She has been learning Spanish since September."] ds=["She has been learning Spanish for September.","She learns Spanish since September.","She has been learning Spanish since six months."]
...
Write `content/corpus/units/g3-u07/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g3u07.s.present-perfect-for-since",
