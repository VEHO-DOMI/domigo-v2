# Grammar generation brief — g4-u09 (MORE! 4, Unit 9)

<!-- domigo:gen grammar g4-u09 bank=7b87ba493528 prompt=4b9164076103 -->
...
### `g4u09.s.modals-possibility` — might / may / could (possibility) (might / may / could (Möglichkeit))

The modal verbs might, may and could for talking about possibility - things that are perhaps true or perhaps going to happen. After the modal comes the base form. The unit also shows other ways of expressing possibility with likely to and the likelihood of + -ing.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [form-modal-base]: Use might / may / could + the base form (no 'to') to say that something is possible. They are the same for all persons.
  - DE: Du verwendest might / may / could + die Grundform (ohne 'to'), um zu sagen, dass etwas möglich ist. Sie sind für alle Personen gleich.
  - "If you go to Greece, you might be surprised." — "Wenn du nach Griechenland fährst, könntest du überrascht sein."
  - "Japanese people may smile when they are confused or angry." — "Japaner lächeln vielleicht, wenn sie verwirrt oder verärgert sind."
- rule [could-for-possibility]: could can also express possibility (something that could happen), not only past ability.
  - DE: could kann auch eine Möglichkeit ausdrücken (etwas, das passieren könnte), nicht nur Fähigkeit in der Vergangenheit.
  - "It could get you into trouble in some countries." — "Es könnte dir in manchen Ländern Ärger bringen."
  - "There is a chance that a smile could get you into trouble." — "Es besteht die Möglichkeit, dass ein Lächeln dir Ärger bringen könnte."
- rule [likely-likelihood]: Express possibility in other ways too: be likely to + base verb, and the likelihood of + the -ing form.
  - DE: Drücke Möglichkeit auch anders aus: be likely to + Grundform und the likelihood of + die -ing-Form.
  - "You are likely to offend the Japanese if you blow your nose into a handkerchief." — "Du beleidigst wahrscheinlich die Japaner, wenn du dir in ein Taschentuch schnäuzt."
  - "The likelihood of insulting someone is quite high." — "Die Wahrscheinlichkeit, jemanden zu beleidigen, ist ziemlich hoch."

common errors:
- Adding 'to' after the modal verb: ✗ "She might to come later." → ✓ "She might come later."
- Using 'can' for a specific-situation possibility instead of might/may/could: ✗ "It can rain tomorrow." → ✓ "It might rain tomorrow."
- Adding -s to the modal in the third person: ✗ "She mights be at home." → ✓ "She might be at home."

SB box `g4/sb/More 4 SB Unit 9.txt#grammar-1` — might / may / could:
```
 (possibility)
...
- `m4-u9-modals-possibility-gf-001` [gap-fill, d1]: p="It's cloudy. It ___ rain later." c="might" a=["might","may","could"] ds=["can","must","will"]
- `m4-u9-modals-possibility-gf-002` [gap-fill, d2]: p="He's been studying all day. He ___ be very tired." c="must" a=["must"] ds=["might","can","should"]
- `m4-u9-modals-possibility-gf-003` [gap-fill, d2]: p="That ___ be Sarah — she's on holiday in Spain!" c="can't" a=["can't","cannot"] ds=["mustn't","might not","shouldn't"]
- `m4-u9-modals-possibility-gf-004` [gap-fill, d3]: p="She ___ be at the library — I'm not sure where she is." c="might" a=["might","may","could"] ds=["can","must","will"]
- `m4-u9-modals-possibility-gf-005` [gap-fill, d4]: p="The restaurant ___ be good — it's always full of people." c="must" a=["must"] ds=["might","can","could"]
- `m4-u9-modals-possibility-gf-006` [gap-fill, d5]: p="A: Where's Tom? B: He ___ be at football practice, or he ___ be at his friend's house — I really don't know." c="could ... could" a=["could ... could","might ... might","may ... may","could ... might","might ... could"] ds=["can ... can","must ... must","could ... must"]
- `m4-u9-modals-possibility-mc-001` [multiple-choice, d2]: p="Your friend hasn't eaten all day. Which sentence expresses logical deduction?" c="He must be really hungry." a=["He must be really hungry."] ds=["He can be really hungry.","He might be really hungry.","He should be really hungry."]
- `m4-u9-modals-possibility-mc-002` [multiple-choice, d3]: p="Tim says he ran 100 metres in 8 seconds. That ___!" c="can't be true" a=["can't be true"] ds=["mustn't be true","might not be true","shouldn't be true"]
- `m4-u9-modals-possibility-mc-003` [multiple-choice, d4]: p="Put the modals in order from MOST certain to LEAST certain:" c="must → may → might → can't" a=["must → may → might → can't"] ds=["can't → must → might → may","might → may → must → can't","must → might → can't → may"]
- `m4-u9-modals-possibility-ec-001` [error-correction, d2]: p="Find and fix the mistake: It can rain tomorrow, so take an umbrella." c="It might rain tomorrow, so take an umbrella." a=["It might rain tomorrow, so take an umbrella.","It may rain tomorrow, so take an umbrella.","It could rain tomorrow, so take an umbrella."] ds=[]
- `m4-u9-modals-possibility-ec-002` [error-correction, d3]: p="Find and fix the mistake: She must not be his sister — she looks completely different." c="She can't be his sister — she looks completely different." a=["She can't be his sister — she looks completely different.","She can't be his sister - she looks completely different.","She cannot be his sister — she looks completely different."] ds=[]
- `m4-u9-modals-possibility-ec-003` [error-correction, d4]: p="Find and fix the mistake: She might to come to the party later." c="She might come to the party later." a=["She might come to the party later.","She might come to the party later","She may come to the party later."] ds=[]
- `m4-u9-modals-possibility-tf-001` [transformation, d3]: p="You're not sure where your keys are. Express the possibility: 'They ___ be in my bag — I'm not sure.'" c="might" a=["might","may","could"] ds=[]
- `m4-u9-modals-possibility-tf-002` [transformation, d4]: p="You see your friend has been studying for 10 hours straight. You're almost certain: 'He ___ be exhausted!'" c="must" a=["must"] ds=[]
- `m4-u9-modals-possibility-tf-003` [transformation, d5]: p="Someone claims this student painting is by Picasso. You're sure it's impossible: 'That ___ be a real Picasso — it's impossible!'" c="can't" a=["can't","cannot"] ds=[]
- `m4-u9-modals-possibility-tr-001` [translation, d2]: p="🇩🇪 Er koennte recht haben, aber ich bin mir nicht sicher." c="He might be right, but I'm not sure." a=["He might be right, but I'm not sure.","He may be right, but I'm not sure.","He could be right, but I'm not sure.","He might be right but I'm not sure."] ds=[]
- `m4-u9-modals-possibility-tr-002` [translation, d3]: p="🇩🇪 Das kann nicht wahr sein — sie ist doch erst 14!" c="That can't be true — she's only 14!" a=["That can't be true — she's only 14!","That can't be true - she's only 14!","That cannot be true — she's only 14!","That can't be true, she's only 14!"] ds=[]
- `m4-u9-modals-possibility-sb-001` [sentence-building, d1]: p="Put the words in the correct order: be / the / answer / that / right / might" c="That might be the right answer." a=["That might be the right answer.","That might be the right answer"] ds=[]
- `m4-u9-modals-possibility-mt-001` [matching, d1]: p="Match each situation with the correct modal response. 1: He hasn't slept in 24 hours. 2: I'm not sure where my keys are. 3: She says she's 200 years old. 4: It's a bit cloudy today." c="{\"1\":\"b\",\"2\":\"c\",\"3\":\"a\",\"4\":\"d\"}" a=["{\"1\":\"b\",\"2\":\"c\",\"3\":\"a\",\"4\":\"d\"}"] ds=["a: That can't be true!","b: He must be exhausted.","c: They might be in my bag.","d: It could rain later."]
- `m4-u9-modals-possibility-qf-001` [question-formation, d3]: p="You see a strange light in the sky. Form a question using 'could' to ask your friend what it might be. Start with: What..." c="What could that be?" a=["What could that be?","What could that be","What could it be?"] ds=[]
- `m4-u9-modals-possibility-gf-007` [gap-fill, d1]: p="She isn't answering her phone. She ___ be in a meeting." c="might" a=["might","may","could"] ds=["must","can","will"]
- `m4-u9-modals-possibility-gf-008` [gap-fill, d2]: p="He's eaten three pizzas! He ___ be very hungry." c="must" a=["must"] ds=["might","can","could"]
- `m4-u9-modals-possibility-gf-009` [gap-fill, d3]: p="He ___ be a teacher — he's only 15 years old!" c="can't" a=["can't","cannot"] ds=["mustn't","might not","shouldn't"]
- `m4-u9-modals-possibility-gf-010` [gap-fill, d4]: p="I'm not sure, but this ___ be the right answer." c="could" a=["could","might","may"] ds=["must","can","should"]
- `m4-u9-modals-possibility-gf-011` [gap-fill, d4]: p="She's been working for 12 hours. She ___ be exhausted!" c="must" a=["must"] ds=["might","can","could"]
- `m4-u9-modals-possibility-gf-012` [gap-fill, d5]: p="Where's Tom? — He ___ be at the library, or he ___ be at home. I'm not sure." c="might ... might" a=["might ... might","could ... could","may ... may","might ... could","could ... might"] ds=["must ... must","can ... can","must ... might"]
- `m4-u9-modals-possibility-mc-004` [multiple-choice, d2]: p="There's someone at the door. It ___ be the postman — he usually comes at this time." c="could" a=["could","might","may"] ds=["must","can","should"]
- `m4-u9-modals-possibility-mc-005` [multiple-choice, d3]: p="She's got the highest mark in the class. She ___ have studied a lot." c="must" a=["must"] ds=["can","might","should"]
- `m4-u9-modals-possibility-mc-006` [multiple-choice, d5]: p="That ___ be Maria's phone — Maria has an iPhone and this is a Samsung!" c="can't" a=["can't","cannot"] ds=["mustn't","might not","won't"]
- `m4-u9-modals-possibility-ec-004` [error-correction, d2]: p="Find and fix the mistake: She can be at school — I'm not sure." c="She might be at school — I'm not sure." a=["She might be at school — I'm not sure.","She could be at school — I'm not sure.","She may be at school — I'm not sure."] ds=[]
- `m4-u9-modals-possibility-ec-005` [error-correction, d3]: p="Find and fix the mistake: That mustn't be true — I don't believe it!" c="That can't be true — I don't believe it!" a=["That can't be true — I don't believe it!","That cannot be true — I don't believe it!"] ds=[]
- `m4-u9-modals-possibility-ec-006` [error-correction, d4]: p="Find and fix the mistake: He's running a fever. He can be sick." c="He's running a fever. He must be sick." a=["He's running a fever. He must be sick."] ds=[]
- `m4-u9-modals-possibility-tf-004` [transformation, d2]: p="Rewrite using a modal of possibility: Maybe it will snow tomorrow. → It ___." c="It might snow tomorrow." a=["It might snow tomorrow.","It may snow tomorrow.","It could snow tomorrow."] ds=[]
- `m4-u9-modals-possibility-tf-005` [transformation, d4]: p="Express near-certainty: I'm almost sure he is lying. → He ___." c="He must be lying." a=["He must be lying."] ds=[]
- `m4-u9-modals-possibility-tr-003` [translation, d3]: p="🇩🇪 Er kann vielleicht morgen kommen." c="He might come tomorrow." a=["He might come tomorrow.","He may come tomorrow.","He could come tomorrow."] ds=[]
- `m4-u9-modals-possibility-tr-004` [translation, d5]: p="🇩🇪 Das kann nicht stimmen! Er muss sich irren." c="That can't be true! He must be wrong." a=["That can't be true! He must be wrong.","That cannot be true! He must be wrong.","That can't be right! He must be wrong."] ds=[]
- `m4-u9-modals-possibility-sb-002` [sentence-building, d1]: p="Put the words in the correct order: be / she / at / might / home" c="She might be at home." a=["She might be at home.","She might be at home"] ds=[]
- `m4-u9-modals-possibility-sb-003` [sentence-building, d3]: p="Put the words in the correct order: John's / be / that / car / can't" c="That can't be John's car." a=["That can't be John's car.","That can't be John's car"] ds=[]
- `m4-u9-modals-possibility-mt-002` [matching, d3]: p="Match each situation with the correct modal:" c="{\"1\":\"c\",\"2\":\"a\",\"3\":\"e\",\"4\":\"b\",\"5\":\"d\"}" a=["{\"1\":\"c\",\"2\":\"a\",\"3\":\"e\",\"4\":\"b\",\"5\":\"d\"}"] ds=["1: He's trained every day. He ___ win.|2: Maybe she'll call later.|3: He's only 12 — he ___ drive!|4: I don't know, but he ___ be right.|5: She's eaten nothing all day. She ___ be starving.","a: might (possibility)|b: could (uncertain)|c: should (expectation)|d: must (deduction)|e: can't (impossibility)"]
- `m4-u9-modals-possibility-qf-002` [question-formation, d3]: p="You see a light on in your neighbour's house. You're not sure if they're home. Ask your friend: 'Do you think they ___ be home?'" c="might" a=["might","could"] ds=[]
...
Write `content/corpus/units/g4-u09/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g4u09.s.modals-possibility",
