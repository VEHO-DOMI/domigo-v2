# Vocab generation brief — g4-u08 (MORE! 4, Unit 8)

<!-- domigo:gen vocab g4-u08 bank=c2962a2f7b3c prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g4u08.w.black-market | black market | Schwarzmarkt | phrase | — | You can't get these things in a normal shop. We bought them on the black market. | — | black market |
| g4u08.w.collect | collect | sammeln | phrase | — | I've collected stamps since I was 12. | — | collect |
| g4u08.w.collection | collection | Sammlung | phrase | — | The painting comes from his private collection. | — | collection |
| g4u08.w.fascination | fascination | Faszination | phrase | — | His fascination with garden gnomes started five years ago. | — | fascination |
| g4u08.w.rare | rare | selten | phrase | — | You don't see many of those butterflies. They're very rare. | — | rare |
| g4u08.w.auction | auction | Auktion ; Versteigerung | phrase | — | I bought this painting at an auction. | — | auction |
| g4u08.w.burn-to-the-ground | burn to the ground | niederbrennen | phrase | — | The building burned to the ground. | — | burn to the ground |
| g4u08.w.copy | copy | Kopie ; Exemplar | phrase | — | The book sold 20,000 copies within two weeks. | — | copy |
| g4u08.w.execute | execute | hinrichten | phrase | — | After the trial, the murderer was executed. | — | execute |
| g4u08.w.furious | furious | wütend ; aufgebracht | phrase | — | I'm furious that I wasn't told about it. | — | furious |
| g4u08.w.judge | judge | Richter/in | phrase | — | The judge sentenced him to five years in prison. | — | judge |
| g4u08.w.librarian | librarian | Bibliothekar/in | phrase | — | She works in the town library as a librarian. | — | librarian |
| g4u08.w.library | library | Bibliothek | phrase | — | I never buy books; I always go to the library. | — | library |
| g4u08.w.monastery | monastery | Kloster | phrase | — | The monks lived in a big monastery outside the city. | — | monastery |
| g4u08.w.monk | monk | Mönch | phrase | — | A monk is a member of a religious group of men. | — | monk |
| g4u08.w.precious | precious | kostbar | phrase | — | That ring means a lot to me. It's very precious. | — | precious |
| g4u08.w.preserve | preserve | erhalten ; schützen | phrase | — | We need to preserve our traditions and our heritage. | — | preserve |
| g4u08.w.rob | rob | ausrauben | phrase | — | We've been robbed. The thieves have taken everything from the house. | — | rob |
| g4u08.w.sentence-to-death | sentence to death | zu Tode verurteilen | phrase | — | He was sentenced to death for his crime. | — | sentence to death |
| g4u08.w.shorten | shorten | kürzen | phrase | — | That film was much too long. I think they should shorten it. | — | shorten |
| g4u08.w.addict | addict | Abhängiger ; Süchtige/r | phrase | — | Look at all the science-fiction addicts waiting outside the cinema! They want to see the new Star Wars movie. | — | addict |
| g4u08.w.addiction | addiction | Sucht | phrase | — | He spends all his time in front of the computer. He has an addiction. | — | addiction |
| g4u08.w.command | command | Befehl | phrase | — | I gave her the command to stay at home. | — | command |
| g4u08.w.go-crazy | go crazy | verrückt werden ; durchdrehen | phrase | — | I must be going crazy. I can't find my car keys anywhere. | — | go crazy |
| g4u08.w.miss-out-on-sth | miss out on sth | etw. verpassen | phrase | — | Of course I'm coming. I don't want to miss out on all the fun! | — | miss out on sth |
| g4u08.w.pale | pale | blass | phrase | — | Are you really OK? You look pale. | — | pale |
| g4u08.w.turn-up | turn up | auftauchen | phrase | — | When do you think our guests will turn up? | — | turn up |
| g4u08.w.whisper | whisper | flüstern | phrase | — | He whispered in my ear to tell me the secret. | — | whisper |
| g4u08.w.sheet | sheet | Blatt | phrase | — | Write this down on a sheet of paper. | — | sheet |
| g4u08.w.confuse-sb | confuse sb | verwirren | phrase | — | His comments only confused me even more. | — | confuse sb |
| g4u08.w.kitschy | kitschy | kitschig | phrase | — | The restaurant is decorated with kitschy furniture from the 1950s. | — | kitschy |
...
- `g4u08.w.black-market` ← v1 `black market`: d="An illegal system of buying and selling goods that are forbidden or hard to find" · s="During the war, people often had to buy food on the _____." · a=[] · mc=["flea market","stock market","supermarket"]
- `g4u08.w.collect` ← v1 `collect`: d="To gather things together as a hobby or for a purpose" · s="My little brother likes to _____ football cards and trade them with his friends." · a=["collected"] · mc=["gather","assemble","hoard"]
- `g4u08.w.collection` ← v1 `collection`: d="A group of objects gathered together because they are interesting or valuable" · s="She has an amazing _____ of old coins from all over the world." · a=["collections"] · mc=["exhibition","selection","assortment"]
- `g4u08.w.fascination` ← v1 `fascination`: d="A very strong interest in or attraction to something" · s="Her _____ with dinosaurs began when she visited the natural history museum." · a=[] · mc=["obsession","curiosity","admiration"]
- `g4u08.w.rare` ← v1 `rare`: d="Not found or seen very often; uncommon" · s="This stamp is very _____ — only 50 of them were ever printed." · a=[] · mc=["unique","unusual","scarce"]
- `g4u08.w.auction` ← v1 `auction`: d="A public sale where items are sold to the person who offers the most money" · s="The old violin was sold at an _____ for over 10,000 euros." · a=["auctions"] · mc=["exhibition","sale","lottery"]
- `g4u08.w.burn-to-the-ground` ← v1 `burn to the ground`: d="To be completely destroyed by fire" · s="The old wooden house _____ during the storm last night." · a=["burn to the ground","burned to the ground","burnt to the ground"] · mc=["fall to pieces","blow to bits","tear apart"]
- `g4u08.w.copy` ← v1 `copy`: d="One example of a book, newspaper, CD, or other printed or recorded item" · s="The library has three _____ of that popular novel." · a=["copy","copies"] · mc=["edition","original","version"]
- `g4u08.w.execute` ← v1 `execute`: d="To kill someone as a legal punishment for a crime" · s="In some countries, criminals can still be _____ for serious crimes." · a=["execute","executed"] · mc=["arrest","imprison","punish"]
- `g4u08.w.furious` ← v1 `furious`: d="Extremely angry" · s="Mum was _____ when she found out I had broken the window." · a=[] · mc=["annoyed","outraged","irritated"]
- `g4u08.w.judge` ← v1 `judge`: d="A person who decides cases in a court of law" · s="The _____ listened carefully to both sides before making a decision." · a=["judges"] · mc=["lawyer","jury","prosecutor"]
- `g4u08.w.librarian` ← v1 `librarian`: d="A person who works in a library and helps people find books" · s="Ask the _____ if you need help finding the right book." · a=["librarians"] · mc=["teacher","archivist","secretary"]
- `g4u08.w.library` ← v1 `library`: d="A building or room where books are kept for people to read or borrow" · s="I borrowed three books from the _____ for my history project." · a=["libraries"] · mc=["bookshop","archive","museum"]
- `g4u08.w.monastery` ← v1 `monastery`: d="A building where monks live and work together" · s="We visited an old _____ high up in the mountains during our school trip." · a=["monasteries"] · mc=["cathedral","temple","chapel"]
- `g4u08.w.monk` ← v1 `monk`: d="A man who lives in a religious community and has devoted his life to God" · s="Each _____ in the community had a small room with just a bed and a desk." · a=["monks"] · mc=["priest","nun","bishop"]
- `g4u08.w.precious` ← v1 `precious`: d="Very valuable, either because it is rare or because it is very important to someone" · s="Gold and diamonds are _____ materials that people have valued for centuries." · a=[] · mc=["valuable","expensive","priceless"]
- `g4u08.w.preserve` ← v1 `preserve`: d="To keep something in its original state or in good condition" · s="It is important to _____ old buildings so that future generations can enjoy them." · a=[] · mc=["protect","restore","maintain"]
- `g4u08.w.rob` ← v1 `rob`: d="To steal money or property from a person, bank, or shop" · s="Two men tried to _____ the jewellery shop, but the alarm scared them away." · a=["robbed"] · mc=["steal","burgle","mug"]
- `g4u08.w.sentence-to-death` ← v1 `sentence to death`: d="To officially decide in court that someone must be killed as punishment" · s="The prisoner was _____ for treason against the crown." · a=["sentence to death","sentenced to death"] · mc=["send to prison","put on trial","find guilty"]
- `g4u08.w.shorten` ← v1 `shorten`: d="To make something shorter in length or time" · s="The teacher decided to _____ the test because there wasn't enough time." · a=[] · mc=["reduce","lengthen","trim"]
- `g4u08.w.addict` ← v1 `addict`: d="A person who cannot stop doing or consuming something harmful" · s="He plays video games all night — he's a real gaming _____." · a=["addicts"] · mc=["fan","enthusiast","user"]
- `g4u08.w.addiction` ← v1 `addiction`: d="The condition of not being able to stop doing or using something harmful" · s="Spending eight hours a day on social media is a sign of _____." · a=["addictions"] · mc=["obsession","habit","craving"]
- `g4u08.w.command` ← v1 `command`: d="An order given by a person in authority" · s="The officer gave the _____ to stop, and all the soldiers stood still." · a=["commands"] · mc=["order","request","instruction"]
- `g4u08.w.go-crazy` ← v1 `go crazy`: d="To become very excited, confused, or mentally unwell" · s="If I have to wait in this queue any longer, I'm going to _____!" · a=["go crazy","going crazy","went crazy"] · mc=["go mad","freak out","break down"]
- `g4u08.w.miss-out-on-sth` ← v1 `miss out on sth`: d="To not get the chance to experience or enjoy something" · s="Everyone at school is talking about the new film. I feel like I _____ something because I haven't seen it yet." · a=["miss out on sth","miss out on something","miss out on","miss out"] · mc=["give up on sth","look forward to sth","put up with sth"]
- `g4u08.w.pale` ← v1 `pale`: d="Having a lighter skin colour than usual, often because of illness or fear" · s="She looked very _____ after being ill in bed for a whole week." · a=[] · mc=["faint","weak","dull"]
- `g4u08.w.turn-up` ← v1 `turn up`: d="To arrive or appear, often unexpectedly" · s="We waited for an hour, but he never _____." · a=["turn up","turned up"] · mc=["show up","come along","pop in"]
- `g4u08.w.whisper` ← v1 `whisper`: d="To speak very quietly so that only the person next to you can hear" · s="Please don't talk so loudly in the library — you need to _____." · a=["whispered"] · mc=["mumble","murmur","mutter"]
- `g4u08.w.sheet` ← v1 `sheet`: d="A single piece of paper" · s="Take out a clean _____ of paper and write your name at the top." · a=["sheets"] · mc=["page","slip","note"]
- `g4u08.w.confuse-sb` ← v1 `confuse sb`: d="To make someone unable to understand or think clearly" · s="All these similar words really _____ me during last week's English test." · a=["confuse sb","confuse","confused"] · mc=["distract sb","mislead sb","surprise sb"]
- `g4u08.w.kitschy` ← v1 `kitschy`: d="In poor taste because it is too bright, sentimental, or cheap-looking" · s="The souvenir shop was full of _____ little figurines that nobody really needed." · a=[] · mc=["tacky","fancy","old-fashioned"]
...
Write `content/corpus/units/g4-u08/gen/vocab.draft.json`:
