# Grammar generation brief — g1-u15 (MORE! 1, Unit 15)

<!-- domigo:gen grammar g1-u15 bank=d2f850cdb0ab prompt=4b9164076103 -->
...
### `g1u15.s.going-to` — (be) going to ((be) going to – Zukunft (geplante Handlungen))

Talking about future plans and intentions with the present of be + going to + base verb.

v1 floor for this structure: **25 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [going-to-affirmative]: To talk about plans for the future, use the present of be + going to + base verb.
  - DE: Wenn du über Pläne für die Zukunft sprichst, verwendest du das Present von be + going to + Grundform.
  - "They're going to visit their friends." — "Sie werden ihre Freunde besuchen."
  - "We're going to swim in the sea a lot." — "Wir werden viel im Meer schwimmen."
- rule [going-to-negative]: Negative: present of be + not + going to + base verb.
  - DE: Verneinung: Present von be + not + going to + Grundform.
  - "We aren't going to stay at home." — "Wir werden nicht zu Hause bleiben."
- rule [going-to-questions]: Questions: Am/Is/Are + subject + going to + base verb? Short answers: Yes, I am. / No, she isn't.
  - DE: Fragen: Am/Is/Are + Subjekt + going to + Grundform? Kurzantworten: Yes, I am. / No, she isn't.
  - "Are you going to lie in the sun?" — "Wirst du in der Sonne liegen?"
  - "What are you going to do in your holidays?" — "Was wirst du in den Ferien machen?"

common errors:
- Leaving out the be auxiliary before going to.: ✗ "I going to play football tomorrow." → ✓ "I'm going to play football tomorrow."
- Adding -ing to the main verb after going to.: ✗ "She is going to swimming." → ✓ "She is going to swim."

SB box `g1/sb/SB Unit 15 What are you going to do?.txt#grammar-1` — ▶️ (be) going to:
```
...
- `m1-u15-going-to-gf-001` [gap-fill, d1]: p="I _____ (be going to / visit) my grandma tomorrow." c="am going to visit" a=["am going to visit","'m going to visit"] ds=["going to visit","am going visit","am going to visiting"]
- `m1-u15-going-to-gf-002` [gap-fill, d1]: p="She _____ (be going to / fly) to London next week." c="is going to fly" a=["is going to fly","'s going to fly"] ds=["going to fly","are going to fly","is going to flying"]
- `m1-u15-going-to-gf-003` [gap-fill, d2]: p="We _____ (be going to / play) football on the beach." c="are going to play" a=["are going to play","'re going to play"] ds=["is going to play","going to play","are going to playing"]
- `m1-u15-going-to-gf-004` [gap-fill, d2]: p="He _____ (not / be going to / come) to the party." c="isn't going to come" a=["isn't going to come","is not going to come","'s not going to come"] ds=["doesn't going to come","not going to come","isn't going to comes"]
- `m1-u15-going-to-gf-005` [gap-fill, d3]: p="_____ you _____ (be going to / help) me with my homework?" c="Are, going to help" a=["Are, going to help","Are going to help"] ds=["Do, going to help","Are, going to helping","Is, going to help"]
- `m1-u15-going-to-gf-006` [gap-fill, d2]: p="What _____ you _____ (be going to / do) this weekend?" c="are, going to do" a=["are, going to do","are going to do"] ds=["do, going to do","are, going to doing","is, going to do"]
- `m1-u15-going-to-mc-001` [multiple-choice, d2]: p="Which sentence is correct?" c="They are going to have a party." a=["They are going to have a party."] ds=["They going to have a party.","They are going have a party.","They are going to having a party."]
- `m1-u15-going-to-mc-002` [multiple-choice, d3]: p="Choose the correct question:" c="Is she going to visit London?" a=["Is she going to visit London?"] ds=["Does she going to visit London?","She is going to visit London?","Is she going to visiting London?"]
- `m1-u15-going-to-mc-003` [multiple-choice, d2]: p="Which negative sentence is correct?" c="I'm not going to stay at home." a=["I'm not going to stay at home."] ds=["I doesn't going to stay at home.","I not going to stay at home.","I'm not going to staying at home."]
- `m1-u15-going-to-ec-001` [error-correction, d2]: p="Find and fix the mistake: I going to play football tomorrow." c="I am going to play football tomorrow." a=["I am going to play football tomorrow.","I'm going to play football tomorrow.","am"] ds=[]
- `m1-u15-going-to-ec-002` [error-correction, d2]: p="Find and fix the mistake: Do you going to swim?" c="Are you going to swim?" a=["Are you going to swim?","are"] ds=[]
- `m1-u15-going-to-ec-003` [error-correction, d3]: p="Find and fix the mistake: She are going to read a book." c="She is going to read a book." a=["She is going to read a book.","She's going to read a book.","is"] ds=[]
- `m1-u15-going-to-tf-001` [transformation, d2]: p="Make it negative: They are going to have a party. → They _____ a party." c="aren't going to have" a=["aren't going to have","are not going to have","'re not going to have","They aren't going to have a party.","They aren't going to have a party","They are not going to have a party.","they'ren't going to have a party."] ds=[]
- `m1-u15-going-to-tf-002` [transformation, d3]: p="Make it a question: He is going to travel to Spain. → _____ he _____ to Spain?" c="Is, going to travel" a=["Is, going to travel","Is going to travel","Is, going to travel he Is, going to travel to Spain?","Is, going to travel he Is, going to travel to Spain","Is, going to travel he Is, going to travel to Spain","Is, going to travel he's, going to travel to Spain?"] ds=[]
- `m1-u15-going-to-tr-001` [translation, d2]: p="Translate into English: Ich werde morgen nach Wien fahren." c="I'm going to go to Vienna tomorrow." a=["I'm going to go to Vienna tomorrow.","I am going to go to Vienna tomorrow.","I'm going to travel to Vienna tomorrow.","Tomorrow I'm going to go to Vienna.","I am going to travel to Vienna tomorrow.","Tomorrow I am going to go to Vienna.","Tomorrow i'm going to travel to vienna","Tomorrow i am going to travel to vienna"] ds=[]
- `m1-u15-going-to-tr-002` [translation, d3]: p="Translate into English: Werden sie am Strand schwimmen? – Ja." c="Are they going to swim at the beach? – Yes, they are." a=["Are they going to swim at the beach? – Yes, they are.","Are they going to swim at the beach? - Yes, they are.","Are they going to swim at the beach? Yes, they are.","Are they going to swim at the beach? – Yes, they are","Are they going to swim at the beach? – Yes, they're.","Are they going to swim at the beach? - Yes, they're.","Are they going to swim at the beach? Yes, they're."] ds=[]
- `m1-u15-going-to-sb-001` [sentence-building, d2]: p="Put the words in the correct order: going / to / she / is / a / read / book" c="She is going to read a book." a=["She is going to read a book.","She's going to read a book."] ds=[]
- `m1-u15-going-to-qf-001` [question-formation, d3]: p="She is going to visit London. → Ask a yes/no question." c="Is she going to visit London?" a=["Is she going to visit London?"] ds=[]
- `m1-u15-going-to-gf-007` [gap-fill, d3]: p="___ they going to play tennis tomorrow?" c="Are" a=["Are"] ds=["Is","Do","Will"]
- `m1-u15-going-to-gf-008` [gap-fill, d3]: p="I ___ (not / be going to / eat) pizza tonight. I'm going to have pasta." c="am not going to eat" a=["am not going to eat","'m not going to eat"] ds=["not going to eat","am not going eat","don't going to eat"]
- `m1-u15-going-to-cp-001` [context-picker, d2]: p="Your family has plans for the weekend. Which sentence talks about a future plan correctly?" c="We are going to visit grandma on Sunday." a=["We are going to visit grandma on Sunday."] ds=["We going to visit grandma on Sunday.","We are go to visit grandma on Sunday.","We are going visit grandma on Sunday."]
- `m1-u15-going-to-cp-002` [context-picker, d3]: p="Your friend asks about your holiday plans. Which sentence is correct?" c="I am going to travel to Italy this summer." a=["I am going to travel to Italy this summer."] ds=["I going to travel to Italy this summer.","I am going to travelling to Italy this summer.","I am going travel to Italy this summer."]
- `m1-u15-going-to-qf-002` [question-formation, d3]: p="Statement: They are going to play football. Ask about WHAT." c="What are they going to play?" a=["What are they going to play?","What are they going to play","What are they going to do?","What are they going to do"] ds=[]
- `m1-u15-going-to-gs-001` [group-sort, d2]: p="Sort: present continuous (now) or going to (future plan)?" c="{\"Present Continuous (now)\":[\"I'm eating lunch.\",\"She's reading a book.\",\"They're playing football.\"],\"Going to (future)\":[\"I'm going to eat lunch.\",\"She's going to read a book.\",\"They're going to play football.\"]}" a=[] ds=[]
- `m1-u15-going-to-gs-002` [group-sort, d2]: p="Sort: \"am going to\", \"is going to\", or \"are going to\"?" c="{\"am going to\":[\"I\"],\"is going to\":[\"he\",\"she\",\"it\"],\"are going to\":[\"you\",\"we\",\"they\"]}" a=[] ds=[]
...
Write `content/corpus/units/g1-u15/gen/grammar.draft.json`:
