# Grammar generation brief — g1-u08 (MORE! 1, Unit 8)

<!-- domigo:gen grammar g1-u08 bank=9dd0f200363c prompt=4b9164076103 -->
...
### `g1u08.s.present-simple-questions` — Present simple (questions) (Present simple (Frageform))
...
- rule [present-simple-q-do]: Do + I/you/we/they + base verb? Short answers: Yes, I do. / No, I don't.
  - DE: Do + I/you/we/they + Grundform? Kurzantworten: Yes, I do. / No, I don't.
  - "Do you buy your own clothes? – Yes, I do." — "Kaufst du deine Kleidung selbst? – Ja."
  - "Do they wear blue jeans? – No, they don't." — "Tragen sie blaue Jeans? – Nein."
- rule [present-simple-q-does]: Does + he/she/it + base verb? (no -s on the verb!) Short answers: Yes, he does. / No, he doesn't.
  - DE: Does + he/she/it + Grundform? (kein -s am Verb!) Kurzantworten: Yes, he does. / No, he doesn't.
  - "Does he like T-shirts with animals? – Yes, he does." — "Mag er T-Shirts mit Tieren? – Ja."
  - "Does she wear yellow trainers? – No, she doesn't." — "Trägt sie gelbe Turnschuhe? – Nein."

common errors:
- Keeping the -s on the main verb in a does question.: ✗ "Does she likes chocolate?" → ✓ "Does she like chocolate?"
- Using do instead of does with he/she/it.: ✗ "Do he play football?" → ✓ "Does he play football?"

SB box `g1/sb/SB Unit 8- Clothes.txt#grammar-1` — ▶️ Present simple | questions:
```
...
- `m1-u8-present-simple-questions-gf-002` [gap-fill, d2]: p="___ she like chocolate? — Yes, she ___." c="Does ... does" a=["Does ... does"] ds=["Do ... do","Does ... likes","Is ... is"]
- `m1-u8-present-simple-questions-gf-003` [gap-fill, d2]: p="___ they play football after school?" c="Do" a=["Do"] ds=["Does","Are","Have"]
- `m1-u8-present-simple-questions-gf-004` [gap-fill, d3]: p="___ he ___ (speak) English? — No, he ___." c="Does ... speak ... doesn't" a=["Does ... speak ... doesn't"] ds=["Does ... speaks ... doesn't","Do ... speak ... don't","Does ... speak ... does not speak"]
- `m1-u8-present-simple-questions-gf-005` [gap-fill, d4]: p="___ your mum ___ (work) in an office? — No, she ___. She ___ (work) at home." c="Does ... work ... doesn't ... works" a=["Does ... work ... doesn't ... works"] ds=["Does ... works ... doesn't ... works","Do ... work ... don't ... work","Does ... work ... doesn't ... work"]
- `m1-u8-present-simple-questions-mc-001` [multiple-choice, d2]: p="Which question is correct?" c="Does she like music?" a=["Does she like music?"] ds=["Does she likes music?","Do she like music?","Is she like music?"]
- `m1-u8-present-simple-questions-mc-002` [gap-fill, d3]: p="_____ he _____ to school by bus?" c="Does ... go" a=["Does ... go"] ds=["Does ... goes","Do ... goes","Is ... go"]
- `m1-u8-present-simple-questions-mc-003` [multiple-choice, d4]: p="Which short answer is correct? — Do they live in Vienna?" c="Yes, they do." a=["Yes, they do."] ds=["Yes, they live.","Yes, they does.","Yes, they are."]
- `m1-u8-present-simple-questions-ec-001` [error-correction, d2]: p="Find and fix the mistake: Does she likes chocolate?" c="Does she like chocolate?" a=["Does she like chocolate?","like"] ds=[]
- `m1-u8-present-simple-questions-ec-002` [error-correction, d3]: p="Find and fix the mistake: Do he play tennis?" c="Does he play tennis?" a=["Does he play tennis?","does"] ds=[]
- `m1-u8-present-simple-questions-ec-003` [error-correction, d4]: p="Find and fix the mistake: You like dogs? Yes, I like." c="Do you like dogs? Yes, I do." a=["Do you like dogs? Yes, I do.","Do you like dogs? Yes, I do","do you like dogs yes i do"] ds=[]
- `m1-u8-present-simple-questions-tf-001` [transformation, d2]: p="You want to find out if your new friend likes sport. Make a question: You like sport. → ___ you ___ sport?" c="Do ... like" a=["Do ... like","Do you like sport?","Do ... like you Do ... like sport?","Do ... like you Do ... like sport","Do ... like you Do ... like sport"] ds=[]
- `m1-u8-present-simple-questions-tf-002` [transformation, d3]: p="Make a question: She plays the guitar. → ___ she ___ the guitar?" c="Does ... play" a=["Does ... play","Does she play the guitar?","Does ... play she Does ... play the guitar?","Does ... play she Does ... play the guitar","Does ... play she Does ... play the guitar"] ds=[]
- `m1-u8-present-simple-questions-tr-001` [translation, d2]: p="🇩🇪 Magst du Pizza?" c="Do you like pizza?" a=["Do you like pizza?"] ds=[]
- `m1-u8-present-simple-questions-tr-002` [translation, d4]: p="🇩🇪 Spielt dein Bruder gerne Fussball?" c="Does your brother like playing football?" a=["Does your brother like playing football?","Does your brother like to play football?","Does your brother play football?"] ds=[]
- `m1-u8-present-simple-questions-sb-001` [sentence-building, d3]: p="Put the words in the correct order: like / she / Does / sport / ?" c="Does she like sport?" a=["Does she like sport?"] ds=[]
- `m1-u8-present-simple-questions-mt-001` [matching, d2]: p="Match each question to the correct short answer: 1) Do you like cats?  2) Does he play football?  3) Do they live here?  4) Does she speak French? — a) No, she doesn't.  b) Yes, I do.  c) No, they don't.  d) Yes, he does." c="{\"1\":\"b\",\"2\":\"d\",\"3\":\"c\",\"4\":\"a\"}" a=["{\"1\":\"b\",\"2\":\"d\",\"3\":\"c\",\"4\":\"a\"}"] ds=[]
- `m1-u8-present-simple-questions-qf-001` [question-formation, d3]: p="Anna likes reading. Ask a yes/no question about Anna:" c="Does Anna like reading?" a=["Does Anna like reading?","Does she like reading?"] ds=[]
- `m1-u8-present-simple-questions-ff-001` [free-form, d2]: p="You want to ask your new classmate about football. Make it a question: You like football. → ___ football?" c="Do you like" a=["Do you like","Do you like football","Do you like football?"] ds=[]
- `m1-u8-present-simple-questions-ff-002` [free-form, d3]: p="You think your friend plays tennis. Ask to be sure. Make it a question: He plays tennis. → ___ tennis?" c="Does he play" a=["Does he play","Does he play tennis","Does he play tennis?"] ds=[]
- `m1-u8-present-simple-questions-cp-001` [gap-fill, d1]: p="___ you like pizza? — Yes, I ___." c="Do ... do" a=["Do ... do"] ds=["Does ... does","Are ... am","Is ... do"]
- `m1-u8-present-simple-questions-gs-001` [group-sort, d2]: p="Sort: does the question start with \"Do\" or \"Does\"?" c="{\"Do\":[\"___ you like pizza?|Do you like pizza?\",\"___ they play football?|Do they play football?\",\"___ we have homework?|Do we have homework?\",\"___ I need a pen?|Do I need a pen?\"],\"Does\":[\"___ she swim?|Does she swim?\",\"___ he eat meat?|Does he eat meat?\",\"___ it rain a lot?|Does it rain a lot?\"]}" a=[] ds=[]
...
Write `content/corpus/units/g1-u08/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g1u08.s.present-simple-questions",
