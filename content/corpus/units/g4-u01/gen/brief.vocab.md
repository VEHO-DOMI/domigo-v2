# Vocab generation brief — g4-u01 (MORE! 4, Unit 1)

<!-- domigo:gen vocab g4-u01 bank=05dcb9424620 prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g4u01.w.be-aware-of-sth | be aware of sth | sich etw. bewusst sein | phrase | — | I wasn't aware of that. | — | be aware of sth |
| g4u01.w.catholic | Catholic | katholisch ; Katholik/in | phrase | — | Most people in the Republic of Ireland are Catholics. | — | Catholic |
| g4u01.w.fluent | fluent | fließend | phrase | — | She speaks fluent English. | — | fluent |
| g4u01.w.independent | independent | unabhängig | phrase | — | The Republic of Ireland is an independent country. | — | independent |
| g4u01.w.leading | leading | führend | phrase | — | Some leading computer firms have their base in Ireland. | — | leading |
| g4u01.w.member | member | Mitglied | phrase | — | The club has 300 members. | — | member |
| g4u01.w.primary-school | primary school | Volksschule | phrase | — | Children in primary school are between 6 and 10 years old. | — | primary school |
| g4u01.w.cattle | cattle | Rinder ; Vieh | phrase | — | He keeps horses and cattle on his farm. | — | cattle |
| g4u01.w.cheer | cheer | jubeln | phrase | — | The fans cheered for their team. | — | cheer |
| g4u01.w.crop | crop | Ernte | phrase | — | In 1845, the potato crop in Ireland was destroyed. | — | crop |
| g4u01.w.famine | famine | Hungersnot | phrase | — | In a famine, people die because they have nothing to eat. | — | famine |
| g4u01.w.found | found | gründen | phrase | — | The Irish Republic was founded in 1922. | — | found |
| g4u01.w.free-state | free state | Freistaat | phrase | — | Ireland became a free state in 1922. | — | free state |
| g4u01.w.fungus | fungus | Pilz | phrase | — | A fungus destroyed all the potatoes in Ireland. | — | fungus |
| g4u01.w.government | government | Regierung | phrase | — | The government didn't react fast enough to the crisis. | — | government |
| g4u01.w.grain | grain | Getreide | phrase | — | You can make bread from grain. It grows in fields. | — | grain |
| g4u01.w.incident | incident | Zwischenfall | phrase | — | Someone just stole that lady's handbag. We should report the incident to the police. | — | incident |
| g4u01.w.intention | intention | Absicht ; Vorhaben | phrase | — | She announced her intention to run for president. | — | intention |
| g4u01.w.interfere | interfere | sich einmischen ; in Konflikt geraten | phrase | — | You should not interfere in other people's business. | — | interfere |
| g4u01.w.landlord | landlord | Grundbesitzer ; Vermieter | phrase | — | The landlord is the owner of the house or the land where people live or work. | — | landlord |
| g4u01.w.majority | majority | Mehrheit | phrase | — | Most of the people in the north were Protestant. They were the majority. | — | majority |
| g4u01.w.put-down | put down | niederschlagen | phrase | — | British soldiers put down the rebellion. | — | put down |
| g4u01.w.shake-hands | shake hands | Hände schütteln | phrase | — | It's normal to shake hands with somebody you've just met. | — | shake hands |
| g4u01.w.starve | starve | verhungern | phrase | — | The people had nothing to eat. They were starving. | — | starve |
| g4u01.w.guess | Guess! | Rate! | phrase | — | You want to know what I bought? Guess! | — | Guess! |
| g4u01.w.i-d-rather | I'd rather | Ich möchte eher | phrase | — | I'd rather stay at home than go on holiday this year. | — | I'd rather |
| g4u01.w.foreigner | foreigner | Ausländer/-in | phrase | — | I met many foreigners from Asia who was working at the hotel. | — | foreigner |
| g4u01.w.improve | improve | verbessern | phrase | — | I wanted to improve my English and get better marks. | — | improve |
| g4u01.w.tax | tax | Steuer | phrase | — | Nearly everyone in the country has to pay taxes to the government. | — | tax |
| g4u01.w.hiking | hiking | Wandern | phrase | — | National Parks are always great places for hiking. | — | hiking |
| g4u01.w.proper | proper | richtig ; angemessen | phrase | — | That's not a proper job. Do it again! | — | proper |
| g4u01.w.admire | admire | bewundern | phrase | — | They all admired her courage. | — | admire |
| g4u01.w.be-terrified | be terrified | fürchterliche Angst haben | phrase | — | Scared? I was absolutely terrified! | — | be terrified |
| g4u01.w.nonsense | nonsense | Unsinn ; Quatsch | phrase | — | She thinks that astrology is nonsense. | — | nonsense |
| g4u01.w.thunder | thunder | Donner | phrase | — | Lightning is usually followed by thunder. | — | thunder |
| g4u01.w.unconscious | unconscious | bewusstlos ; unbewusst | phrase | — | She was unconscious for three days after the accident. | — | unconscious |
...
- `g4u01.w.be-aware-of-sth` ← v1 `be aware of sth`: d="To know about or realise something exists or is happening" · s="Are you _____ how dangerous it is to swim in this river?" · a=["be aware of sth","be aware of something","be aware of"] · mc=["be afraid of sth","be ashamed of sth","be fond of sth"]
- `g4u01.w.catholic` ← v1 `Catholic`: d="Relating to the largest Christian Church, led by the Pope" · s="My grandmother goes to a _____ church every Sunday morning." · a=["Catholics"] · mc=["Protestant","Orthodox","Muslim"]
- `g4u01.w.fluent` ← v1 `fluent`: d="Able to speak a language smoothly and easily" · s="He grew up in Spain, so he is _____ in Spanish." · a=[] · mc=["basic","native","advanced"]
- `g4u01.w.independent` ← v1 `independent`: d="Free from the control or influence of others" · s="She moved into her own flat because she wanted to be more _____." · a=[] · mc=["dependent","separate","individual"]
- `g4u01.w.leading` ← v1 `leading`: d="Most important or most successful in a particular area" · s="She is one of the _____ scientists in the field of medicine." · a=[] · mc=["following","supporting","growing"]
- `g4u01.w.member` ← v1 `member`: d="A person who belongs to a group or organisation" · s="Every _____ of the football team has to come to practice on Wednesdays." · a=["member","members"] · mc=["visitor","leader","supporter"]
- `g4u01.w.primary-school` ← v1 `primary school`: d="The first level of education for children aged about 6 to 10" · s="My little sister just started _____ and she already loves it." · a=[] · mc=["secondary school","nursery school","grammar school"]
- `g4u01.w.cattle` ← v1 `cattle`: d="Cows and bulls kept on a farm for milk or meat" · s="The farmer has about fifty _____ in the field behind the barn." · a=[] · mc=["poultry","livestock","sheep"]
- `g4u01.w.cheer` ← v1 `cheer`: d="To shout with joy or encouragement" · s="The crowd began to _____ when the singer came on stage." · a=["cheer","cheered"] · mc=["clap","whistle","shout"]
- `g4u01.w.crop` ← v1 `crop`: d="A plant grown in large amounts by farmers, such as wheat or potatoes" · s="The dry weather destroyed most of the wheat _____ this summer." · a=["crops"] · mc=["harvest","seed","field"]
- `g4u01.w.famine` ← v1 `famine`: d="A situation in which many people have no food and may die" · s="The long war led to a terrible _____ in the country." · a=[] · mc=["drought","poverty","plague"]
- `g4u01.w.found` ← v1 `found`: d="To start or establish an organisation, city, or institution" · s="Two students _____ a charity to help homeless people in their city." · a=["found","founded"] · mc=["discover","build","invent"]
- `g4u01.w.free-state` ← v1 `free state`: d="A country or region that governs itself independently" · s="After years of fighting, the region finally became a _____." · a=[] · mc=["kingdom","republic","colony"]
- `g4u01.w.fungus` ← v1 `fungus`: d="A living organism like a mushroom or mould that grows on plants or dead material" · s="A dangerous _____ is killing many trees in the forest." · a=["fungi"] · mc=["bacteria","virus","parasite"]
- `g4u01.w.government` ← v1 `government`: d="The group of people who officially control and make decisions for a country" · s="The _____ has decided to build more schools in rural areas." · a=[] · mc=["parliament","ministry","authority"]
- `g4u01.w.grain` ← v1 `grain`: d="Seeds from plants like wheat, rice, or barley used as food" · s="This region produces more _____ than any other area in the country." · a=["grains"] · mc=["flour","cereal","corn"]
- `g4u01.w.incident` ← v1 `incident`: d="An event, especially one that is unusual, unpleasant, or violent" · s="There was a serious _____ at school today — two boys got into a fight." · a=["incidents"] · mc=["accident","occasion","event"]
- `g4u01.w.intention` ← v1 `intention`: d="A plan or aim to do something" · s="It was never my _____ to hurt your feelings. I'm really sorry." · a=["intentions"] · mc=["attention","ambition","decision"]
- `g4u01.w.interfere` ← v1 `interfere`: d="To get involved in a situation where you are not wanted or needed" · s="Please don't _____ when I'm talking to my friends about our problems." · a=[] · mc=["interrupt","involve","interact"]
- `g4u01.w.landlord` ← v1 `landlord`: d="A person who owns land or a building and rents it to others" · s="Our _____ said he would fix the broken window next week." · a=["landlords"] · mc=["tenant","neighbour","owner"]
- `g4u01.w.majority` ← v1 `majority`: d="The larger number or part of something; more than half" · s="The _____ of students in our class voted to go on a trip to Vienna." · a=[] · mc=["minority","quantity","authority"]
- `g4u01.w.put-down` ← v1 `put down`: d="To stop a rebellion or protest by force" · s="The army was sent to _____ the protest in the capital." · a=[] · mc=["give up","break out","carry out"]
- `g4u01.w.shake-hands` ← v1 `shake hands`: d="To hold and move another person's hand up and down as a greeting" · s="In Austria, people usually _____ when they meet for the first time." · a=[] · mc=["wave goodbye","give a hug","nod the head"]
- `g4u01.w.starve` ← v1 `starve`: d="To suffer or die because of not having enough food" · s="Without food or water, a person can _____ within a few weeks." · a=["starve","starving"] · mc=["suffer","struggle","survive"]
- `g4u01.w.guess` ← v1 `Guess!`: d="An exclamation telling someone to try to find the answer" · s="I'm thinking of a number between one and ten. _____! You have three tries." · a=["guess"] · mc=["Think!","Imagine!","Choose!"]
- `g4u01.w.i-d-rather` ← v1 `I'd rather`: d="Used to say that you prefer one thing over another" · s="No thanks, _____ stay at home tonight than go to the cinema." · a=[] · mc=["I'd better","I'd prefer","I'd like"]
- `g4u01.w.foreigner` ← v1 `foreigner`: d="A person who comes from a different country" · s="As a _____ in Japan, she had to learn a completely new language." · a=["foreigner","foreigners"] · mc=["stranger","tourist","immigrant"]
- `g4u01.w.improve` ← v1 `improve`: d="To make something better, or to become better" · s="She practises the piano every day to _____ her skills." · a=[] · mc=["increase","develop","advance"]
- `g4u01.w.tax` ← v1 `tax`: d="Money that people must pay to the government based on their income or purchases" · s="The government uses _____ money to build roads and hospitals." · a=["tax","taxes"] · mc=["fee","fine","debt"]
- `g4u01.w.hiking` ← v1 `hiking`: d="The activity of going on long walks in the countryside or mountains" · s="We went _____ in the Alps last weekend and the views were amazing." · a=[] · mc=["climbing","trekking","jogging"]
- `g4u01.w.proper` ← v1 `proper`: d="Correct, suitable, or appropriate for a situation" · s="You can't go to the job interview in flip-flops — you need _____ shoes." · a=[] · mc=["suitable","polite","formal"]
- `g4u01.w.admire` ← v1 `admire`: d="To look at something or someone with pleasure and respect" · s="I really _____ people who can speak more than three languages." · a=["admire","admired"] · mc=["envy","appreciate","adore"]
- `g4u01.w.be-terrified` ← v1 `be terrified`: d="To be extremely frightened" · s="My little brother is _____ of spiders — he screams whenever he sees one." · a=["be terrified","terrified"] · mc=["be frightened","be worried","be shocked"]
- `g4u01.w.nonsense` ← v1 `nonsense`: d="Words or ideas that are silly or have no meaning" · s="Don't believe him — everything he just said was complete _____." · a=[] · mc=["rubbish","mistake","rumour"]
- `g4u01.w.thunder` ← v1 `thunder`: d="The loud noise in the sky during a storm, usually after lightning" · s="We saw a flash of lightning and then heard loud _____ a few seconds later." · a=[] · mc=["lightning","storm","hail"]
- `g4u01.w.unconscious` ← v1 `unconscious`: d="Not awake; having lost consciousness" · s="He hit his head on the door and was _____ for a few minutes." · a=[] · mc=["asleep","unaware","exhausted"]
...
Write `content/corpus/units/g4-u01/gen/vocab.draft.json`:
