# Grammar generation brief — g4-u06 (MORE! 4, Unit 6)

<!-- domigo:gen grammar g4-u06 bank=4ede02fd891e prompt=4b9164076103 -->
...
### `g4u06.s.adverbs-of-manner` — Adverbs of manner (revision) (Adverbien der Art und Weise (Wiederholung))

Adverbs of manner say how someone does something or how something happens. Regular adverbs are adjective + -ly; some are irregular (well, fast, hard/hardly); and after linking verbs (look, sound, feel, taste, smell) you use an adjective, not an adverb. Taught in the unit-6 grammar box together with question tags.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [adjective-plus-ly]: Form regular adverbs of manner by adding -ly to the adjective. They tell you how something is done.
  - DE: Regelmäßige Adverbien der Art und Weise bildest du, indem du -ly an das Adjektiv anhängst. Sie sagen, wie etwas getan wird.
  - "Dream Boxes were successfully distributed to over 50,000 students." — "Dream Boxes wurden erfolgreich an über 50.000 Schüler verteilt."
  - "He drove slowly through the village." — "Er fuhr langsam durch das Dorf."
- rule [irregular-adverbs]: Some adverbs are irregular: good -> well, fast -> fast, hard -> hard. Watch out: hard means 'with effort', but hardly means 'almost not at all'.
  - DE: Einige Adverbien sind unregelmäßig: good -> well, fast -> fast, hard -> hard. Achtung: hard bedeutet 'mit Anstrengung', hardly aber 'kaum'.
  - "Everybody worked hard." — "Alle arbeiteten hart."
  - "I hardly slept at all last night." — "Ich habe letzte Nacht kaum geschlafen."
- rule [adjective-after-linking-verbs]: After the verbs look, sound, feel, taste and smell, use an adjective (not an adverb), because they describe a state, not an action.
  - DE: Nach den Verben look, sound, feel, taste und smell verwendest du ein Adjektiv (kein Adverb), weil sie einen Zustand und keine Handlung beschreiben.
  - "That doesn't sound good." — "Das klingt nicht gut."
  - "This food tastes awful." — "Dieses Essen schmeckt schrecklich."

common errors:
- Using the adjective form where an adverb is needed: ✗ "She sings beautiful." → ✓ "She sings beautifully."
- Using an adverb after a linking verb instead of an adjective: ✗ "It tastes badly." → ✓ "It tastes bad."
- Confusing hard (with effort) and hardly (almost not): ✗ "He hardly works. (meaning: he works a lot)" → ✓ "He works hard."

SB box `g4/sb/More 4 SB Unit 6.txt#grammar-1` — Adverbs of manner (Revision):
```
...
- `m4-u6-adverbs-of-manner-gf-001` [gap-fill, d1]: p="She sings ___. (beautiful)" c="beautifully" a=["beautifully"] ds=["beautiful","beautifuly","beauty"]
- `m4-u6-adverbs-of-manner-gf-002` [gap-fill, d2]: p="He runs very ___. (fast)" c="fast" a=["fast"] ds=["fastly","faster","quick"]
- `m4-u6-adverbs-of-manner-gf-003` [gap-fill, d3]: p="She plays the piano very ___. (good)" c="well" a=["well"] ds=["good","goodly","best"]
- `m4-u6-adverbs-of-manner-gf-004` [gap-fill, d4]: p="I can ___ hear you — please speak louder!" c="hardly" a=["hardly"] ds=["hard","harder","not hard"]
- `m4-u6-adverbs-of-manner-gf-005` [gap-fill, d4]: p="I haven't seen Tom ___. Is he OK?" c="lately" a=["lately","recently"] ds=["late","later","latest"]
- `m4-u6-adverbs-of-manner-gf-006` [gap-fill, d2]: p="The children were playing ___ in the garden. (happy)" c="happily" a=["happily"] ds=["happy","happyly","happiness"]
- `m4-u6-adverbs-of-manner-mc-001` [multiple-choice, d3]: p="Choose the correct sentence:" c="She speaks English fluently." a=["She speaks English fluently."] ds=["She speaks fluently English.","She fluently speaks English.","She speaks English fluent."]
- `m4-u6-adverbs-of-manner-mc-002` [multiple-choice, d5]: p="Choose the correct sentence: 'He worked ___ for the exam but he could ___ pass it.'" c="He worked hard for the exam but he could hardly pass it." a=["He worked hard for the exam but he could hardly pass it."] ds=["He worked hardly for the exam but he could hard pass it.","He worked hard for the exam but he could hard pass it.","He worked hardly for the exam but he could hardly pass it."]
- `m4-u6-adverbs-of-manner-mc-003` [multiple-choice, d2]: p="Tom speaks three languages. He speaks French ___." c="fluently" a=["fluently"] ds=["fluent","fluentely","fluents"]
- `m4-u6-adverbs-of-manner-ec-001` [error-correction, d1]: p="Find and fix the mistake: She dances very good." c="She dances very well." a=["She dances very well.","She dances really well.","She dances well."] ds=[]
- `m4-u6-adverbs-of-manner-ec-002` [error-correction, d3]: p="Find and fix the mistake: He drove fastly to the hospital." c="He drove fast to the hospital." a=["He drove fast to the hospital.","He drove fast to the hospital","He fast drove to the hospital."] ds=[]
- `m4-u6-adverbs-of-manner-ec-003` [error-correction, d4]: p="Find and fix the mistake: She quietly closed the door and careful walked down the stairs." c="She quietly closed the door and carefully walked down the stairs." a=["She quietly closed the door and carefully walked down the stairs.","She quietly closed the door and carefully walked down the stairs","She closed the door quietly and carefully walked down the stairs."] ds=[]
- `m4-u6-adverbs-of-manner-tf-001` [transformation, d2]: p="Rewrite using an adverb: He is a slow runner. → He runs ___." c="He runs slowly." a=["He runs slowly.","He runs slowly","He runs very slowly."] ds=[]
- `m4-u6-adverbs-of-manner-tf-002` [transformation, d3]: p="Your friend asks about your mum's cooking. You say: 'My mum is a great cook — she cooks really ___.'" c="well" a=["well"] ds=[]
- `m4-u6-adverbs-of-manner-tf-003` [transformation, d5]: p="It was very foggy this morning. Tell a friend: 'I could ___ see anything — it was so foggy!'" c="hardly" a=["hardly"] ds=[]
- `m4-u6-adverbs-of-manner-tr-001` [translation, d2]: p="🇩🇪 Er spricht sehr leise." c="He speaks very quietly." a=["He speaks very quietly.","He talks very quietly.","He speaks really quietly.","He speaks very softly."] ds=[]
- `m4-u6-adverbs-of-manner-tr-002` [translation, d4]: p="🇩🇪 Sie hat hart gearbeitet, aber sie konnte die Pruefung kaum bestehen." c="She worked hard, but she could hardly pass the exam." a=["She worked hard, but she could hardly pass the exam.","She worked hard but she could hardly pass the exam.","She had worked hard, but she could hardly pass the exam.","She worked hard, but she hardly passed the exam."] ds=[]
- `m4-u6-adverbs-of-manner-sb-001` [sentence-building, d1]: p="Put the words in the correct order: carefully / she / letter / read / the" c="She read the letter carefully." a=["She read the letter carefully.","She carefully read the letter."] ds=[]
- `m4-u6-adverbs-of-manner-mt-001` [matching, d3]: p="Match the adjective with its correct adverb form:" c="{\"1\":\"d\",\"2\":\"e\",\"3\":\"a\",\"4\":\"c\",\"5\":\"b\",\"6\":\"f\"}" a=["{\"1\":\"d\",\"2\":\"e\",\"3\":\"a\",\"4\":\"c\",\"5\":\"b\",\"6\":\"f\"}"] ds=["1: good|2: fast|3: careful|4: happy|5: hard|6: late","a: carefully|b: hard|c: happily|d: well|e: fast|f: late"]
- `m4-u6-adverbs-of-manner-qf-001` [question-formation, d3]: p="She plays the guitar beautifully. Ask about HOW she plays the guitar." c="How does she play the guitar?" a=["How does she play the guitar?","How does she play guitar?","How well does she play the guitar?"] ds=[]
- `m4-u6-adverbs-of-manner-gf-007` [gap-fill, d1]: p="Please speak ___ — the baby is sleeping. (quiet)" c="quietly" a=["quietly"] ds=["quiet","quietely","quitly"]
- `m4-u6-adverbs-of-manner-gf-008` [gap-fill, d2]: p="The dog was barking ___ at the stranger. (angry)" c="angrily" a=["angrily"] ds=["angry","angryly","angrly"]
- `m4-u6-adverbs-of-manner-gf-009` [gap-fill, d3]: p="She worked ___ on her project and still had problems. (hard)" c="hard" a=["hard"] ds=["hardly","harder","hardily"]
- `m4-u6-adverbs-of-manner-gf-010` [gap-fill, d3]: p="He answered all the questions ___ and got the best mark. (correct)" c="correctly" a=["correctly"] ds=["correct","correctily","correcting"]
- `m4-u6-adverbs-of-manner-gf-011` [gap-fill, d5]: p="The team played really ___ in the first half but ___ in the second. (good / terrible)" c="well ... terribly" a=["well ... terribly"] ds=["good ... terrible","well ... terrible","good ... terribly"]
- `m4-u6-adverbs-of-manner-gf-012` [gap-fill, d4]: p="Don't arrive ___ for the interview — it makes a bad impression. (late)" c="late" a=["late"] ds=["lately","later","latest"]
- `m4-u6-adverbs-of-manner-mc-004` [multiple-choice, d2]: p="Choose the correct sentence: The teacher explained the rules ___." c="clearly" a=["clearly"] ds=["clear","clearlly","clearing"]
- `m4-u6-adverbs-of-manner-mc-005` [multiple-choice, d3]: p="Which sentence is correct?" c="She dances really well." a=["She dances really well."] ds=["She dances really good.","She dances really goodly.","She dances really welly."]
- `m4-u6-adverbs-of-manner-mc-006` [multiple-choice, d4]: p="He studied ___ for the test, but he ___ passed." c="hard ... hardly" a=["hard ... hardly"] ds=["hardly ... hard","hardly ... hardly","hard ... hard"]
- `m4-u6-adverbs-of-manner-ec-004` [error-correction, d2]: p="Find and fix the mistake: He speaks French fluent." c="He speaks French fluently." a=["He speaks French fluently.","He speaks French fluently","He fluently speaks French."] ds=[]
- `m4-u6-adverbs-of-manner-ec-005` [error-correction, d3]: p="Find and fix the mistake: We haven't seen Jake lately. He has been working hardly." c="We haven't seen Jake lately. He has been working hard." a=["We haven't seen Jake lately. He has been working hard.","We haven't seen Jake lately. He has been working hard"] ds=[]
- `m4-u6-adverbs-of-manner-ec-006` [error-correction, d5]: p="Find and fix the mistake: She sings beautiful but dances bad." c="She sings beautifully but dances badly." a=["She sings beautifully but dances badly.","She sings beautifully but dances badly"] ds=[]
- `m4-u6-adverbs-of-manner-tf-004` [transformation, d2]: p="Rewrite using an adverb: She is a careful driver. → She drives ___." c="She drives carefully." a=["She drives carefully.","She drives carefully","She drives very carefully."] ds=[]
- `m4-u6-adverbs-of-manner-tf-005` [transformation, d4]: p="Rewrite using an adverb: He is a lazy worker. → He works ___." c="He works lazily." a=["He works lazily.","He works lazily"] ds=[]
- `m4-u6-adverbs-of-manner-tr-003` [translation, d3]: p="🇩🇪 Sie hat die Frage richtig beantwortet." c="She answered the question correctly." a=["She answered the question correctly.","She correctly answered the question.","She answered the question right."] ds=[]
- `m4-u6-adverbs-of-manner-tr-004` [translation, d5]: p="🇩🇪 Er ist immer spät dran, aber in letzter Zeit kommt er noch später." c="He is always late, but lately he has been coming even later." a=["He is always late, but lately he has been coming even later.","He's always late, but lately he's been coming even later.","He is always late but lately he has been arriving even later."] ds=[]
- `m4-u6-adverbs-of-manner-sb-002` [sentence-building, d2]: p="Put the words in the correct order: nervously / she / the / answered / phone" c="She answered the phone nervously." a=["She answered the phone nervously.","She nervously answered the phone.","Nervously, she answered the phone."] ds=[]
- `m4-u6-adverbs-of-manner-sb-003` [sentence-building, d3]: p="Put the words in the correct order: well / surprisingly / the / team / played" c="The team played surprisingly well." a=["The team played surprisingly well.","Surprisingly, the team played well."] ds=[]
- `m4-u6-adverbs-of-manner-mt-002` [matching, d4]: p="Match each sentence with the correct adverb:" c="{\"1\":\"d\",\"2\":\"e\",\"3\":\"a\",\"4\":\"b\",\"5\":\"c\",\"6\":\"f\"}" a=["{\"1\":\"d\",\"2\":\"e\",\"3\":\"a\",\"4\":\"b\",\"5\":\"c\",\"6\":\"f\"}"] ds=["1: He trains ___ every day.|2: She could ___ lift the box.|3: The bus arrived ___.|4: He spoke ___ about the problem.|5: She finished the race ___.|6: He has been sleeping ___ all week.","a: late|b: seriously|c: fast|d: hard|e: hardly|f: badly"]
- `m4-u6-adverbs-of-manner-qf-002` [question-formation, d4]: p="Tom speaks Spanish fluently. Ask about HOW Tom speaks Spanish." c="How does Tom speak Spanish?" a=["How does Tom speak Spanish?","How well does Tom speak Spanish?"] ds=[]

### `g4u06.s.question-tags` — Question tags (Frageanhängsel (Question tags))

Short question tags (the English 'oder?' / 'nicht wahr?') added to the end of a sentence: a positive sentence takes a negative tag and a negative sentence a positive tag. The tag repeats the auxiliary or modal, or uses do/does/did, and always ends with a pronoun. Taught in the unit-6 grammar box together with adverbs of manner.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [opposite-polarity]: Use the opposite polarity in the tag: a positive sentence takes a negative tag, and a negative sentence takes a positive tag.
  - DE: Verwende im Anhang die gegenteilige Polarität: Ein bejahender Satz bekommt einen verneinenden Anhang, ein verneinender einen bejahenden.
  - "That's easy, isn't it?" — "Das ist einfach, oder?"
  - "You aren't from here, are you?" — "Du bist nicht von hier, oder?"
- rule [repeat-auxiliary-or-do]: Repeat the auxiliary (be/have) or the modal (can/should/will/might) in the tag. If there is no auxiliary or modal, use a form of do.
  - DE: Wiederhole im Anhang das Hilfsverb (be/have) oder das Modalverb (can/should/will/might). Gibt es kein Hilfs- oder Modalverb, verwende eine Form von do.
  - "All kids should eat healthily, shouldn't they?" — "Alle Kinder sollten sich gesund ernähren, oder?"
  - "She started her healthy cooking channel, didn't she?" — "Sie hat ihren Kanal für gesundes Kochen gestartet, oder?"
- rule [pronoun-in-tag]: The tag always ends with a pronoun, never a noun - replace a noun subject with the matching pronoun. Special case: I am ..., aren't I? (not 'amn't I?').
  - DE: Der Anhang endet immer mit einem Pronomen, nie mit einem Nomen - ersetze ein Nomen-Subjekt durch das passende Pronomen. Sonderfall: I am ..., aren't I? (nicht 'amn't I?').
  - "Amber was only 11 at the time, wasn't she?" — "Amber war damals erst 11, oder?"
  - "I am late, aren't I?" — "Ich bin spät dran, oder?"

common errors:
- Using the wrong auxiliary in the tag (is instead of does): ✗ "She likes music, isn't she?" → ✓ "She likes music, doesn't she?"
- Using the same polarity instead of the opposite one: ✗ "She likes music, does she?" → ✓ "She likes music, doesn't she?"
- Using a noun or the wrong pronoun in the tag: ✗ "The children are coming, isn't it?" → ✓ "The children are coming, aren't they?"
...
v1 seed items (UNTRUSTED):
- `m4-u6-question-tags-gf-001` [gap-fill, d1]: p="She is your sister, ___ ?" c="isn't she" a=["isn't she"] ds=["is she","doesn't she","wasn't she"]
- `m4-u6-question-tags-gf-002` [gap-fill, d1]: p="They can't come to the party, ___ ?" c="can they" a=["can they"] ds=["can't they","do they","are they"]
- `m4-u6-question-tags-gf-003` [gap-fill, d2]: p="Tom likes football, ___ ?" c="doesn't he" a=["doesn't he"] ds=["isn't he","does he","don't he"]
- `m4-u6-question-tags-gf-004` [gap-fill, d3]: p="The children were playing outside, ___ ?" c="weren't they" a=["weren't they"] ds=["weren't it","didn't they","were they"]
- `m4-u6-question-tags-gf-005` [gap-fill, d3]: p="You haven't finished your homework, ___ ?" c="have you" a=["have you"] ds=["haven't you","did you","don't you"]
- `m4-u6-question-tags-gf-006` [gap-fill, d4]: p="I am late, ___ ?" c="aren't I" a=["aren't I"] ds=["am I","isn't I","amn't I"]
- `m4-u6-question-tags-mc-001` [multiple-choice, d2]: p="Which sentence has the correct question tag?" c="She will come tomorrow, won't she?" a=["She will come tomorrow, won't she?"] ds=["She will come tomorrow, will she?","She will come tomorrow, doesn't she?","She will come tomorrow, isn't she?"]
- `m4-u6-question-tags-mc-002` [multiple-choice, d3]: p="Which sentence has the correct question tag?" c="Your parents went to Italy, didn't they?" a=["Your parents went to Italy, didn't they?"] ds=["Your parents went to Italy, weren't they?","Your parents went to Italy, didn't he?","Your parents went to Italy, don't they?"]
- `m4-u6-question-tags-mc-003` [multiple-choice, d4]: p="Which sentence has the correct question tag?" c="Nobody called, did they?" a=["Nobody called, did they?"] ds=["Nobody called, didn't they?","Nobody called, called they?","Nobody called, didn't he?"]
- `m4-u6-question-tags-ec-001` [error-correction, d1]: p="Find and fix the mistake: She likes pizza, isn't she?" c="She likes pizza, doesn't she?" a=["She likes pizza, doesn't she?","She likes pizza, doesn't she","She likes pizza doesn't she?"] ds=[]
- `m4-u6-question-tags-ec-002` [error-correction, d3]: p="Find and fix the mistake: The students have finished the test, haven't it?" c="The students have finished the test, haven't they?" a=["The students have finished the test, haven't they?","The students have finished the test, haven't they","The students have finished the test haven't they?"] ds=[]
- `m4-u6-question-tags-ec-003` [error-correction, d4]: p="Find and fix the mistake: You don't like maths, don't you?" c="You don't like maths, do you?" a=["You don't like maths, do you?","You don't like maths, do you","You don't like maths do you?"] ds=[]
- `m4-u6-question-tags-tf-001` [transformation, d2]: p="You're checking something with your friend during a chat: 'He should study more, ___?'" c="He should study more, shouldn't he?" a=["He should study more, shouldn't he?","He should study more, shouldn't he","He should study more shouldn't he?"] ds=[]
- `m4-u6-question-tags-tf-002` [transformation, d3]: p="Add the correct question tag: Sarah doesn't eat meat." c="Sarah doesn't eat meat, does she?" a=["Sarah doesn't eat meat, does she?","Sarah doesn't eat meat, does she","Sarah doesn't eat meat does she?"] ds=[]
- `m4-u6-question-tags-tf-003` [transformation, d5]: p="Add the correct question tag: Let's go to the cinema." c="Let's go to the cinema, shall we?" a=["Let's go to the cinema, shall we?","Let's go to the cinema, shall we","Let's go to the cinema shall we?"] ds=[]
- `m4-u6-question-tags-tr-001` [translation, d2]: p="🇩🇪 Er ist nett, oder?" c="He is nice, isn't he?" a=["He is nice, isn't he?","He's nice, isn't he?","He is nice isn't he?","He's nice isn't he?"] ds=[]
- `m4-u6-question-tags-tr-002` [translation, d4]: p="🇩🇪 Du spielst gern Tennis, oder?" c="You like playing tennis, don't you?" a=["You like playing tennis, don't you?","You like to play tennis, don't you?","You enjoy playing tennis, don't you?","You like playing tennis don't you?"] ds=[]
- `m4-u6-question-tags-sb-001` [sentence-building, d2]: p="Put the words in the correct order: she / can / swim / , / can't / she / ?" c="She can swim, can't she?" a=["She can swim, can't she?","She can swim can't she?"] ds=[]
- `m4-u6-question-tags-mt-001` [matching, d3]: p="Match each sentence with the correct question tag. 1: She is tired 2: They went home 3: He can drive 4: You don't smoke 5: We should leave" c="{\"1\":\"c\",\"2\":\"e\",\"3\":\"d\",\"4\":\"a\",\"5\":\"b\"}" a=["{\"1\":\"c\",\"2\":\"e\",\"3\":\"d\",\"4\":\"a\",\"5\":\"b\"}"] ds=["a: do you?","b: shouldn't we?","c: isn't she?","d: can't he?","e: didn't they?"]
- `m4-u6-question-tags-qf-001` [question-formation, d5]: p="Form the complete sentence with the correct question tag: Your brother / has been / to London" c="Your brother has been to London, hasn't he?" a=["Your brother has been to London, hasn't he?","Your brother has been to London hasn't he?","Your brother has been to London, hasn't he"] ds=[]
- `m4-u6-question-tags-gf-007` [gap-fill, d1]: p="You are from Vienna, ___ ?" c="aren't you" a=["aren't you"] ds=["are you","don't you","isn't you"]
- `m4-u6-question-tags-gf-008` [gap-fill, d2]: p="She won't be at the meeting, ___ ?" c="will she" a=["will she"] ds=["won't she","does she","is she"]
- `m4-u6-question-tags-gf-009` [gap-fill, d3]: p="Nobody told you about the party, ___ ?" c="did they" a=["did they"] ds=["didn't they","did he","didn't nobody"]
- `m4-u6-question-tags-gf-010` [gap-fill, d4]: p="Let's go to the cinema, ___ ?" c="shall we" a=["shall we"] ds=["will we","do we","don't we"]
- `m4-u6-question-tags-gf-011` [gap-fill, d5]: p="Nothing happened at the party, ___ ?" c="did it" a=["did it"] ds=["didn't it","did they","didn't they"]
- `m4-u6-question-tags-gf-012` [gap-fill, d5]: p="I am the oldest in the class, ___ ?" c="aren't I" a=["aren't I"] ds=["amn't I","am I not","isn't I"]
- `m4-u6-question-tags-mc-004` [multiple-choice, d2]: p="Your mum has already cooked dinner, ___ ?" c="hasn't she" a=["hasn't she"] ds=["has she","didn't she","doesn't she"]
- `m4-u6-question-tags-mc-005` [multiple-choice, d3]: p="They didn't enjoy the film, ___ ?" c="did they" a=["did they"] ds=["didn't they","do they","were they"]
- `m4-u6-question-tags-mc-006` [multiple-choice, d4]: p="Everybody knows the answer, ___ ?" c="don't they" a=["don't they"] ds=["doesn't they","doesn't everybody","don't everybody"]
- `m4-u6-question-tags-ec-004` [error-correction, d2]: p="Find and fix the mistake: She likes pizza, doesn't it?" c="She likes pizza, doesn't she?" a=["She likes pizza, doesn't she?","She likes pizza, doesn't she"] ds=[]
- `m4-u6-question-tags-ec-005` [error-correction, d3]: p="Find and fix the mistake: They have been to London, didn't they?" c="They have been to London, haven't they?" a=["They have been to London, haven't they?","They have been to London, haven't they"] ds=[]
- `m4-u6-question-tags-ec-006` [error-correction, d4]: p="Find and fix the mistake: Nobody likes tests, do he?" c="Nobody likes tests, do they?" a=["Nobody likes tests, do they?","Nobody likes tests, do they"] ds=[]
- `m4-u6-question-tags-tf-004` [transformation, d2]: p="Add a question tag: We should leave early." c="We should leave early, shouldn't we?" a=["We should leave early, shouldn't we?","We should leave early, shouldn't we"] ds=[]
- `m4-u6-question-tags-tf-005` [transformation, d4]: p="Add a question tag: Someone called you last night." c="Someone called you last night, didn't they?" a=["Someone called you last night, didn't they?","Someone called you last night, didn't they"] ds=[]
- `m4-u6-question-tags-tr-003` [translation, d2]: p="🇩🇪 Du magst Schokolade, oder? (present simple)" c="You like chocolate, don't you?" a=["You like chocolate, don't you?","You like chocolate, don't you"] ds=[]
- `m4-u6-question-tags-tr-004` [translation, d4]: p="🇩🇪 Niemand war dort, oder?" c="Nobody was there, were they?" a=["Nobody was there, were they?","Nobody was there, were they","No one was there, were they?"] ds=[]
- `m4-u6-question-tags-sb-002` [sentence-building, d2]: p="Put the words in the correct order to form a question tag sentence: lovely / isn't / today / it / it / day / is / a / ," c="It is a lovely day, isn't it?" a=["It is a lovely day, isn't it?","It's a lovely day, isn't it?"] ds=[]
- `m4-u6-question-tags-sb-003` [sentence-building, d3]: p="Put the words in the correct order: we / go / swimming / , / shall / let's" c="Let's go swimming, shall we?" a=["Let's go swimming, shall we?","Let's go swimming, shall we"] ds=[]
- `m4-u6-question-tags-mt-002` [matching, d3]: p="Match each statement with the correct question tag:" c="{\"1\":\"e\",\"2\":\"d\",\"3\":\"f\",\"4\":\"b\",\"5\":\"a\",\"6\":\"c\"}" a=["{\"1\":\"e\",\"2\":\"d\",\"3\":\"f\",\"4\":\"b\",\"5\":\"a\",\"6\":\"c\"}"] ds=["1: She can swim, ...|2: They won't come, ...|3: He doesn't like maths, ...|4: You were late, ...|5: We should go, ...|6: I am right, ...","a: shouldn't we?|b: weren't you?|c: aren't I?|d: will they?|e: can't she?|f: does he?"]
- `m4-u6-question-tags-qf-002` [question-formation, d5]: p="You think your friend has already been to Paris. Confirm with a question tag: You've been to Paris, ___?" c="haven't you" a=["haven't you"] ds=[]
...
Write `content/corpus/units/g4-u06/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g4u06.s.adverbs-of-manner",
