# Vocab generation brief — g2-u08 (MORE! 2, Unit 8)

<!-- domigo:gen vocab g2-u08 bank=7b3557fe606c prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g2u08.w.spaceship | spaceship | Raumschiff | wordfile | Science Fiction | — | — | spaceship |
| g2u08.w.commander | commander | Kommandant/in | wordfile | Science Fiction | — | — | commander |
| g2u08.w.spacesuit | spacesuit | Raumanzug | wordfile | Science Fiction | — | — | spacesuit |
| g2u08.w.alien | alien | Außerirdische/r | wordfile | Science Fiction | — | — | alien |
| g2u08.w.ufo | UFO | UFO | wordfile | Science Fiction | — | — | UFO |
| g2u08.w.space-centre | space centre | Raumfahrtzentrum | wordfile | Science Fiction | — | — | space centre |
| g2u08.w.planet | planet | Planet | wordfile | Science Fiction | — | — | planet |
| g2u08.w.boss | boss | Chef/Chefin | phrase | — | He wanted to warn the boss of the space centre. | — | boss |
| g2u08.w.cable | cable | Kabel | phrase | — | Benson connected a cable to his spacesuit. | — | cable |
| g2u08.w.capital | capital | Hauptstadt | phrase | — | Vienna is the capital of Austria. | — | capital |
| g2u08.w.to-connect | to connect | anschließen ; verbinden | phrase | — | You have to connect the cable to the spacesuit. | connect | to connect ; connect |
| g2u08.w.hero-heroine | hero, heroine | Held ; Heldin | phrase | — | You saved us – you're our hero. | — | hero, heroine |
| g2u08.w.machine | machine | Maschine | phrase | — | The alien gave him a little machine that helped him to understand the language. | — | machine |
| g2u08.w.to-repair | to repair | reparieren | phrase | — | Benson went outside to repair the broken spaceship. | repair | to repair ; repair |
| g2u08.w.space | space | Weltall | phrase | — | There are lots of stars and planets out there in space. | — | space |
| g2u08.w.statue | statue | Statue | phrase | — | There's a statue of Lord Nelson at Trafalgar Square. | — | statue |
| g2u08.w.to-take-over | to take over | erobern ; die Führung übernehmen | phrase | — | The aliens want to take over the Earth. | take over | to take over ; take over |
| g2u08.w.traveller | traveller | Reisender/Reisende | phrase | — | I'm a traveller from planet Arconia. | — | traveller |
| g2u08.w.visitor | visitor | Besucher/Besucherin | phrase | — | Welcome! It's good to have you as a visitor. | — | visitor |
| g2u08.w.key | key | Schlüssel | phrase | — | He found a gold key on the ground. | — | key |
| g2u08.w.crew | crew | Besatzung | phrase | — | Benson has to save his crew on the spaceship. | — | crew |
| g2u08.w.aeroplane | aeroplane | Flugzeug | phrase | — | Yesterday, I saw a huge aeroplane in the sky. | — | aeroplane |
| g2u08.w.expert | expert | Experte/Expertin | phrase | — | She's an expert. | — | expert |
| g2u08.w.hoax | hoax | Streich ; Täuschung | phrase | — | The news isn't true. It's a hoax. | — | hoax |
| g2u08.w.investigation | investigation | Untersuchung ; Ermittlung | phrase | — | The police started their investigation yesterday. | — | investigation |
| g2u08.w.photograph | photograph | Foto | phrase | — | My grandma showed me an old photograph. | — | photograph |
| g2u08.w.to-destroy | to destroy | zerstören | phrase | — | In the film, aliens try to destroy Earth. | destroy | to destroy ; destroy |
| g2u08.w.to-kidnap | to kidnap | entführen | phrase | — | I think aliens want to kidnap people from Earth. | kidnap | to kidnap ; kidnap |
| g2u08.w.nonsense | nonsense | Unsinn | phrase | — | I'm sorry, but this is just nonsense. | — | nonsense |
| g2u08.w.comfortable | comfortable | bequem | phrase | — | The chair was very comfortable! | — | comfortable |
| g2u08.w.calm-down | Calm down! | Beruhige dich! | phrase | — | Calm down! You're safe with us. | — | Calm down! |
| g2u08.w.in-that-case | in that case | in diesem Fall | phrase | — | In that case, we should give him morphing powers. | — | in that case |
...
- `g2u08.w.spaceship` ← v1 `spaceship`: d="a vehicle that travels through space" · s="The _____ flew past the moon and into deep darkness." · a=["spaceships"] · mc=["aeroplane","rocket","satellite"]
- `g2u08.w.commander` ← v1 `commander`: d="The person in charge who tells others what to do" · s="The military _____ of the ship told all the sailors to get ready for the mission." · a=["commanders"] · mc=["cook","doctor","passenger"]
- `g2u08.w.spacesuit` ← v1 `spacesuit`: d="Special clothes you wear to survive in space" · s="You need a _____ so you can breathe outside the ship." · a=["spacesuits"] · mc=["costume","uniform","armour"]
- `g2u08.w.alien` ← v1 `alien`: d="A creature that comes from another world" · s="In the film, the _____ was green and had big eyes." · a=["aliens"] · mc=["monster","robot","creature"]
- `g2u08.w.ufo` ← v1 `UFO`: d="A strange flying thing in the sky that nobody can explain" · s="Some people say they saw a _____ over the city last night." · a=["UFOs"] · mc=["spaceship","satellite","rocket"]
- `g2u08.w.space-centre` ← v1 `space centre`: d="A building where people plan trips to the sky and other worlds" · s="We visited the _____ and saw real rockets." · a=["space centre","space center","space centres"] · mc=["airport","laboratory","observatory"]
- `g2u08.w.planet` ← v1 `planet`: d="A big round thing in the sky that goes around a star" · s="Earth is the _____ where we all live." · a=["planets"] · mc=["star","moon","satellite"]
- `g2u08.w.boss` ← v1 `boss`: d="The person who is in charge at work" · s="My mum's _____ at the office called her about a meeting tomorrow morning." · a=["bosses"] · mc=["friend","sister","neighbour"]
- `g2u08.w.cable` ← v1 `cable`: d="A thick wire used to connect things" · s="The TV does not work because the power _____ that connects it to the wall is broken." · a=["cables"] · mc=["button","remote","screen"]
- `g2u08.w.capital` ← v1 `capital`: d="The most important city of a country" · s="London is the _____ of England. It is where the king and the government are." · a=["capitals"] · mc=["country","region","continent"]
- `g2u08.w.to-connect` ← v1 `to connect`: d="To join two things together" · s="Can you _____ your phone to the speaker so we can play music?" · a=["connect","connects","connected"] · mc=["to hide","to throw","to break"]
- `g2u08.w.hero-heroine` ← v1 `hero, heroine`: d="A brave person who helps or saves other people" · s="The firefighter was a real _____ and saved the cat." · a=["hero","heroine","heroes","heroines"] · mc=["villain","champion","leader"]
- `g2u08.w.machine` ← v1 `machine`: d="Something built to do a job, like a washing or coffee maker" · s="This kitchen _____ makes fresh orange juice in ten seconds when you press the button." · a=["machines"] · mc=["bowl","glass","knife"]
- `g2u08.w.to-repair` ← v1 `to repair`: d="To fix something that is broken" · s="My dad _____ my bike after the wheel came off, using his tools in the garage." · a=["repair","repairs","repaired"] · mc=["to ride","to paint","to sell"]
- `g2u08.w.space` ← v1 `space`: d="Everything outside our world, where the stars are" · s="One day I want to travel into _____." · a=[] · mc=["sky","universe","atmosphere"]
- `g2u08.w.statue` ← v1 `statue`: d="A figure of a person or animal made from stone or metal" · s="There is a big bronze _____ of a horse and its rider in the town centre, made by a famous artist 100 years ago." · a=["statues"] · mc=["tree","fountain","bench"]
- `g2u08.w.to-take-over` ← v1 `to take over`: d="To get control of something" · s="In the story, robots _____ the whole city." · a=["take over","took over","takes over"] · mc=["to give up","to take part","to take off"]
- `g2u08.w.traveller` ← v1 `traveller`: d="A person who goes from place to place" · s="The _____ going around the world had a big backpack, a map, and a passport with many stamps." · a=["travellers","traveler","travelers"] · mc=["student","doctor","farmer"]
- `g2u08.w.visitor` ← v1 `visitor`: d="A person who comes to see a place or a person" · s="Our school had a special _____ from England today who came to give us a talk about London." · a=["visitors"] · mc=["teacher","parent","student"]
- `g2u08.w.key` ← v1 `key`: d="A small metal thing you use to open a lock" · s="I forgot my _____ and couldn't get into the house." · a=["keys"] · mc=["lock","code","password"]
- `g2u08.w.crew` ← v1 `crew`: d="The group of people who work on a ship or plane" · s="The _____ on the plane was very friendly — the pilot and all five flight attendants." · a=["crews"] · mc=["passenger","baggage","food"]
- `g2u08.w.aeroplane` ← v1 `aeroplane`: d="A big vehicle with wings that flies through the sky" · s="The _____ flew over our house and made a loud noise." · a=["aeroplanes","airplane","airplanes"] · mc=["helicopter","spaceship","glider"]
- `g2u08.w.expert` ← v1 `expert`: d="A person who knows a lot about something" · s="She is an _____ on African animals — she has studied them for 20 years and wrote three books about them." · a=["experts"] · mc=["student","beginner","visitor"]
- `g2u08.w.hoax` ← v1 `hoax`: d="A trick that makes people believe something that is not true" · s="The story about the monster was just a _____." · a=["hoaxes"] · mc=["trick","joke","lie"]
- `g2u08.w.investigation` ← v1 `investigation`: d="When people try to find out what really happened" · s="The police started an _____ to find the missing painting. They looked for clues everywhere." · a=["investigations"] · mc=["argument","celebration","meeting"]
- `g2u08.w.photograph` ← v1 `photograph`: d="A picture taken with a camera" · s="She showed me an old black-and-white _____ of her grandparents taken in 1960." · a=["photographs","photo","photos"] · mc=["letter","book","postcard"]
- `g2u08.w.to-destroy` ← v1 `to destroy`: d="To break something so badly it cannot be fixed" · s="The strong storm completely _____ many trees in the park last night. Nothing was left." · a=["destroy","destroys","destroyed"] · mc=["to plant","to water","to climb"]
- `g2u08.w.to-kidnap` ← v1 `to kidnap`: d="To take a person away by force" · s="In the film, bad people _____ the prince and held him in a secret castle for a week." · a=["kidnap","kidnaps","kidnapped"] · mc=["to help","to visit","to thank"]
- `g2u08.w.nonsense` ← v1 `nonsense`: d="Something silly that does not make sense" · s="Don't talk _____! Of course the Earth is round — everyone knows that." · a=[] · mc=["English","homework","breakfast"]
- `g2u08.w.comfortable` ← v1 `comfortable`: d="Nice to sit or lie on, making you feel good" · s="This soft sofa is very _____. I could sit here all day without getting a sore back." · a=[] · mc=["hard","rough","sharp"]
- `g2u08.w.calm-down` ← v1 `Calm down!`: d="Words you say to someone who is too excited or scared" · s="_____! Stop shouting and breathe slowly. Everything is going to be fine." · a=["Calm down","Calm down!"] · mc=["Run away!","Look out!","Watch out!"]
- `g2u08.w.in-that-case` ← v1 `in that case`: d="If the situation is like that, then" · s="You don't like fish? _____, let's order chicken." · a=["in that case"] · mc=["if so","therefore","however"]
...
Write `content/corpus/units/g2-u08/gen/vocab.draft.json`:
