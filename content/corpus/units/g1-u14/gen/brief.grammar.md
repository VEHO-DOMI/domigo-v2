# Grammar generation brief — g1-u14 (MORE! 1, Unit 14)

<!-- domigo:gen grammar g1-u14 bank=001680d0f49a prompt=4b9164076103 -->
...
### `g1u14.s.past-simple-irregular` — Past simple (4–5) irregular verbs (Past simple (4–5) unregelmäßige Verben)

Common irregular verbs whose past simple is not formed with -ed and must be learnt by heart (have–had, go–went, see–saw …).

v1 floor for this structure: **27 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [irregular-verbs-concept]: Irregular verbs do NOT add -ed. They have special past forms you learn by heart.
  - DE: Unregelmäßige Verben bekommen KEIN -ed. Sie haben besondere Vergangenheitsformen, die du auswendig lernst.
  - "have – had, go – went, see – saw" — "have – had, go – went, see – saw"
  - "I went into the shop and took out the control." — "Ich ging in den Laden und holte die Fernbedienung heraus."
- rule [irregular-verbs-more]: More common irregular verbs: eat–ate, come–came, get–got, give–gave, tell–told, find–found, catch–caught, read–read.
  - DE: Weitere häufige unregelmäßige Verben: eat–ate, come–came, get–got, give–gave, tell–told, find–found, catch–caught, read–read.
  - "Yesterday I met Carol's sister." — "Gestern traf ich Carols Schwester."
  - "They ran out of the classroom." — "Sie liefen aus dem Klassenzimmer."

common errors:
- Adding -ed to an irregular verb.: ✗ "I goed to the cinema yesterday." → ✓ "I went to the cinema yesterday."
- Regularising a vowel-change irregular verb.: ✗ "He runned very fast." → ✓ "He ran very fast."

SB box `g1/sb/SB Unit 14 It's my favourite.txt#grammar-1` — ▶️ Past simple (3) Verneinung mit didn't:
```
...
- `m1-u14-irregular-verbs-gf-001` [gap-fill, d1]: p="Yesterday she _____ (go) to the park." c="went" a=["went"] ds=["goed","goes","going"]
- `m1-u14-irregular-verbs-gf-002` [gap-fill, d1]: p="I _____ (see) a great film last night." c="saw" a=["saw"] ds=["seed","seen","seeing"]
- `m1-u14-irregular-verbs-gf-003` [gap-fill, d2]: p="She _____ (write) a letter to her friend." c="wrote" a=["wrote"] ds=["writed","written","writing"]
- `m1-u14-irregular-verbs-gf-004` [gap-fill, d2]: p="He _____ (think) it was a great idea." c="thought" a=["thought"] ds=["thinked","thinkt","thinks"]
- `m1-u14-irregular-verbs-gf-005` [gap-fill, d2]: p="We _____ (have) pizza for dinner last night." c="had" a=["had"] ds=["haved","has","having"]
- `m1-u14-irregular-verbs-gf-006` [gap-fill, d3]: p="Yesterday I _____ (take) the bus and _____ (come) to school early." c="took, came" a=["took, came"] ds=["taked, comed","took, comed","taked, came"]
- `m1-u14-irregular-verbs-mc-001` [gap-fill, d2]: p="Which past tense form is correct? run → _____" c="ran" a=["ran"] ds=["runned","runed","running"]
- `m1-u14-irregular-verbs-mc-002` [multiple-choice, d2]: p="Which past form is WRONG?" c="goed" a=["goed"] ds=["went","saw","took"]
- `m1-u14-irregular-verbs-mc-003` [multiple-choice, d3]: p="Which sentence is correct?" c="She made a beautiful cake." a=["She made a beautiful cake."] ds=["She maked a beautiful cake.","She maded a beautiful cake.","She makes a beautiful cake yesterday."]
- `m1-u14-irregular-verbs-ec-001` [error-correction, d2]: p="Find and fix the mistake: I catched the ball in the game." c="I caught the ball in the game." a=["I caught the ball in the game.","caught"] ds=[]
- `m1-u14-irregular-verbs-ec-002` [error-correction, d2]: p="Find and fix the mistake: He thinked about it all day." c="He thought about it all day." a=["He thought about it all day.","thought"] ds=[]
- `m1-u14-irregular-verbs-ec-003` [error-correction, d3]: p="Find and fix the mistake: She writed a story about her dog." c="She wrote a story about her dog." a=["She wrote a story about her dog.","wrote"] ds=[]
- `m1-u14-irregular-verbs-tf-001` [transformation, d2]: p="You're talking about your birthday dinner yesterday. The cake was delicious! Write the past simple: eat → _____" c="ate" a=["ate"] ds=[]
- `m1-u14-irregular-verbs-tf-002` [transformation, d3]: p="Your friend got a present from his grandma. She is very generous! Write the past simple: give → _____" c="gave" a=["gave"] ds=[]
- `m1-u14-irregular-verbs-tr-001` [translation, d2]: p="Translate into English: Ich bin gestern in die Schule gegangen." c="I went to school yesterday." a=["I went to school yesterday.","Yesterday I went to school."] ds=[]
- `m1-u14-irregular-verbs-tr-002` [translation, d3]: p="Translate into English: Sie hat einen Brief geschrieben und ihn abgeschickt." c="She wrote a letter and sent it." a=["She wrote a letter and sent it.","She wrote a letter and she sent it."] ds=[]
- `m1-u14-irregular-verbs-mt-001` [matching, d2]: p="Match the base form with its past simple form:" c="{\"1\":\"d\",\"2\":\"e\",\"3\":\"a\",\"4\":\"b\",\"5\":\"c\"}" a=["{\"1\":\"d\",\"2\":\"e\",\"3\":\"a\",\"4\":\"b\",\"5\":\"c\"}"] ds=["1: go|2: see|3: take|4: make|5: come","a: took|b: made|c: came|d: went|e: saw"]
- `m1-u14-irregular-verbs-gf-007` [gap-fill, d3]: p="Yesterday she ___ (find) a cat in the garden." c="found" a=["found"] ds=["finded","find","founds"]
- `m1-u14-irregular-verbs-gf-008` [gap-fill, d4]: p="He ___ (read) the book and then put it on the shelf." c="read" a=["read"] ds=["readed","reads","reeded"]
- `m1-u14-irregular-verbs-cp-001` [context-picker, d3]: p="You are telling your teacher about yesterday. Which sentence uses the past correctly?" c="I ate lunch at school yesterday." a=["I ate lunch at school yesterday."] ds=["I eated lunch at school yesterday.","I eat lunch at school yesterday.","I was eat lunch at school yesterday."]
- `m1-u14-irregular-verbs-mp-001` [matching-pairs, d2]: p="Find the pairs: base form ↔ past form." c="[[\"go\",\"went\"],[\"see\",\"saw\"],[\"take\",\"took\"],[\"have\",\"had\"],[\"make\",\"made\"],[\"come\",\"came\"]]" a=[] ds=[]
- `m1-u14-irregular-verbs-mp-002` [matching-pairs, d3]: p="Find the pairs: base form ↔ past form." c="[[\"eat\",\"ate\"],[\"drink\",\"drank\"],[\"write\",\"wrote\"],[\"read\",\"read\"],[\"give\",\"gave\"],[\"think\",\"thought\"]]" a=[] ds=[]
- `m1-u14-irregular-verbs-gs-001` [group-sort, d3]: p="Sort: does this verb form the past with -ed, or is it irregular?" c="{\"Regular (-ed)\":[\"walk|walked\",\"play|played\",\"want|wanted\",\"like|liked\",\"open|opened\"],\"Irregular\":[\"go|went\",\"see|saw\",\"take|took\",\"have|had\",\"make|made\",\"come|came\"]}" a=[] ds=[]
- `m1-u14-irregular-verbs-ag-001` [anagram, d2]: p="Past form of \"think\":" c="thought" a=["thought"] ds=[]
- `m1-u14-irregular-verbs-ag-002` [anagram, d2]: p="Past form of \"bring\":" c="brought" a=["brought"] ds=[]
- `m1-u14-irregular-verbs-ag-003` [anagram, d3]: p="Past form of \"write\":" c="wrote" a=["wrote"] ds=[]
- `m1-u14-irregular-verbs-ag-004` [anagram, d2]: p="Past form of \"eat\":" c="ate" a=["ate"] ds=[]

### `g1u14.s.past-simple-negative` — Past simple (3) negative with didn't (Past simple (3) Verneinung mit didn't)

Forming the past-simple negative with didn't + base verb. The form is the same for all persons.

v1 floor for this structure: **16 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [past-neg-didnt]: Make the past-simple negative with: person + didn't (did not) + base form of the verb (not the past form!). It is the same for all persons.
  - DE: Die Verneinung im Past simple bildest du so: Person + didn't (did not) + Grundform des Verbs (nicht die Vergangenheitsform!). Sie ist für alle Personen gleich.
  - "I didn't read the book." — "Ich habe das Buch nicht gelesen."
  - "We didn't like the film." — "Der Film hat uns nicht gefallen."
...
v1 seed items (UNTRUSTED):
- `m1-u14-past-simple-negative-gf-002` [gap-fill, d1]: p="She _____ (not/play) football last weekend." c="didn't play" a=["didn't play","did not play"] ds=["didn't played","not played","doesn't play"]
- `m1-u14-past-simple-negative-gf-003` [gap-fill, d2]: p="They _____ (not/go) to the party." c="didn't go" a=["didn't go","did not go"] ds=["didn't went","not went","don't go"]
- `m1-u14-past-simple-negative-gf-004` [gap-fill, d2]: p="He _____ (not/eat) his lunch." c="didn't eat" a=["didn't eat","did not eat"] ds=["didn't ate","not eat","doesn't eat"]
- `m1-u14-past-simple-negative-gf-005` [gap-fill, d3]: p="We _____ (not/have) homework yesterday, _____ we _____ (not/do) any work at home." c="didn't have, so, didn't do" a=["didn't have, so, didn't do"] ds=["didn't had, so, didn't did","didn't have, so, didn't done","don't have, so, don't do"]
- `m1-u14-past-simple-negative-mc-001` [multiple-choice, d2]: p="Which sentence is correct?" c="They didn't do the homework." a=["They didn't do the homework."] ds=["They didn't did the homework.","They don't did the homework.","They no did the homework."]
- `m1-u14-past-simple-negative-ec-001` [error-correction, d2]: p="Find and fix the mistake: He didn't went to the party." c="He didn't go to the party." a=["He didn't go to the party.","go","He did not go to the party."] ds=[]
- `m1-u14-past-simple-negative-ec-002` [error-correction, d2]: p="Find and fix the mistake: She didn't liked the food." c="She didn't like the food." a=["She didn't like the food.","like","She did not like the food."] ds=[]
- `m1-u14-past-simple-negative-ec-003` [error-correction, d3]: p="Find and fix the mistake: I no went to school yesterday." c="I didn't go to school yesterday." a=["I didn't go to school yesterday.","I did not go to school yesterday.","didn't","go","did not"] ds=[]
- `m1-u14-past-simple-negative-tf-001` [transformation, d2]: p="You were sick yesterday and stayed home. Make it negative: I went to school. → I _____ to school." c="didn't go" a=["didn't go","did not go","I didn't go to school.","I didn't go to school","I did not go to school."] ds=[]
- `m1-u14-past-simple-negative-tf-002` [transformation, d2]: p="Your sister was busy with homework last night. Make it negative: She watched TV. → She _____ TV." c="didn't watch" a=["didn't watch","did not watch","She didn't watch TV.","She didn't watch TV","She did not watch TV."] ds=[]
- `m1-u14-past-simple-negative-tr-001` [translation, d2]: p="Translate into English: Ich habe den Film nicht gesehen." c="I didn't see the film." a=["I didn't see the film.","I did not see the film.","I didn't see the movie.","I did not see the movie."] ds=[]
- `m1-u14-past-simple-negative-gf-007` [gap-fill, d3]: p="We ___ (not/have) any money, so we couldn't buy anything." c="didn't have" a=["didn't have","did not have"] ds=["didn't had","not had","haven't"]
- `m1-u14-past-simple-negative-gf-008` [gap-fill, d3]: p="He ___ (not/eat) all the pizza. There was some left." c="didn't eat" a=["didn't eat","did not eat"] ds=["didn't ate","not ate","doesn't eat"]
- `m1-u14-past-simple-negative-qf-001` [question-formation, d3]: p="Statement: He went to school. Ask a YES/NO question." c="Did he go to school?" a=["Did he go to school?","Did he go to school"] ds=[]
- `m1-u14-past-simple-negative-cp-001` [gap-fill, d1]: p="I _____ (not/see) the film yesterday." c="didn't see" a=["didn't see","did not see"] ds=["didn't saw","not see","don't see"]
- `m1-u14-past-simple-negative-gs-001` [group-sort, d2]: p="Sort: correct or incorrect past negative?" c="{\"Correct\":[\"I didn't go.\",\"She didn't see it.\",\"We didn't have time.\",\"He didn't play.\"],\"Incorrect\":[\"I didn't went.\",\"She didn't saw it.\",\"We didn't had time.\",\"He didn't played.\"]}" a=[] ds=[]
...
Write `content/corpus/units/g1-u14/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g1u14.s.past-simple-irregular",
