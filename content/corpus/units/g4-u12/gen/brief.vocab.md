# Vocab generation brief — g4-u12 (MORE! 4, Unit 12)

<!-- domigo:gen vocab g4-u12 bank=8238afa2164f prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g4u12.w.asteroid | asteroid | Asteroid | phrase | — | Most asteroids are found between Mars and Jupiter. | — | asteroid |
| g4u12.w.astronaut | astronaut | Astronaut/in | phrase | — | Astronauts travel into space in a spacecraft. | — | astronaut |
| g4u12.w.explosion | explosion | Explosion | phrase | — | There were two loud explosions and then the building collapsed. | — | explosion |
| g4u12.w.orbit | orbit | Umlaufbahn | phrase | — | The space shuttle stayed in orbit around the Earth. | — | orbit |
| g4u12.w.plaque | plaque | Plakette | phrase | — | There is a plaque on the moon that says when the first landing took place. | — | plaque |
| g4u12.w.space-shuttle | space shuttle | Raumfähre | phrase | — | A space shuttle is used to travel between the Earth and a space station. | — | space shuttle |
| g4u12.w.altogether | altogether | insgesamt | phrase | — | Altogether there are 8 planets in our solar system. | — | altogether |
| g4u12.w.atmosphere | atmosphere | Atmosphäre | phrase | — | The atmosphere surrounds the Earth and protects it from the sun's rays. | — | atmosphere |
| g4u12.w.crew | crew | Mannschaft ; Besatzung | phrase | — | The crew of a spaceship have to train very hard before they can go into space. | — | crew |
| g4u12.w.disgusting | disgusting | ekelhaft | phrase | — | Sorry, but this pizza is disgusting. It tastes horrible. | — | disgusting |
| g4u12.w.engineering | engineering | Maschinenbau ; Ingenieurswesen | phrase | — | A spaceship is a fantastic work of engineering. | — | engineering |
| g4u12.w.mankind | mankind | Menschheit | phrase | — | One day mankind might need a new home on another planet. | — | mankind |
| g4u12.w.space-travel | space travel | Raumfahrt | phrase | — | Space travel has made it possible to land on the moon. | — | space travel |
| g4u12.w.sunrise | sunrise | Sonnenaufgang | phrase | — | Sunrise tomorrow is around 6 a.m. | — | sunrise |
| g4u12.w.sunset | sunset | Sonnenuntergang | phrase | — | Sunset tomorrow is around 8.30 p.m. | — | sunset |
| g4u12.w.warning | warning | Warnung | phrase | — | There's a warning not to go into the water. There are jellyfish. | — | warning |
| g4u12.w.advert | advert | Reklame ; Anzeige | phrase | — | You want to sell your car? I saw your advert in the local newspaper. | — | advert |
| g4u12.w.spacecraft | spacecraft | Raumfahrzeug | phrase | — | In the future there will probably be several kinds of spacecraft to take us into space. | — | spacecraft |
| g4u12.w.commercial | commercial | kommerziell | phrase | — | We use the plane for private and commercial flights. | — | commercial |
| g4u12.w.demand | demand | verlangen | phrase | — | Tell me why you did that. I demand an answer. | — | demand |
| g4u12.w.multibillion | multibillion | Multimilliarden- | phrase | — | It's a very expensive multibillion-dollar project. | — | multibillion |
| g4u12.w.privately-owned | privately owned | im Privatbesitz befindlich | phrase | — | The race was won by a privately owned yacht. | — | privately owned |
| g4u12.w.celebrate | celebrate | feiern | phrase | — | She wants to celebrate her birthday next weekend. | — | celebrate |
| g4u12.w.depressed | depressed | deprimiert | phrase | — | He and his girlfriend broke up last week. He's miserable and feeling very depressed. | — | depressed |
| g4u12.w.disturb | disturb | stören | phrase | — | I'm sorry to disturb you, but I think you should see this now. | — | disturb |
| g4u12.w.masterpiece | masterpiece | Meisterwerk | phrase | — | Her picture was a brilliant piece of art – a masterpiece. | — | masterpiece |
| g4u12.w.neither-nor | neither ... nor | weder ... noch | phrase | — | Neither you nor I will be able to travel to other planets for many years. | — | neither ... nor |
| g4u12.w.reply | reply | erwidern ; antworten | phrase | — | She replied to his question immediately. | — | reply |
| g4u12.w.biosphere | biosphere | Lebensraum ; Biosphäre | phrase | — | The biosphere is the area of the planet where organisms live, including the ground and the air. | — | biosphere |
| g4u12.w.genetic-engineering | genetic engineering | Gentechnik | phrase | — | Cloning is an example of genetic engineering. | — | genetic engineering |
| g4u12.w.gravity | gravity | Schwerkraft | phrase | — | It's gravity that makes satellites move around the Earth. | — | gravity |
| g4u12.w.resource | resource | Hilfs-/Mittel ; Quelle | phrase | — | The computer lab is an essential resource for students. | — | resource |
| g4u12.w.surface | surface | Oberfläche | phrase | — | About one third of the Earth's surface is land. | — | surface |
| g4u12.w.uninhabitable | uninhabitable | unbewohnbar | phrase | — | After the earthquake, many of the ruined houses were uninhabitable. | — | uninhabitable |
| g4u12.w.commander | commander | Kommandant/in | phrase | — | The commander of the spaceship gave his orders to the crew. | — | commander |
| g4u12.w.tiring | tiring | ermüdend | phrase | — | Shopping all day was very tiring. I'm exhausted! | — | tiring |
...
- `g4u12.w.asteroid` ← v1 `asteroid`: d="A large rock that orbits the sun in space" · s="Scientists are tracking a large _____ that will pass close to Earth next year." · a=["asteroid","asteroids"] · mc=["comet","meteor","satellite"]
- `g4u12.w.astronaut` ← v1 `astronaut`: d="A person who travels and works in space" · s="She dreams of becoming an _____ and travelling to Mars one day." · a=["astronaut","astronauts"] · mc=["cosmonaut","pilot","scientist"]
- `g4u12.w.explosion` ← v1 `explosion`: d="A sudden and violent burst of energy, often causing damage" · s="We heard a loud _____ and then saw smoke rising from the factory." · a=["explosion","explosions"] · mc=["eruption","collision","impact"]
- `g4u12.w.orbit` ← v1 `orbit`: d="The curved path that a planet or spacecraft follows around a star or planet" · s="The International Space Station is in _____ about 400 kilometres above the Earth." · a=["orbits"] · mc=["axis","rotation","trajectory"]
- `g4u12.w.plaque` ← v1 `plaque`: d="A flat piece of metal or stone with writing on it, placed on a wall to remember an event" · s="There is a _____ on the wall of the old school showing when it was built." · a=["plaques"] · mc=["medal","trophy","monument"]
- `g4u12.w.space-shuttle` ← v1 `space shuttle`: d="A reusable spacecraft designed to carry astronauts into orbit and return to Earth" · s="The last American _____ flew its final mission in 2011." · a=["space shuttles"] · mc=["space station","spacecraft","rocket"]
- `g4u12.w.altogether` ← v1 `altogether`: d="In total; considering everything" · s="We invited 30 guests, but _____ only 22 people came to the party." · a=[] · mc=["approximately","entirely","mostly"]
- `g4u12.w.atmosphere` ← v1 `atmosphere`: d="The layer of gases surrounding the Earth or another planet" · s="Mars has a very thin _____, which makes it difficult for humans to breathe there." · a=[] · mc=["stratosphere","climate","environment"]
- `g4u12.w.crew` ← v1 `crew`: d="A group of people who work together, especially on a ship, aircraft, or spacecraft" · s="The _____ of the sailing boat worked together to survive the storm." · a=["crews"] · mc=["team","staff","squad"]
- `g4u12.w.disgusting` ← v1 `disgusting`: d="Extremely unpleasant; causing a strong feeling of dislike" · s="The milk in the fridge smells _____. I think it has gone off." · a=[] · mc=["revolting","awful","dreadful"]
- `g4u12.w.engineering` ← v1 `engineering`: d="The work of designing and building machines, bridges, roads, or systems" · s="She wants to study _____ at university because she loves building things." · a=[] · mc=["architecture","technology","construction"]
- `g4u12.w.mankind` ← v1 `mankind`: d="All human beings considered as a group; the human race" · s="Landing on the moon was one of the greatest achievements of _____." · a=["humankind"] · mc=["humanity","civilisation","population"]
- `g4u12.w.space-travel` ← v1 `space travel`: d="The activity of going beyond the Earth's atmosphere into the universe" · s="Do you think _____ will become normal for ordinary people in the future?" · a=[] · mc=["time travel","air travel","space exploration"]
- `g4u12.w.sunrise` ← v1 `sunrise`: d="The time when the sun first appears in the sky in the morning" · s="We woke up early to watch the _____ from the top of the mountain." · a=["sunrises"] · mc=["sunset","dawn","daylight"]
- `g4u12.w.sunset` ← v1 `sunset`: d="The time when the sun disappears below the horizon in the evening" · s="The _____ over the lake was so beautiful that everyone stopped to take photos." · a=["sunsets"] · mc=["sunrise","dusk","twilight"]
- `g4u12.w.warning` ← v1 `warning`: d="A statement telling someone about a possible danger or problem" · s="The teacher gave him a _____ that he would fail if he didn't start studying." · a=["warnings"] · mc=["threat","alarm","notice"]
- `g4u12.w.advert` ← v1 `advert`: d="A notice, picture, or short film designed to sell a product (British English)" · s="I saw an _____ for cheap flights to London and booked one immediately." · a=["adverts","advertisement","ad"] · mc=["poster","commercial","flyer"]
- `g4u12.w.spacecraft` ← v1 `spacecraft`: d="A vehicle designed for travelling in space" · s="The _____ landed safely on Mars after a seven-month journey through space." · a=[] · mc=["satellite","aircraft","rocket"]
- `g4u12.w.commercial` ← v1 `commercial`: d="Related to buying and selling goods; done to make a profit" · s="The airport is used for both military and _____ flights." · a=[] · mc=["industrial","financial","professional"]
- `g4u12.w.demand` ← v1 `demand`: d="To ask for something very firmly and urgently" · s="The angry customers _____ to speak to the manager right away." · a=[] · mc=["request","require","insist"]
- `g4u12.w.multibillion` ← v1 `multibillion`: d="Involving many billions (of dollars, euros, etc.)" · s="The space programme is a _____ dollar industry, involving huge amounts of money from many countries." · a=[] · mc=["multimillion","trillion","billion"]
- `g4u12.w.privately-owned` ← v1 `privately owned`: d="Belonging to a private person or company, not the government" · s="That island is _____, so nobody is allowed to visit without permission." · a=[] · mc=["publicly owned","state-owned","government-run"]
- `g4u12.w.celebrate` ← v1 `celebrate`: d="To do something special and enjoyable for an important event or achievement" · s="How are you going to _____ your birthday this year?" · a=[] · mc=["commemorate","honour","observe"]
- `g4u12.w.depressed` ← v1 `depressed`: d="Feeling very unhappy and without hope for a long time" · s="She has been feeling _____ since she moved to a new town and left all her friends behind." · a=[] · mc=["disappointed","miserable","exhausted"]
- `g4u12.w.disturb` ← v1 `disturb`: d="To interrupt someone or cause them to feel worried or upset" · s="Please don't _____ your sister while she is doing her homework." · a=[] · mc=["interrupt","annoy","bother"]
- `g4u12.w.masterpiece` ← v1 `masterpiece`: d="A work of art, music, or writing that is considered the best of its kind" · s="Many people consider the Mona Lisa to be Leonardo da Vinci's greatest _____." · a=["masterpieces"] · mc=["classic","original","bestseller"]
- `g4u12.w.neither-nor` ← v1 `neither … nor`: d="Used to say that two or more things are not true or do not happen" · s="She wanted _____ tea nor coffee, so she asked for water instead." · a=["neither","neither nor","neither ... nor","neither … nor"] · mc=["either … or","both … and","not only … but also"]
- `g4u12.w.reply` ← v1 `reply`: d="To say or write something as an answer to someone" · s="I sent her a message three days ago, but she still hasn't _____." · a=["reply","replied"] · mc=["respond","answer","react"]
- `g4u12.w.biosphere` ← v1 `biosphere`: d="The parts of the Earth where life exists, including land, water, and air" · s="Protecting the _____ means protecting all living things on our planet." · a=["biospheres"] · mc=["atmosphere","ecosystem","hemisphere"]
- `g4u12.w.genetic-engineering` ← v1 `genetic engineering`: d="The science of changing the genes of a living thing to give it new qualities" · s="Some scientists use _____ to create plants that can survive without much water." · a=[] · mc=["biomedical science","nuclear energy","artificial intelligence"]
- `g4u12.w.gravity` ← v1 `gravity`: d="The force that pulls objects towards the Earth and keeps us on the ground" · s="On the moon, there is less _____, so astronauts can jump much higher." · a=[] · mc=["magnetism","friction","pressure"]
- `g4u12.w.resource` ← v1 `resource`: d="Something useful that a country or person has, such as money, land, or energy" · s="Water is our most important natural _____ and we must not waste it." · a=["resources"] · mc=["supply","reserve","material"]
- `g4u12.w.surface` ← v1 `surface`: d="The outer or top part of something" · s="The _____ of the lake was perfectly still on that calm morning." · a=["surfaces"] · mc=["bottom","layer","edge"]
- `g4u12.w.uninhabitable` ← v1 `uninhabitable`: d="Not suitable for people to live in" · s="Without clean water, the village became _____ and people had to leave." · a=[] · mc=["uninhabited","unlivable","deserted"]
- `g4u12.w.commander` ← v1 `commander`: d="The person in charge of a group of people, especially in the military or on a mission" · s="The _____ told the soldiers to wait for further instructions." · a=["commanders"] · mc=["captain","lieutenant","officer"]
- `g4u12.w.tiring` ← v1 `tiring`: d="Making you feel that you need to rest or sleep" · s="The hike up the mountain was really _____. We all needed a long rest afterwards." · a=[] · mc=["exhausting","boring","challenging"]
...
Write `content/corpus/units/g4-u12/gen/vocab.draft.json`:
