# Grammar generation brief — g3-u05 (MORE! 3, Unit 5)

<!-- domigo:gen grammar g3-u05 bank=b87cdd08c5c9 prompt=4b9164076103 -->
...
### `g3u05.s.first-conditional` — 1st conditional (Erster Konditional (Bedingungssatz Typ 1))

The first conditional for real, likely situations and their future consequences: If + present simple in the if-clause and will + base verb in the main clause.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [form-if-present-will]: Form it with If + present simple in the if-clause and will + base verb in the main clause. The if-clause never uses will. Use a comma when the if-clause comes first.
  - DE: Du bildest ihn mit If + Present simple im if-Satz und will + Grundform im Hauptsatz. Im if-Satz steht nie will. Beistrich, wenn der if-Satz zuerst kommt.
  - "If you put your handbag on the floor, you'll never have money." — "Wenn du deine Handtasche auf den Boden stellst, wirst du nie Geld haben."
  - "You'll have bad luck if you walk on cracks in the pavement." — "Du wirst Pech haben, wenn du auf Risse im Gehweg trittst."
- rule [use-real-consequences]: Use it to describe what consequences a real, possible action or situation will have.
  - DE: Du verwendest ihn, um zu beschreiben, welche Folgen eine reale, mögliche Handlung oder Situation haben wird.
  - "If you don't whistle, there won't be any rain." — "Wenn du nicht pfeifst, wird es keinen Regen geben."
  - "What will happen if you break a mirror?" — "Was wird passieren, wenn du einen Spiegel zerbrichst?"

common errors:
- Using will in the if-clause instead of the present simple: ✗ "If I will go to London, I will visit Big Ben." → ✓ "If I go to London, I will visit Big Ben."
- Using the present continuous instead of the present simple in the if-clause: ✗ "If it is raining tomorrow, we'll stay inside." → ✓ "If it rains tomorrow, we'll stay inside."

SB box `g3/sb/More 3 SB Unit 5.txt#grammar-1` — 🔹 1st conditional:
```
...
- `m3-u5-first-conditional-gf-001` [gap-fill, d1]: p="If it ___ (rain), we will stay at home." c="rains" a=["rains"] ds=["will rain","rained","raining"]
- `m3-u5-first-conditional-gf-002` [gap-fill, d1]: p="If you study hard, you ___ pass the test." c="will" a=["will","'ll"] ds=["would","are","do"]
- `m3-u5-first-conditional-gf-003` [gap-fill, d2]: p="We ___ (go) to the park if the weather is nice." c="will go" a=["will go","'ll go"] ds=["would go","go","are going"]
- `m3-u5-first-conditional-gf-004` [gap-fill, d3]: p="If she ___ (not / hurry), she will miss the bus." c="doesn't hurry" a=["doesn't hurry","does not hurry"] ds=["won't hurry","don't hurry","isn't hurrying"]
- `m3-u5-first-conditional-gf-005` [gap-fill, d4]: p="If I ___ (have) enough money, I will buy a new skateboard." c="have" a=["have"] ds=["will have","had","would have"]
- `m3-u5-first-conditional-gf-006` [gap-fill, d5]: p="If you ___ (not / eat) breakfast, you won't have energy for PE class." c="don't eat" a=["don't eat","do not eat"] ds=["won't eat","didn't eat","aren't eating"]
- `m3-u5-first-conditional-mc-001` [multiple-choice, d2]: p="Which sentence is correct?" c="If it snows tomorrow, we will build a snowman." a=["If it snows tomorrow, we will build a snowman."] ds=["If it will snow tomorrow, we will build a snowman.","If it snows tomorrow, we build a snowman.","If it snowed tomorrow, we will build a snowman."]
- `m3-u5-first-conditional-mc-002` [multiple-choice, d3]: p="Choose the correct sentence:" c="I won't go to the party if I don't feel better." a=["I won't go to the party if I don't feel better."] ds=["I won't go to the party if I won't feel better.","I don't go to the party if I don't feel better.","I won't go to the party if I didn't feel better."]
- `m3-u5-first-conditional-mc-003` [multiple-choice, d5]: p="Choose the correct first conditional sentence:" c="If you eat too much, you'll feel sick." a=["If you eat too much, you'll feel sick."] ds=["If you will eat too much, you feel sick.","If you ate too much, you'll feel sick.","If you eat too much, you would feel sick."]
- `m3-u5-first-conditional-ec-001` [error-correction, d1]: p="Find and fix the mistake: If it will rain, we will stay inside." c="If it rains, we will stay inside." a=["If it rains, we will stay inside.","If it rains we will stay inside.","If it rains, we will stay inside"] ds=[]
- `m3-u5-first-conditional-ec-002` [error-correction, d3]: p="Find and fix the mistake: If you eat too much, you feel sick." c="If you eat too much, you will feel sick." a=["If you eat too much, you will feel sick.","If you eat too much, you'll feel sick.","If you eat too much, you will feel sick"] ds=[]
- `m3-u5-first-conditional-ec-003` [error-correction, d4]: p="Find and fix the mistake: If she would study more, she will get better marks." c="If she studies more, she will get better marks." a=["If she studies more, she will get better marks.","If she studies more, she will get better marks","If she studies more, she'll get better marks."] ds=[]
- `m3-u5-first-conditional-tf-001` [gap-fill, d2]: p="Your younger brother is worried about his test tomorrow. Encourage him: 'If you ________ (study) hard, you ________ (pass) the test.'" c="study ... will pass" a=["study ... will pass","study ... 'll pass","study, will pass"] ds=["study ... would pass","study ... can pass","study ... pass"]
- `m3-u5-first-conditional-tf-002` [gap-fill, d3]: p="You're looking out the window at grey clouds with your little cousin. Make a plan: 'If it ________ (snow), we ________ (make) a snowman!'" c="snows ... will make" a=["snows ... will make","snows ... 'll make","snows, will make"] ds=["snows ... would make","snows ... can make","snows ... make"]
- `m3-u5-first-conditional-tf-003` [transformation, d4]: p="Your sister is still getting ready and the bus leaves in 5 minutes. Complete the warning: 'If she ________ (not hurry), she ________ (miss) the bus!'" c="doesn't hurry ... will miss" a=["doesn't hurry ... will miss","doesn't hurry ... 'll miss","does not hurry ... will miss"] ds=[]
- `m3-u5-first-conditional-tr-001` [translation, d2]: p="🇩🇪 Wenn es morgen regnet, werden wir zu Hause bleiben." c="If it rains tomorrow, we will stay at home." a=["If it rains tomorrow, we will stay at home.","If it rains tomorrow, we'll stay at home.","If it rains tomorrow we will stay at home.","We will stay at home if it rains tomorrow."] ds=[]
- `m3-u5-first-conditional-tr-002` [translation, d4]: p="🇩🇪 Wenn du nicht bald kommst, gehe ich ohne dich." c="If you don't come soon, I will go without you." a=["If you don't come soon, I will go without you.","If you don't come soon, I'll go without you.","If you do not come soon, I will go without you.","I will go without you if you don't come soon."] ds=[]
- `m3-u5-first-conditional-sb-001` [sentence-building, d3]: p="Put the words in the correct order: miss / the bus / if / hurry / you / will / don't / you" c="If you don't hurry, you will miss the bus." a=["If you don't hurry, you will miss the bus.","If you don't hurry you will miss the bus.","You will miss the bus if you don't hurry."] ds=[]
- `m3-u5-first-conditional-mt-001` [matching, d3]: p="Match each if-clause with the correct result. 1: If it rains, 2: If you don't study, 3: If we hurry, 4: If she calls me," c="{\"1\":\"c\",\"2\":\"a\",\"3\":\"d\",\"4\":\"b\"}" a=["{\"1\":\"c\",\"2\":\"a\",\"3\":\"d\",\"4\":\"b\"}"] ds=["a: you will fail the test.","b: I will tell her the news.","c: we will get wet.","d: we will catch the train."]
- `m3-u5-first-conditional-cp-001` [context-picker, d2]: p="Your friend says: 'If it rains tomorrow, we'll stay home.' Is this about a real or imaginary situation? Which sentence type fits?" c="First conditional — it's a real possibility for tomorrow." a=["First conditional — it's a real possibility for tomorrow."] ds=["Second conditional — it's an imaginary situation that probably won't happen.","Zero conditional — it's a general fact that is always true.","Past conditional — it's about something that already happened."]
- `m3-u5-first-conditional-gf-020` [gap-fill, d1]: p="If she ___ (work) hard, she will get good marks." c="works" a=["works"] ds=["will work","worked","working"]
- `m3-u5-first-conditional-gf-021` [gap-fill, d2]: p="We ___ be late if we don't hurry up." c="will" a=["will","'ll"] ds=["would","are going","do"]
- `m3-u5-first-conditional-gf-022` [gap-fill, d2]: p="If I ___ (have) enough money, I'll buy a new skateboard." c="have" a=["have"] ds=["will have","had","am having"]
- `m3-u5-first-conditional-gf-023` [gap-fill, d3]: p="If you ___ (not/eat) your vegetables, you won't get any dessert." c="don't eat" a=["don't eat","do not eat"] ds=["won't eat","didn't eat","aren't eating"]
- `m3-u5-first-conditional-gf-024` [gap-fill, d4]: p="If the weather ___ (be) nice tomorrow, we ___ (go) to the beach." c="is ... will go" a=["is ... will go","is ... 'll go","is...will go","is...'ll go"] ds=["will be ... go","is ... go","will be ... will go"]
- `m3-u5-first-conditional-gf-025` [gap-fill, d5]: p="I ___ (not/pass) the exam if I ___ (not/study) harder." c="won't pass ... don't study" a=["won't pass ... don't study","will not pass ... do not study","won't pass...don't study","will not pass...do not study"] ds=["don't pass ... won't study","won't pass ... won't study","didn't pass ... didn't study"]
- `m3-u5-first-conditional-mc-020` [multiple-choice, d2]: p="Which sentence correctly uses the first conditional?" c="If you touch that, you'll burn your hand." a=["If you touch that, you'll burn your hand."] ds=["If you will touch that, you'll burn your hand.","If you touch that, you burn your hand.","If you touched that, you'll burn your hand."]
- `m3-u5-first-conditional-mc-021` [multiple-choice, d3]: p="Choose the correct sentence about a school trip." c="If it rains tomorrow, we won't go on the trip." a=["If it rains tomorrow, we won't go on the trip."] ds=["If it will rain tomorrow, we won't go on the trip.","If it rained tomorrow, we won't go on the trip.","If it rains tomorrow, we don't go on the trip."]
- `m3-u5-first-conditional-mc-022` [multiple-choice, d4]: p="Which sentence is NOT a first conditional?" c="If I had a million euros, I would buy a house." a=["If I had a million euros, I would buy a house."] ds=["If you are hungry, I'll make you a sandwich.","We'll miss the bus if we don't leave now.","If she passes the test, her parents will be happy."]
- `m3-u5-first-conditional-ec-020` [error-correction, d2]: p="Find and fix the mistake: If it will be sunny, we will go swimming." c="is" a=["is","If it is sunny","If it is sunny, we will go swimming.","If it is sunny, we will go swimming"] ds=[]
- `m3-u5-first-conditional-ec-021` [error-correction, d3]: p="Find and fix the mistake: If you won't hurry, we'll be late for school." c="don't hurry" a=["don't hurry","do not hurry","If you don't hurry, we'll be late for school.","If you don't hurry, we'll be late for school"] ds=[]
- `m3-u5-first-conditional-ec-022` [error-correction, d5]: p="Find and fix the mistake: If she will study hard, she will passes the exam." c="If she studies hard, she will pass the exam." a=["If she studies hard, she will pass the exam.","If she studies hard, she will pass the exam"] ds=[]
- `m3-u5-first-conditional-tf-020` [gap-fill, d3]: p="Your friend is worried about the football match. Encourage them: 'If you ________ (practice) every day, you ________ (play) really well on Saturday.'" c="practice ... will play" a=["practice ... will play","practice ... 'll play","practice...will play","practice...'ll play","practise ... will play","practise...'ll play"] ds=["practice ... would play","practice ... can play","practice ... play"]
- `m3-u5-first-conditional-tf-021` [transformation, d4]: p="You're warning your little sister about the consequences. Complete: 'If you ________ (not/finish) your homework, Mum ________ (not/let) you play outside.'" c="don't finish ... won't let" a=["don't finish ... won't let","do not finish ... will not let","don't finish...won't let","do not finish...will not let"] ds=[]
- `m3-u5-first-conditional-tr-020` [translation, d3]: p="🇩🇪 Wenn du nicht aufpasst, wirst du hinfallen." c="If you don't pay attention, you will fall." a=["If you don't pay attention, you will fall.","If you don't pay attention, you will fall","If you don't pay attention, you'll fall.","You will fall if you don't pay attention.","If you aren't careful, you will fall.","If you aren't careful, you'll fall."] ds=[]
- `m3-u5-first-conditional-tr-021` [translation, d4]: p="🇩🇪 Wenn wir den Bus verpassen, werden wir zu spät in die Schule kommen." c="If we miss the bus, we will be late for school." a=["If we miss the bus, we will be late for school.","If we miss the bus, we will be late for school","If we miss the bus, we'll be late for school.","We will be late for school if we miss the bus.","We'll be late for school if we miss the bus."] ds=[]
- `m3-u5-first-conditional-sb-020` [sentence-building, d2]: p="Put the words in the correct order: if / rains / it / won't / we / go / the / to / park" c="If it rains, we won't go to the park." a=["If it rains, we won't go to the park.","If it rains, we won't go to the park","We won't go to the park if it rains.","We won't go to the park if it rains"] ds=[]
- `m3-u5-first-conditional-sb-021` [sentence-building, d4]: p="Put the words in the correct order: will / you / if / be / your / you / happy / parents / get / marks / good" c="Your parents will be happy if you get good marks." a=["Your parents will be happy if you get good marks.","Your parents will be happy if you get good marks","If you get good marks, your parents will be happy.","If you get good marks, your parents will be happy"] ds=[]
- `m3-u5-first-conditional-mt-020` [matching, d3]: p="Match each if-clause with the correct result. 1: If I don't feel well tomorrow, 2: If we save enough money, 3: If the bus is late, 4: If you practise every day, 5: If they don't invite me," c="{\"1\":\"e\",\"2\":\"c\",\"3\":\"a\",\"4\":\"d\",\"5\":\"b\"}" a=["{\"1\":\"e\",\"2\":\"c\",\"3\":\"a\",\"4\":\"d\",\"5\":\"b\"}"] ds=["a: we'll walk to school.","b: I won't go to the party.","c: we'll go on holiday to Italy.","d: you'll get much better at the guitar.","e: I'll stay at home."]
- `m3-u5-first-conditional-cp-020` [context-picker, d3]: p="Your mum is talking about the weekend plans. She says: 'We might go to the zoo.' Which reply uses the first conditional correctly?" c="If we go to the zoo, I'll take my camera." a=["If we go to the zoo, I'll take my camera."] ds=["If we will go to the zoo, I'll take my camera.","If we went to the zoo, I'll take my camera.","If we go to the zoo, I take my camera."]

### `g3u05.s.unless` — unless (unless (es sei denn / wenn ... nicht))

unless as a one-word way of saying 'if ... not' in conditional sentences. Because unless already contains the negative idea, the verb after it stays affirmative. Taught in the same unit-5 box as the first conditional.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [unless-means-if-not]: unless means 'if ... not'. The verb after unless is always affirmative, because the 'not' is already inside unless.
  - DE: unless bedeutet 'wenn ... nicht'. Das Verb nach unless ist immer bejahend, weil das 'nicht' schon in unless steckt.
  - "I'll go and look for him after breakfast, unless he comes here first." — "Ich gehe ihn nach dem Frühstück suchen, es sei denn, er kommt zuerst hierher."
  - "Unless you put up a spirit screen, the ghosts can follow you into your home." — "Wenn du keine Geisterwand aufstellst, können dir die Geister in dein Zuhause folgen."
- rule [transform-if-not]: To turn 'if ... not' into unless, drop the not/don't/doesn't and replace if with unless; the meaning stays the same.
  - DE: Um 'if ... not' in unless umzuwandeln, lässt du not/don't/doesn't weg und ersetzt if durch unless; die Bedeutung bleibt gleich.
  - "If you don't hurry, you'll be late. = Unless you hurry, you'll be late." — "Wenn du dich nicht beeilst, kommst du zu spät. = Es sei denn, du beeilst dich, kommst du zu spät."

common errors:
- Adding a negative verb after unless (double negative): ✗ "Unless you don't hurry, you'll be late." → ✓ "Unless you hurry, you'll be late."
- Using unless where a positive condition needs if: ✗ "Unless you study, you'll pass the exam." → ✓ "If you study, you'll pass the exam."
...
v1 seed items (UNTRUSTED):
- `m3-u5-unless-gf-001` [gap-fill, d1]: p="I won't go to the party ___ you come with me." c="unless" a=["unless"] ds=["if","when","until"]
- `m3-u5-unless-gf-002` [gap-fill, d2]: p="You will be late ___ you leave now." c="unless" a=["unless"] ds=["if","because","although"]
- `m3-u5-unless-gf-003` [gap-fill, d3]: p="We will have the picnic ___ it rains." c="unless" a=["unless"] ds=["if","whether","while"]
- `m3-u5-unless-gf-004` [gap-fill, d4]: p="She won't pass the exam ___ she studies harder." c="unless" a=["unless"] ds=["if","so","but"]
- `m3-u5-unless-gf-005` [gap-fill, d4]: p="The match will be cancelled ___ the rain stops." c="unless" a=["unless"] ds=["if","except","without"]
- `m3-u5-unless-gf-006` [gap-fill, d5]: p="I'll lend you my book ___ you promise to give it back." c="if" a=["if"] ds=["unless","until","when"]
- `m3-u5-unless-mc-001` [multiple-choice, d2]: p="Which sentence means the same as 'I won't help you if you don't ask me'?" c="I won't help you unless you ask me." a=["I won't help you unless you ask me."] ds=["I won't help you unless you don't ask me.","I will help you unless you ask me.","I won't help you if you ask me."]
- `m3-u5-unless-mc-002` [multiple-choice, d3]: p="Choose the correct sentence:" c="We won't go on the trip unless the weather gets better." a=["We won't go on the trip unless the weather gets better."] ds=["We won't go on the trip unless the weather doesn't get better.","We won't go on the trip unless the weather will get better.","We don't go on the trip unless the weather gets better."]
- `m3-u5-unless-mc-003` [multiple-choice, d5]: p="Which two sentences mean the SAME thing?" c="'Unless he apologises, I won't talk to him.' = 'If he doesn't apologise, I won't talk to him.'" a=["'Unless he apologises, I won't talk to him.' = 'If he doesn't apologise, I won't talk to him.'"] ds=["'Unless he apologises, I won't talk to him.' = 'If he apologises, I won't talk to him.'","'Unless he doesn't apologise, I won't talk to him.' = 'If he doesn't apologise, I won't talk to him.'","'Unless he apologises, I will talk to him.' = 'If he doesn't apologise, I won't talk to him.'"]
- `m3-u5-unless-ec-001` [error-correction, d2]: p="Find and fix the mistake: I won't go unless you don't come with me." c="I won't go unless you come with me." a=["I won't go unless you come with me.","I won't go unless you come with me","I will not go unless you come with me."] ds=[]
- `m3-u5-unless-ec-002` [error-correction, d3]: p="Find and fix the mistake: We will be late unless we will hurry." c="We will be late unless we hurry." a=["We will be late unless we hurry.","We will be late unless we hurry","We'll be late unless we hurry."] ds=[]
- `m3-u5-unless-ec-003` [error-correction, d4]: p="Find and fix the mistake: Unless you don't finish your homework, you can't play outside." c="Unless you finish your homework, you can't play outside." a=["Unless you finish your homework, you can't play outside.","Unless you finish your homework you can't play outside.","If you don't finish your homework, you can't play outside."] ds=[]
- `m3-u5-unless-tf-001` [gap-fill, d2]: p="Your friend is still on the sofa and school starts in 10 minutes. Warn them: 'Unless you ________ now, you ________ late!'" c="leave ... 'll be" a=["leave ... 'll be","leave ... will be","leave, will be","leave, 'll be"] ds=["leave ... won't be","leave ...  would be","leave ...  can be"]
- `m3-u5-unless-tf-002` [gap-fill, d3]: p="Your teammate hasn't been coming to basketball practice. Explain the consequence to her: 'Unless you ________ (practise), you ________ (not improve).'" c="practise ... won't improve" a=["practise ... won't improve","practise ... will not improve","practise, won't improve"] ds=["practise ... will improve","practise ... wouldn't improve","practise ... don't improve"]
- `m3-u5-unless-tf-003` [gap-fill, d2]: p="You're about to leave for a walk and it looks cloudy. Remind your dad: 'Unless we ________ (bring) an umbrella, we ________ (get) wet.'" c="bring ... 'll get" a=["bring ... 'll get","bring ... will get","bring, will get","bring, 'll get"] ds=["bring ... won't get","bring ...  would get","bring ...  can get"]
- `m3-u5-unless-tr-001` [translation, d3]: p="🇩🇪 Ich gehe nicht schwimmen, es sei denn, du kommst mit." c="I won't go swimming unless you come with me." a=["I won't go swimming unless you come with me.","I won't go swimming unless you come along.","I will not go swimming unless you come with me.","Unless you come with me, I won't go swimming."] ds=[]
- `m3-u5-unless-tr-002` [translation, d4]: p="🇩🇪 Du wirst den Test nicht bestehen, wenn du nicht mehr lernst." c="You won't pass the test unless you study more." a=["You won't pass the test unless you study more.","You will not pass the test unless you study more.","Unless you study more, you won't pass the test.","You won't pass the test if you don't study more."] ds=[]
- `m3-u5-unless-sb-001` [sentence-building, d3]: p="Put the words in the correct order: won't / unless / I / you / go / come / with me" c="I won't go unless you come with me." a=["I won't go unless you come with me.","I won't go unless you come with me","Unless you come with me, I won't go."] ds=[]
- `m3-u5-unless-mt-001` [matching, d1]: p="Match each 'unless' sentence with its 'if...not' meaning. 1: Unless you hurry, you'll be late. 2: I won't buy it unless it's cheap. 3: Unless it stops raining, we'll stay inside. 4: She'll be angry unless you say sorry." c="{\"1\":\"c\",\"2\":\"a\",\"3\":\"d\",\"4\":\"b\"}" a=["{\"1\":\"c\",\"2\":\"a\",\"3\":\"d\",\"4\":\"b\"}"] ds=["a: I won't buy it if it isn't cheap.","b: She'll be angry if you don't say sorry.","c: If you don't hurry, you'll be late.","d: If it doesn't stop raining, we'll stay inside."]
- `m3-u5-unless-qf-001` [question-formation, d1]: p="Form a question: 'We won't go unless the weather is nice.' → Ask: 'Will we go if the weather isn't nice?'" c="Will we go if the weather isn't nice?" a=["Will we go if the weather isn't nice?","Will we go if the weather is not nice?","Will we go if the weather isn't nice"] ds=[]
- `m3-u5-unless-gf-020` [gap-fill, d1]: p="We can't play outside ___ it stops raining." c="unless" a=["unless"] ds=["if","when","because"]
- `m3-u5-unless-gf-021` [gap-fill, d2]: p="She won't pass the test ___ she studies harder." c="unless" a=["unless"] ds=["if","until","although"]
- `m3-u5-unless-gf-022` [gap-fill, d3]: p="I'll go to the cinema tomorrow ___ I have too much homework." c="unless" a=["unless"] ds=["if","when","while"]
- `m3-u5-unless-gf-023` [gap-fill, d3]: p="You will get sunburnt ___ you put on sunscreen." c="unless" a=["unless"] ds=["if","because","after"]
- `m3-u5-unless-gf-024` [gap-fill, d4]: p="The match will be cancelled ___ the rain stops before 3 o'clock." c="unless" a=["unless"] ds=["if","when","until"]
- `m3-u5-unless-gf-025` [gap-fill, d5]: p="They won't let you into the pool ___ you wear a swimming cap." c="unless" a=["unless"] ds=["if","while","although"]
- `m3-u5-unless-mc-020` [multiple-choice, d2]: p="Which sentence means the same as 'If you don't clean your room, you can't go out'?" c="Unless you clean your room, you can't go out." a=["Unless you clean your room, you can't go out."] ds=["If you clean your room, you can't go out.","Unless you don't clean your room, you can't go out.","While you clean your room, you can't go out."]
- `m3-u5-unless-mc-021` [multiple-choice, d3]: p="Choose the correct sentence." c="Unless you hurry, we'll miss the train." a=["Unless you hurry, we'll miss the train."] ds=["Unless you won't hurry, we'll miss the train.","Unless you will hurry, we'll miss the train.","Unless you don't hurry, we'll miss the train."]
- `m3-u5-unless-mc-022` [multiple-choice, d5]: p="Which pair of sentences has the same meaning?" c="'I'll help you unless you tell me not to.' = 'I'll help you if you don't tell me not to.'" a=["'I'll help you unless you tell me not to.' = 'I'll help you if you don't tell me not to.'"] ds=["'I'll help you unless you ask.' = 'I'll help you if you ask.'","'Unless you call me, I'll come.' = 'If you call me, I'll come.'","'I won't go unless you don't come.' = 'I won't go if you don't come.'"]
- `m3-u5-unless-ec-020` [error-correction, d2]: p="Find and fix the mistake: Unless you don't hurry, we'll miss the bus." c="Unless you hurry" a=["Unless you hurry","Unless you hurry, we'll miss the bus.","Unless you hurry, we'll miss the bus"] ds=[]
- `m3-u5-unless-ec-021` [error-correction, d3]: p="Find and fix the mistake: Unless you will study, you won't pass the test." c="study" a=["study","Unless you study","Unless you study, you won't pass the test.","Unless you study, you won't pass the test"] ds=[]
- `m3-u5-unless-ec-022` [error-correction, d4]: p="Find and fix the mistake: I'll come to the party if not you tell me it's cancelled." c="unless" a=["unless","unless you tell me","I'll come to the party unless you tell me it's cancelled.","I'll come to the party unless you tell me it's cancelled"] ds=[]
- `m3-u5-unless-tf-020` [gap-fill, d3]: p="Your friend asks if you're going to the school dance. Answer with 'unless': 'I'll go ________ I feel sick on Friday.'" c="unless" a=["unless"] ds=["don't ... will","didn't ... would","won't ... don't"]
- `m3-u5-unless-tf-021` [gap-fill, d4]: p="Rewrite using 'unless' so the meaning stays the same: 'If Tom doesn't apologise, I won't talk to him again.' → '________ Tom ________, I won't talk to him again.'" c="Unless Tom apologises" a=["Unless Tom apologises","Unless Tom apologizes"] ds=["don't ... will","didn't ... would","won't ... don't"]
- `m3-u5-unless-tr-020` [translation, d3]: p="🇩🇪 Wir werden zu spät kommen, es sei denn, wir laufen schneller." c="We will be late unless we run faster." a=["We will be late unless we run faster.","We will be late unless we run faster","We'll be late unless we run faster.","We'll be late unless we walk faster.","Unless we run faster, we will be late.","Unless we run faster, we'll be late."] ds=[]
- `m3-u5-unless-tr-021` [translation, d4]: p="🇩🇪 Du darfst nicht mit deinen Freunden spielen, wenn du deine Hausaufgaben nicht machst." c="You can't play with your friends unless you do your homework." a=["You can't play with your friends unless you do your homework.","You can't play with your friends unless you do your homework","Unless you do your homework, you can't play with your friends.","You won't be allowed to play with your friends unless you do your homework."] ds=[]
- `m3-u5-unless-sb-020` [sentence-building, d2]: p="Put the words in the correct order: unless / you / won't / she / invite / apologise / her / you" c="She won't invite you unless you apologise." a=["She won't invite you unless you apologise.","She won't invite you unless you apologise","She won't invite you unless you apologize.","Unless you apologise, she won't invite you.","Unless you apologize, she won't invite you."] ds=[]
- `m3-u5-unless-sb-021` [sentence-building, d3]: p="Put the words in the correct order: the / unless / cancelled / be / match / will / stops / rain / the" c="The match will be cancelled unless the rain stops." a=["The match will be cancelled unless the rain stops.","The match will be cancelled unless the rain stops","Unless the rain stops, the match will be cancelled.","Unless the rain stops, the match will be cancelled"] ds=[]
- `m3-u5-unless-mt-020` [matching, d3]: p="Match each 'unless' sentence with its 'if...not' equivalent. 1: Unless you study, you'll fail. 2: I won't go unless you come. 3: Unless it rains, we'll have a picnic. 4: She'll be angry unless you call her. 5: We won't win unless we try harder." c="{\"1\":\"c\",\"2\":\"e\",\"3\":\"a\",\"4\":\"d\",\"5\":\"b\"}" a=["{\"1\":\"c\",\"2\":\"e\",\"3\":\"a\",\"4\":\"d\",\"5\":\"b\"}"] ds=["a: If it doesn't rain, we'll have a picnic.","b: We won't win if we don't try harder.","c: If you don't study, you'll fail.","d: She'll be angry if you don't call her.","e: I won't go if you don't come."]
- `m3-u5-unless-qf-020` [question-formation, d4]: p="Your friend says: 'I'm not going to the party.' You want to know the condition. Ask using 'unless'. Start with: 'Will you go...' or 'Won't you go...'" c="Won't you go unless someone invites you?" a=["Won't you go unless someone invites you?","Won't you go unless your friends go too?","Will you go unless it's boring?","Won't you go to the party unless someone asks you?"] ds=[]
...
Write `content/corpus/units/g3-u05/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g3u05.s.first-conditional",
