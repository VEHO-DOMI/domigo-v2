# Grammar generation brief — g2-u13 (MORE! 2, Unit 13)

<!-- domigo:gen grammar g2-u13 bank=5a9152db8a34 prompt=4b9164076103 -->
...
### `g2u13.s.adverbs-manner` — Adverbs of manner (Adverbien der Art und Weise)

Forming adverbs of manner from adjectives with -ly (slowly, carefully, happily) plus the exceptions fast and well, and using them to say how something is done.

v1 floor for this structure: **20 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [adverb-use]: Adverbs of manner say how someone does something or how something happens. An adjective describes a noun; an adverb describes a verb.
  - DE: Mit dem Adverb der Art und Weise drückst du aus, wie jemand etwas macht oder wie etwas geschieht. Mit einem Adjektiv beschreibst du ein Nomen, mit einem Adverb ein Verb.
  - "He walked slowly to the mountain." — "Er ging langsam zum Berg."
  - "The old man shouted angrily at the sky." — "Der alte Mann schrie wütend zum Himmel."
- rule [formation-ly]: Form: adjective + -ly (slow - slowly, quick - quickly, careful - carefully). With adjectives ending in -y, the y becomes i: happy - happily, easy - easily, angry - angrily.
  - DE: Bildung: Adjektiv + ly (slow - slowly, quick - quickly, careful - carefully). Bei Adjektiven, die auf y enden, wird das y zu einem i: happy - happily, easy - easily, angry - angrily.
  - "He carefully broke the stone." — "Er zerbrach den Stein vorsichtig."
  - "I can easily stop the sun." — "Ich kann die Sonne leicht aufhalten."
  - "Look at me, flying quickly." — "Schau mich an, wie schnell ich fliege."
- rule [irregular-adverbs]: Exceptions: fast - fast and good - well take no -ly. They must be learnt by heart.
  - DE: Ausnahmen: fast - fast und good - well - hier hängst du kein -ly an. Diese musst du auswendig lernen.
  - "The weather changed so fast." — "Das Wetter änderte sich so schnell."
  - "I speak English quite well." — "Ich spreche ziemlich gut Englisch."
- rule [adverb-position]: Adverbs of manner usually come after the verb or after its object.
  - DE: Adverbien der Art und Weise stehen meist nach dem Verb oder nach dem Objekt.
  - "She played the piano beautifully." — "Sie spielte wunderschön Klavier."
  - "He read the book quickly." — "Er las das Buch schnell."

common errors:
- Using the adjective instead of the adverb after a verb: ✗ "She sings beautiful." → ✓ "She sings beautifully."
- Adding -ly to irregular adverbs: ✗ "He runs fastly." → ✓ "He runs fast."
- Forming the adverb of good with -ly: ✗ "She speaks English goodly." → ✓ "She speaks English well."

SB box `g2/sb/More 2 SB Unit 13.txt#grammar-1` — Will-future:
```
...
- `m2-u13-adverbs-manner-gf-001` [gap-fill, d1]: p="She sings very ___. Everyone loves her voice." c="beautifully" a=["beautifully"] ds=["beautiful","beautifuly","beautifuler"]
- `m2-u13-adverbs-manner-gf-002` [gap-fill, d1]: p="Please walk ___. The baby is sleeping." c="quietly" a=["quietly"] ds=["quiet","quieter","quietely"]
- `m2-u13-adverbs-manner-gf-003` [gap-fill, d2]: p="He plays the guitar really ___." c="well" a=["well"] ds=["good","goodly","gooder"]
- `m2-u13-adverbs-manner-gf-004` [gap-fill, d2]: p="The children played ___ in the garden all afternoon." c="happily" a=["happily"] ds=["happy","happyly","happier"]
- `m2-u13-adverbs-manner-gf-005` [gap-fill, d1]: p="The cat can run very ___." c="fast" a=["fast"] ds=["fastly","faster","fasting"]
- `m2-u13-adverbs-manner-gf-006` [gap-fill, d4]: p="She did her homework ___ because she wanted to watch TV." c="quickly" a=["quickly"] ds=["quick","quicker","quickfully"]
- `m2-u13-adverbs-manner-mc-001` [multiple-choice, d2]: p="Which sentence is correct?" c="He spoke to the teacher politely." a=["He spoke to the teacher politely."] ds=["He spoke to the teacher polite.","He politely spoke to the teacher politely.","He spoke polite to the teacher."]
- `m2-u13-adverbs-manner-mc-002` [multiple-choice, d3]: p="Which is the correct adverb form of 'good'?" c="well" a=["well"] ds=["goodly","goody","better"]
- `m2-u13-adverbs-manner-mc-003` [multiple-choice, d4]: p="Which sentence uses the adverb correctly?" c="The train arrived late." a=["The train arrived late."] ds=["The train arrived lately.","The train lately arrived.","The train arrived lateful."]
- `m2-u13-adverbs-manner-ec-001` [error-correction, d2]: p="Find and fix the mistake: He runs very fastly in the morning." c="He runs very fast in the morning." a=["He runs very fast in the morning.","He runs very fast in the morning","fast","very fast"] ds=[]
- `m2-u13-adverbs-manner-ec-002` [error-correction, d3]: p="Find and fix the mistake: She speaks English very good." c="She speaks English very well." a=["She speaks English very well.","She speaks English very well","well","very well"] ds=[]
- `m2-u13-adverbs-manner-ec-003` [error-correction, d3]: p="Find and fix the mistake: The dog sat patient and waited for food." c="The dog sat patiently and waited for food." a=["The dog sat patiently and waited for food.","The dog sat patiently and waited for food","patiently","sat patiently"] ds=[]
- `m2-u13-adverbs-manner-tf-001` [gap-fill, d3]: p="Your mum is a very safe driver. Describe how she drives: 'She is a careful driver. → She drives ___.'" c="carefully" a=["carefully"] ds=["careful","careless","more careful"]
- `m2-u13-adverbs-manner-tf-002` [gap-fill, d4]: p="Your brother doesn't try hard at work. Describe how he works: 'He is a lazy worker. → He works ___.'" c="lazily" a=["lazily"] ds=["lazy","lazier","more lazy"]
- `m2-u13-adverbs-manner-tf-003` [gap-fill, d5]: p="Your sister has an amazing voice. Describe how she sings: 'She is a good singer. → She sings ___.'" c="well" a=["well"] ds=["quick","slow","careful"]
- `m2-u13-adverbs-manner-tr-001` [translation, d3]: p="🇩🇪 Er spricht sehr leise." c="He speaks very quietly." a=["He speaks very quietly.","He speaks very quietly","He talks very quietly.","He talks very quietly."] ds=[]
- `m2-u13-adverbs-manner-tr-002` [translation, d4]: p="🇩🇪 Sie schwimmt gut." c="She swims well." a=["She swims well.","She swims well","She can swim well.","She can swim well."] ds=[]
- `m2-u13-adverbs-manner-sb-001` [sentence-building, d3]: p="Put the words in the correct order: slowly / the / walked / old / man / very" c="The old man walked very slowly." a=["The old man walked very slowly.","The old man walked very slowly"] ds=[]
- `m2-u13-adverbs-manner-mt-001` [matching, d5]: p="Match each adjective with its correct adverb form:\n1. happy\n2. good\n3. fast\n4. careful\n5. easy\na. well\nb. easily\nc. carefully\nd. fast\ne. happily" c="{\"1\":\"e\",\"2\":\"a\",\"3\":\"d\",\"4\":\"c\",\"5\":\"b\"}" a=["{\"1\":\"e\",\"2\":\"a\",\"3\":\"d\",\"4\":\"c\",\"5\":\"b\"}"] ds=[]
- `m2-u13-adverbs-manner-qf-001` [question-formation, d2]: p="You want to know how your friend dances. Ask a question using 'how'." c="How does your friend dance?" a=["How does your friend dance?","How does your friend dance","How does he dance?","How does she dance?"] ds=[]

### `g2u13.s.will-future` — Will-future (Will-future (Zukunft mit will))

will/won't + base form for expectations, predictions, hopes, and spontaneous decisions or promises - contrasted with going to for plans.

v1 floor for this structure: **20 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [expectations-predictions]: Use the will-future for expectations, guesses and hopes, and to predict what will happen.
  - DE: Mithilfe der will-future drückst du Erwartungen, Vermutungen und Hoffnungen für die Zukunft aus - und sagst etwas vorher.
  - "It will never end." — "Es wird nie enden."
  - "Some heavy rain will come in from Northern Scotland." — "Aus Nordschottland wird starker Regen aufziehen."
  - "The sun won't come out for another few days." — "Die Sonne wird noch ein paar Tage nicht herauskommen."
- rule [spontaneous-decisions]: Use will when you spontaneously decide or promise to do something.
  - DE: Du verwendest die will-future auch dann, wenn du dich spontan entschließt oder spontan versprichst, etwas zu tun.
  - "I'll get an umbrella." — "Ich hole einen Regenschirm."
  - "I'll fly all around the world." — "Ich werde um die ganze Welt fliegen."
- rule [will-form]: Form: person + will / won't + base form - the same for all persons. Short forms: I will = I'll; I will not = I won't.
  - DE: Bildung: Person + will / won't + Grundform des Verbs - für alle Personen gleich. Kurzformen: I will = I'll, I will not = I won't.
  - "There'll be some showers today." — "Heute wird es einige Regenschauer geben."
  - "All this hard work will kill me." — "Diese ganze harte Arbeit wird mich noch umbringen."
- rule [will-vs-going-to]: will = spontaneous decision, offer or prediction; going to = a plan you made before speaking.
  - DE: will = spontane Entscheidung, Angebot oder Vorhersage; going to = ein Plan, den du schon vor dem Sprechen gefasst hast.
  - "Oh, you need help? I'll carry your bags!" — "Oh, du brauchst Hilfe? Ich trage deine Taschen! (spontan)"
  - "I'm going to visit London next summer." — "Ich besuche nächsten Sommer London. (geplant)"

common errors:
- Adding -s to will for the third person: ✗ "She wills come tomorrow." → ✓ "She will come tomorrow."
- Wrong negative form of will: ✗ "She willn't come." → ✓ "She won't come."
- Using will for an already-made plan: ✗ "I will visit London next summer. (already planned)" → ✓ "I'm going to visit London next summer."
...
v1 seed items (UNTRUSTED):
- `m2-u13-will-future-gf-001` [gap-fill, d1]: p="It's cold! I ___ close the window." c="will" a=["will","'ll"] ds=["am going to","wills","am"]
- `m2-u13-will-future-gf-002` [gap-fill, d1]: p="Don't worry, I ___ help you with your homework." c="will" a=["will","'ll"] ds=["am going to","going to","wills"]
- `m2-u13-will-future-gf-003` [gap-fill, d2]: p="I am not sure, but I think it ___ rain tomorrow." c="will" a=["will","'ll"] ds=["is going to","rains","is raining"]
- `m2-u13-will-future-gf-004` [gap-fill, d3]: p="She ___ be 13 next month. Her birthday is on the 14th." c="will" a=["will","'ll"] ds=["is going to","wills","shall"]
- `m2-u13-will-future-gf-005` [gap-fill, d4]: p="I just decided: he ___ come to the party. He's feeling sick." c="won't" a=["won't","will not"] ds=["willn't","doesn't will","isn't going to"]
- `m2-u13-will-future-gf-006` [gap-fill, d4]: p="The phone is ringing. I ___ answer it!" c="will" a=["will","'ll"] ds=["am going to","would","shall"]
- `m2-u13-will-future-mc-001` [multiple-choice, d2]: p="Which sentence is correct?" c="I think she will like the present." a=["I think she will like the present."] ds=["I think she wills like the present.","I think she will likes the present.","I think she will to like the present."]
- `m2-u13-will-future-mc-002` [multiple-choice, d3]: p="Choose the correct option:" c="We won't be late, I promise." a=["We won't be late, I promise."] ds=["We willn't be late, I promise.","We don't will be late, I promise.","We won't to be late, I promise."]
- `m2-u13-will-future-mc-003` [multiple-choice, d5]: p="Which sentence uses the CORRECT future form?" c="Look at those clouds! It's going to rain." a=["Look at those clouds! It's going to rain."] ds=["Look at those clouds! It will rain.","Look at those clouds! It rains.","Look at those clouds! It's raining."]
- `m2-u13-will-future-ec-001` [error-correction, d3]: p="Find and fix the mistake: She wills come to the party." c="She will come to the party." a=["She will come to the party.","She will come to the party","will","She'll come to the party.","She'll come to the party"] ds=[]
- `m2-u13-will-future-ec-002` [error-correction, d4]: p="Find and fix the mistake: They willn't forget your birthday." c="They won't forget your birthday." a=["They won't forget your birthday.","They won't forget your birthday","won't","They will not forget your birthday.","They will not forget your birthday"] ds=[]
- `m2-u13-will-future-ec-003` [error-correction, d3]: p="Find and fix the mistake: I will to help you carry the bags." c="I will help you carry the bags." a=["I will help you carry the bags.","I will help you carry the bags","I'll help you carry the bags.","I'll help you carry the bags","help"] ds=[]
- `m2-u13-will-future-tf-001` [transformation, d2]: p="Your friend is worried you won't phone tonight. Make a promise: 'I ___ (call) you tonight.'" c="will call you tonight" a=["will call you tonight","'ll call you tonight","I will call you tonight.","I'll call you tonight."] ds=[]
- `m2-u13-will-future-tf-002` [transformation, d3]: p="Your teacher asks if Ben will be ready. You don't think so. Say: 'He ___ (not finish) on time.'" c="won't finish on time" a=["won't finish on time","will not finish on time","He won't finish on time."] ds=[]
- `m2-u13-will-future-tf-003` [gap-fill, d4]: p="You want to know when your cousins arrive. Ask your dad: '___ they ___ (arrive) at six?'" c="Will they arrive" a=["Will they arrive","Will they arrive at six?","Will ... arrive"] ds=["Do they arrive","Are they arrive","Did they arrive"]
- `m2-u13-will-future-tr-001` [translation, d2]: p="🇩🇪 Ich werde dir helfen." c="I will help you." a=["I will help you.","I will help you","I'll help you.","I'll help you"] ds=[]
- `m2-u13-will-future-tr-002` [translation, d3]: p="🇩🇪 Er wird morgen nicht kommen." c="He won't come tomorrow." a=["He won't come tomorrow.","He won't come tomorrow","He will not come tomorrow.","He will not come tomorrow"] ds=[]
- `m2-u13-will-future-sb-001` [sentence-building, d1]: p="Put the words in the correct order: will / you / I / later / call / ." c="I will call you later." a=["I will call you later.","I will call you later"] ds=[]
- `m2-u13-will-future-mt-001` [matching, d5]: p="Match the situation with the correct future form:\n1. I've already bought the tickets. We ... (go) to the cinema.\n2. The doorbell is ringing. I ... (open) the door.\n3. I think robots ... (do) all housework in 2050.\n4. Look at the sky! It ... (snow).\n\na. will open\nb. are going to go\nc. will do\nd. is going to snow" c="{\"1\":\"b\",\"2\":\"a\",\"3\":\"c\",\"4\":\"d\"}" a=["{\"1\":\"b\",\"2\":\"a\",\"3\":\"c\",\"4\":\"d\"}"] ds=[]
- `m2-u13-will-future-cp-001` [context-picker, d2]: p="Your friend drops her heavy bag. You want to help immediately. Which sentence fits this moment?" c="I'll carry that bag for you." a=["I'll carry that bag for you."] ds=["I carry that bag for you.","I'm going to carry that bag for you.","I carried that bag for you."]
...
Write `content/corpus/units/g2-u13/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g2u13.s.adverbs-manner",
