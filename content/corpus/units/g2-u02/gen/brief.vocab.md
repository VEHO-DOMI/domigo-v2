# Vocab generation brief — g2-u02 (MORE! 2, Unit 2)

<!-- domigo:gen vocab g2-u02 bank=ad9510a3c2c7 prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g2u02.w.to-organise | to organise | organisieren | phrase | — | I want to organise a surprise party for her birthday. | organise | to organise ; organise |
| g2u02.w.surprise-party | surprise party | Überraschungsparty | phrase | — | They planned a surprise party. | — | surprise party |
| g2u02.w.admission-fee | admission fee | Eintritt ; Eintrittspreis | phrase | — | The admission fee to enter the museum is 5 pounds. | — | admission fee |
| g2u02.w.artist | artist | Künstler/Künstlerin | phrase | — | He made this painting. He's a great artist. | — | artist |
| g2u02.w.exhibition | exhibition | Ausstellung | phrase | — | I'm going to see the new exhibition at the museum. | — | exhibition |
| g2u02.w.dirty | dirty | dreckig ; schmutzig | phrase | — | The floor was very dirty after the party. | — | dirty |
| g2u02.w.modern | modern | modern | phrase | — | The modern sculpture was missing. | — | modern |
| g2u02.w.museum | museum | Museum | phrase | — | She works in a museum. | — | museum |
| g2u02.w.to-be-part-of | to be part of | Teil von etw. sein | phrase | — | The jacket was part of a sculpture. | be part of | to be part of ; be part of |
| g2u02.w.sculpture | sculpture | Skulptur | phrase | — | The sculpture is huge. | — | sculpture |
| g2u02.w.to-be-worth | to be worth | wert sein | phrase | — | The sculpture was worth a lot of money. | be worth | to be worth ; be worth |
| g2u02.w.what-s-the-matter | What's the matter? | Was ist los? | phrase | — | What's the matter? You look upset. | — | What's the matter? |
| g2u02.w.anyone | anyone | irgendjemand | phrase | — | Don't give your computer password to anyone. | — | anyone |
| g2u02.w.behaviour | behaviour | Verhalten | phrase | — | There is a lot of wrong behaviour on the web. | — | behaviour |
| g2u02.w.to-contact | to contact | kontaktieren | phrase | — | Please contact us if you have any questions. | contact | to contact ; contact |
| g2u02.w.mess | mess | Unordnung ; Durcheinander | phrase | — | The garden was a mess. | — | mess |
| g2u02.w.to-pass-on | to pass on | weitergeben | phrase | — | Please pass on the message to your mum. | pass on | to pass on ; pass on |
| g2u02.w.password | password | Passwort | phrase | — | Don't give your computer password to other people. | — | password |
| g2u02.w.to-post | to post | posten ; einen Beitrag verfassen (online) | phrase | — | Think before you post something. | post | to post ; post |
| g2u02.w.posting | posting | Posting ; Beitrag (online) | phrase | — | Check who can see your posting. | — | posting |
| g2u02.w.such | such | solch ; so (ein) | phrase | — | He isn't the only one to make such a mistake. | — | such |
| g2u02.w.tip | tip | Hinweis ; Tipp | phrase | — | Here is an important tip for when you go online. | — | tip |
| g2u02.w.possible | possible | möglich | phrase | — | I can't finish all this homework. It's not possible. | — | possible |
| g2u02.w.awesome | awesome | großartig ; beeindruckend | phrase | — | Sport is awesome! | — | awesome |
| g2u02.w.boring | boring | langweilig | phrase | — | This film is very boring. I don't want to watch it any more. | — | boring |
| g2u02.w.confusing | confusing | verwirrend | phrase | — | I don't understand this exercise. It's very confusing. | — | confusing |
| g2u02.w.difficult | difficult | schwierig | phrase | — | I don't think the text is difficult. It's easy. | — | difficult |
| g2u02.w.exciting | exciting | spannend ; aufregend | phrase | — | There's an exciting film on TV this evening. | — | exciting |
| g2u02.w.funny | funny | lustig ; komisch | phrase | — | That was funny. I laughed a lot. | — | funny |
| g2u02.w.embarrassed | embarrassed | verlegen ; beschämt | phrase | — | I was so embarrassed. I didn't know what to say. | — | embarrassed |
| g2u02.w.plate | plate | Teller | phrase | — | The waiter puts the plate down. | — | plate |
| g2u02.w.secret | secret | Geheimnis | phrase | — | Your secret is safe with me. | — | secret |
| g2u02.w.upset | upset | verärgert ; aufgebracht | phrase | — | The little girl looked upset because she couldn't have her favourite toy. | — | upset |
| g2u02.w.to-add | to add | hinzufügen | phrase | — | You should add a good title to the story. | add | to add ; add |
| g2u02.w.to-fail | to fail | scheitern ; durchfallen | phrase | — | I didn't want to fail the test, so I studied very hard. | fail | to fail ; fail |
| g2u02.w.i-promise | I promise. | Ich verspreche es. | phrase | — | I'll help you. I promise. | — | I promise. |
...
- `g2u02.w.to-organise` ← v1 `to organise`: d="To plan and set up something" · s="Let's _____ the party and plan who to invite and what food to buy." · a=["organise","organises","organised","organize","organized"] · mc=["to prepare","to cancel","to attend"]
- `g2u02.w.surprise-party` ← v1 `surprise party`: d="A party that someone does not know about before" · s="We planned a _____ for my sister. She does not know about it yet!" · a=["surprise party","surprise parties"] · mc=["birthday party","fancy dress party","garden party"]
- `g2u02.w.admission-fee` ← v1 `admission fee`: d="The money you pay to go into a place" · s="The _____ for the zoo is five euros — you pay it to get in." · a=["admission fee","admission fees"] · mc=["map","guidebook","snack"]
- `g2u02.w.artist` ← v1 `artist`: d="Someone who makes pictures, music, or other creative things" · s="This painting is beautiful. The _____ is very talented." · a=["artists"] · mc=["musician","writer","actor"]
- `g2u02.w.exhibition` ← v1 `exhibition`: d="A place where people show art or other things" · s="We went to see a photo _____ at the town hall." · a=["exhibitions"] · mc=["museum","concert","gallery"]
- `g2u02.w.dirty` ← v1 `dirty`: d="Not clean" · s="My shoes are very _____ because I played in the mud." · a=[] · mc=["shiny","dusty","clean"]
- `g2u02.w.modern` ← v1 `modern`: d="New and from the time we live in now" · s="Their school is very _____ with big windows and computers." · a=[] · mc=["old","ancient","traditional"]
- `g2u02.w.museum` ← v1 `museum`: d="A building where you can see old or interesting things" · s="We saw old coins and swords at the _____." · a=["museums"] · mc=["gallery","exhibition","library"]
- `g2u02.w.to-be-part-of` ← v1 `to be part of`: d="To belong to something bigger" · s="This song is _____ the new album — it is one of the twelve tracks on it." · a=["be part of","is part of","was part of"] · mc=["separate from","outside of","different from"]
- `g2u02.w.sculpture` ← v1 `sculpture`: d="Art made from stone, wood, or metal that you can walk around" · s="There is a big stone _____ of a horse that an artist made for the park last year." · a=["sculptures"] · mc=["tree","pond","bench"]
- `g2u02.w.to-be-worth` ← v1 `to be worth`: d="To have a price or value" · s="This old painting is _____ a lot of money." · a=["be worth","is worth","was worth"] · mc=["to cost","to pay","to afford"]
- `g2u02.w.what-s-the-matter` ← v1 `What's the matter?`: d="A question you ask when someone looks sad or worried" · s="You look sad. _____? Tell me what is wrong." · a=["What's the matter","What is the matter","Whats the matter"] · mc=["What happened?","How are you?","What do you mean?"]
- `g2u02.w.anyone` ← v1 `anyone`: d="Any person at all" · s="Is _____ at home? I knocked but nobody opened." · a=["anybody"] · mc=["someone","everyone","nobody"]
- `g2u02.w.behaviour` ← v1 `behaviour`: d="How a person acts and what they do" · s="Good _____ in class makes the teacher happy — sitting still, listening, and not talking." · a=["behavior"] · mc=["punishment","noise","trouble"]
- `g2u02.w.to-contact` ← v1 `to contact`: d="To call, write, or send a message to someone" · s="Please _____ me by phone or email if you need help." · a=["contact","contacts","contacted"] · mc=["to ignore","to forget","to avoid"]
- `g2u02.w.mess` ← v1 `mess`: d="When things are not tidy and everywhere" · s="My room is a big _____ with clothes on the floor and toys everywhere. I need to clean it." · a=["messes"] · mc=["surprise","secret","gift"]
- `g2u02.w.to-pass-on` ← v1 `to pass on`: d="To give something to another person" · s="Can you _____ this letter to your mum? I cannot see her today." · a=["pass on","passed on","passes on"] · mc=["to read","to open","to tear up"]
- `g2u02.w.password` ← v1 `password`: d="A secret word you use to open your account" · s="Never tell your _____ to other people — it is secret and protects your account." · a=["passwords"] · mc=["name","address","phone number"]
- `g2u02.w.to-post` ← v1 `to post`: d="To put a message or picture on the internet" · s="She _____ a funny photo on Instagram for all her followers to see, and got many likes." · a=["post","posted","posts"] · mc=["to hide","to delete","to save"]
- `g2u02.w.posting` ← v1 `to post`: d="To put a message or picture on the internet" · s="She _____ a funny photo on Instagram for all her followers to see, and got many likes." · a=["post","posted","posts"] · mc=["to hide","to delete","to save"]
- `g2u02.w.such` ← v1 `such`: d="a word used before a/an + adjective + noun to show emphasis" · s="It was _____ a nice day -- so warm and sunny -- that we went to the lake." · a=[] · mc=["really","very","quite"]
- `g2u02.w.tip` ← v1 `tip`: d="A helpful idea or piece of advice" · s="Here is a good _____ that will help you pass the test: read the questions first before you answer." · a=["tips"] · mc=["prize","result","rule"]
- `g2u02.w.possible` ← v1 `possible`: d="Something that can happen or be done" · s="Is it _____ to finish this homework in ten minutes?" · a=[] · mc=["impossible","probable","certain"]
- `g2u02.w.awesome` ← v1 `awesome`: d="Really great and amazing" · s="The fireworks last night were _____!" · a=[] · mc=["boring","terrible","quiet"]
- `g2u02.w.boring` ← v1 `boring`: d="Not interesting at all" · s="This TV show is so _____. Nothing interesting happens and I want to fall asleep." · a=[] · mc=["exciting","funny","interesting"]
- `g2u02.w.confusing` ← v1 `confusing`: d="Hard to understand" · s="The instructions were very _____ and I made mistakes. Nothing made sense." · a=[] · mc=["clear","simple","easy"]
- `g2u02.w.difficult` ← v1 `difficult`: d="Not easy to do or understand" · s="The last question on the test was really _____. Nobody in the class could answer it." · a=[] · mc=["easy","simple","quick"]
- `g2u02.w.exciting` ← v1 `exciting`: d="Making you feel happy and full of energy" · s="Going on a roller coaster is really _____!" · a=[] · mc=["boring","relaxing","calm"]
- `g2u02.w.funny` ← v1 `funny`: d="Something that makes you laugh" · s="The clown at the party was very _____. He made everyone laugh out loud." · a=["funnier","funniest"] · mc=["sad","scary","serious"]
- `g2u02.w.embarrassed` ← v1 `embarrassed`: d="Feeling bad because you did something silly" · s="I felt so _____ when I fell in front of everyone — my face turned red and I wanted to hide." · a=[] · mc=["proud","brave","confident"]
- `g2u02.w.plate` ← v1 `plate`: d="A flat round thing you put food on" · s="Put the pasta on the _____ and start eating." · a=["plates"] · mc=["bowl","cup","tray"]
- `g2u02.w.secret` ← v1 `secret`: d="Something you do not tell other people" · s="Can you keep a _____? Don't tell anyone — not even your best friend!" · a=["secrets"] · mc=["promise","rule","diary"]
- `g2u02.w.upset` ← v1 `upset`: d="Feeling sad or angry about something bad" · s="She was _____ because someone took her pencil case. Tears came to her eyes." · a=[] · mc=["happy","glad","proud"]
- `g2u02.w.to-add` ← v1 `to add`: d="To put something more to what is already there" · s="You can _____ sugar to your tea if you want to make it sweeter." · a=["add","adds","added"] · mc=["to take away","to throw away","to remove"]
- `g2u02.w.to-fail` ← v1 `to fail`: d="To not pass a test or not do well enough" · s="I studied hard every night because I did not want to _____ the exam and get a bad mark." · a=["fail","fails","failed"] · mc=["to pass","to do","to write"]
- `g2u02.w.i-promise` ← v1 `I promise.`: d="Words you say to show you will do something for sure" · s="I will help you tomorrow. _____ I always keep my word." · a=["I promise"] · mc=["I swear.","Believe me!","Trust me."]
...
Write `content/corpus/units/g2-u02/gen/vocab.draft.json`:
