# Vocab generation brief — g2-u10 (MORE! 2, Unit 10)

<!-- domigo:gen vocab g2-u10 bank=96a3bd6f6117 prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g2u10.w.auntie | auntie | Tantchen | phrase | — | My auntie arrived first. | — | auntie |
| g2u10.w.calm | calm | ruhig ; gelassen | phrase | — | It's difficult for me to stay calm. | — | calm |
| g2u10.w.girlfriend | girlfriend | feste Freundin | phrase | — | My dad has a new girlfriend. | — | girlfriend |
| g2u10.w.to-be-proud-of | to be proud of | stolz sein auf | phrase | — | I'm very proud of myself. | be proud of | to be proud of ; be proud of |
| g2u10.w.sense-of-humour | sense of humour | Sinn für Humor | phrase | — | We've got the same sense of humour. | — | sense of humour |
| g2u10.w.ugly | ugly | hässlich | phrase | — | Your hat's so ugly! | — | ugly |
| g2u10.w.virus | virus | Virus | phrase | — | I've got this virus. | — | virus |
| g2u10.w.to-breathe | to breathe | (ein-)atmen | phrase | — | I like to breathe the clean air in the mountains. | breathe | to breathe ; breathe |
| g2u10.w.to-burn | to burn | (ver-)brennen | phrase | — | You can burn wood on a fire. | burn | to burn ; burn |
| g2u10.w.foreign-language | foreign language | Fremdsprache | phrase | — | She doesn't speak a foreign language. | — | foreign language |
| g2u10.w.to-panic | to panic | in Panik geraten | phrase | — | When you get scared, try not to panic. | panic | to panic ; panic |
| g2u10.w.tractor | tractor | Traktor | phrase | — | The farmer has a big tractor on his farm. | — | tractor |
| g2u10.w.tool | tool | Werkzeug | phrase | — | You use a tool to make or build something. | — | tool |
| g2u10.w.divorced | divorced | geschieden | phrase | — | Rick's parents are divorced. | — | divorced |
| g2u10.w.to-be-related-to | to be related to | mit jdm. verwandt sein | phrase | — | Talk about the people and how they are related to you. | be related to | to be related to ; be related to |
| g2u10.w.to-delete | to delete | löschen | phrase | — | Don't delete the last email I sent you. | delete | to delete ; delete |
| g2u10.w.file | file | Ordner ; Datei | phrase | — | You mustn't go into my private files. | — | file |
| g2u10.w.to-print-out | to print out | ausdrucken | phrase | — | I should print out everything. | print out | to print out ; print out |
| g2u10.w.public | public | öffentlich ; in der Öffentlichkeit | phrase | — | You mustn't shout in public. | — | public |
| g2u10.w.ice-skating | ice skating | Eislaufen | phrase | — | I don't like ice skating. | — | ice skating |
| g2u10.w.fault | fault | Schuld | phrase | — | It's not my fault. | — | fault |
| g2u10.w.hopefully | hopefully | hoffentlich | phrase | — | This was hopefully the last time. | — | hopefully |
...
- `g2u10.w.auntie` ← v1 `auntie`: d="A friendly name for your parent's sister" · s="My _____ always brings me a present when she visits." · a=["aunties","aunty"] · mc=["uncle","cousin","grandmother"]
- `g2u10.w.calm` ← v1 `calm`: d="Quiet and not nervous or angry" · s="The teacher told us to stay _____ and sit down." · a=["calmer","calmest"] · mc=["nervous","angry","loud"]
- `g2u10.w.girlfriend` ← v1 `girlfriend`: d="A girl or woman that someone is dating" · s="My brother's _____ came to our house for dinner." · a=["girlfriends"] · mc=["boyfriend","best friend","classmate"]
- `g2u10.w.to-be-proud-of` ← v1 `to be proud of`: d="To feel very good about what you or someone else did" · s="She was _____ her drawing because it looked great." · a=["be proud of","proud of"] · mc=["to be ashamed of","to be pleased with","to be happy about"]
- `g2u10.w.sense-of-humour` ← v1 `sense of humour`: d="The ability to find things funny and make others laugh" · s="My dad has a great _____. He makes everyone laugh." · a=["sense of humour","sense of humor"] · mc=["sense of style","personality","talent"]
- `g2u10.w.ugly` ← v1 `ugly`: d="Not nice to look at" · s="The old building was grey and _____." · a=["uglier","ugliest"] · mc=["pretty","beautiful","lovely"]
- `g2u10.w.virus` ← v1 `virus`: d="A tiny thing that can make you sick" · s="I caught a _____ and had to stay in bed for three days." · a=["viruses"] · mc=["bacteria","illness","infection"]
- `g2u10.w.to-breathe` ← v1 `to breathe`: d="To take air in and out through your nose or mouth" · s="It is hard to _____ when you run very fast." · a=["breathe","breathes","breathed"] · mc=["to cough","to sneeze","to swallow"]
- `g2u10.w.to-burn` ← v1 `to burn`: d="To make fire, or to get hurt by fire or something hot" · s="We _____ wood to make a warm fire in the garden." · a=["burn","burns","burned","burnt"] · mc=["to freeze","to melt","to boil"]
- `g2u10.w.foreign-language` ← v1 `foreign language`: d="A language that is not the one you speak at home" · s="Learning a _____ can be hard but also a lot of fun." · a=["foreign language","foreign languages"] · mc=["mother tongue","second language","sign language"]
- `g2u10.w.to-panic` ← v1 `to panic`: d="To feel very scared and not know what to do" · s="Don't _____ or start shouting! I will help you find your lost bag — just stay calm." · a=["panic","panics","panicked"] · mc=["to smile","to laugh","to whisper"]
- `g2u10.w.tractor` ← v1 `tractor`: d="A big machine with big wheels that farmers use" · s="The farmer drove his _____ across the field." · a=["tractors"] · mc=["truck","combine","van"]
- `g2u10.w.tool` ← v1 `tool`: d="Something you hold in your hand to build or fix things" · s="A hammer is a _____ you hold in your hand to put nails into wood." · a=["tools"] · mc=["toy","food","game"]
- `g2u10.w.divorced` ← v1 `divorced`: d="When two married people have ended their marriage" · s="His parents are _____ and he lives with his mum." · a=[] · mc=["married","single","separated"]
- `g2u10.w.to-be-related-to` ← v1 `to be related to`: d="To be in the same family as someone" · s="Are you _____ the new boy in class? He has the same last name." · a=["be related to","related to"] · mc=["to be friends with","to belong to","to be connected to"]
- `g2u10.w.to-delete` ← v1 `to delete`: d="To remove something, like a file or message" · s="I _____ the old photos from my phone yesterday. They are gone forever now." · a=["delete","deletes","deleted"] · mc=["to upload","to take","to share"]
- `g2u10.w.file` ← v1 `file`: d="A place on your computer where you keep documents or pictures" · s="I saved my homework in a _____ on the computer." · a=["files"] · mc=["folder","document","app"]
- `g2u10.w.to-print-out` ← v1 `to print out`: d="To make a paper copy of something from the computer" · s="Can you _____ this document for me on paper? I need to read it at the table." · a=["print out","prints out","printed out"] · mc=["to delete","to hide","to throw away"]
- `g2u10.w.public` ← v1 `public`: d="For everyone, not just one person" · s="The library is a _____ place — anyone can go there." · a=[] · mc=["private","personal","secret"]
- `g2u10.w.ice-skating` ← v1 `ice skating`: d="Moving on a frozen surface wearing special shoes with blades" · s="We went _____ at the rink in the city centre." · a=["ice skating"] · mc=["roller-skating","skiing","snowboarding"]
- `g2u10.w.fault` ← v1 `fault`: d="When something bad is because of you" · s="It was my _____ that we were late. I forgot my bag." · a=["faults"] · mc=["mistake","blame","problem"]
- `g2u10.w.hopefully` ← v1 `hopefully`: d="You want this to happen and think it will" · s="_____ it will be sunny for our school trip tomorrow." · a=["hopefully"] · mc=["luckily","unfortunately","probably"]
...
Write `content/corpus/units/g2-u10/gen/vocab.draft.json`:
