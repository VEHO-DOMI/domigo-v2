# Grammar generation brief — g2-u01 (MORE! 2, Unit 1)

<!-- domigo:gen grammar g2-u01 bank=d2d12476b358 prompt=4b9164076103 -->
...
### `g2u01.s.past-simple` — Past simple (revision) (Past simple (Wiederholung))

Revision of the past simple for reporting past events and situations: regular verbs with -ed and the most common irregular forms carried over from grade 1.

v1 floor for this structure: **0 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [use-past-events]: Use the past simple to report events and situations in the past.
  - DE: Mithilfe des Past simple berichtest du über Ereignisse und Situationen in der Vergangenheit.
  - "My family and I had a scary holiday." — "Meine Familie und ich hatten einen gruseligen Urlaub."
  - "Tell me what you did." — "Erzähl mir, was du gemacht hast."
- rule [regular-ed]: Regular verbs form the past simple with -ed.
  - DE: Bei regelmäßigen Verben (regular verbs) hängst du ein -ed an das Verb an.
  - "On Monday, they walked to school." — "Am Montag gingen sie zu Fuß zur Schule."
  - "He picked the snake up." — "Er hob die Schlange auf."
- rule [irregular-forms]: Many verbs have irregular past simple forms that must be learnt: go-went, sit-sat, say-said, have-had, put-put, do-did, swim-swam.
  - DE: Einige Verben haben unregelmäßige Formen im Past simple, die du auswendig lernen musst: go-went, sit-sat, say-said, have-had, put-put, do-did, swim-swam.
  - "We went to Disneyland in Paris." — "Wir fuhren ins Disneyland nach Paris."
  - "I sat down on a stone." — "Ich setzte mich auf einen Stein."
  - "I swam a lot." — "Ich bin viel geschwommen."

common errors:
- Adding -ed to irregular verbs: ✗ "We goed to Disneyland." → ✓ "We went to Disneyland."
- Using the base form instead of the past form: ✗ "Yesterday I swim a lot." → ✓ "Yesterday I swam a lot."

SB box `g2/sb/More 2 SB Unit 1.txt#grammar-1` — ▶️ Present simple (revision):
```
...
### `g2u01.s.present-simple` — Present simple (revision) (Present simple (Wiederholung))

Revision of the present simple for facts, habits and routines, carried over from grade 1.

v1 floor for this structure: **0 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [use-facts-habits]: Use the present simple to talk about facts and habits.
  - DE: Du verwendest das Present simple, um über Tatsachen und Gewohnheiten zu sprechen.
  - "They sleep in the day and hunt at night." — "Sie schlafen am Tag und jagen in der Nacht."
  - "I do my homework after supper." — "Ich mache meine Hausaufgaben nach dem Abendessen."
- rule [third-person-s]: In the third person singular (he/she/it) the verb takes -s.
  - DE: In der 3. Person Einzahl (he/she/it) hängst du ein -s an das Verb an.
  - "The milk snake eats mice and rats." — "Die Milchschlange frisst Mäuse und Ratten."
  - "Our first lesson starts at 7.30 a.m." — "Unsere erste Stunde beginnt um 7:30 Uhr."
- rule [negation-dont]: Form negatives with don't/doesn't + base form of the verb.
  - DE: Die Verneinung bildest du mit don't/doesn't + Grundform des Verbs.
  - "I don't believe you." — "Ich glaube dir nicht."

common errors:
- Missing -s in the third person singular: ✗ "She like dancing." → ✓ "She likes dancing."
...
Write `content/corpus/units/g2-u01/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g2u01.s.past-simple",
