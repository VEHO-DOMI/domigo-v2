# Vocab generation brief — g4-u10 (MORE! 4, Unit 10)

<!-- domigo:gen vocab g4-u10 bank=2e7bd10777c1 prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g4u10.w.oil | oil | Öl | phrase | — | Oil is very precious in our society. | — | oil |
| g4u10.w.fair-trade | Fair Trade | eine Organisation ; die sich für fairen Handel einsetzt | phrase | — | The Fair Trade project gives farmers more money for their products. | — | Fair Trade |
| g4u10.w.farmer | farmer | Landwirt/in | phrase | — | My uncle is a farmer. He owns a farm with cows and horses. | — | farmer |
| g4u10.w.make-a-living | make a living | den Lebensunterhalt verdienen | phrase | — | He made a living by working as a cook. | — | make a living |
| g4u10.w.pay-rise | pay rise | Gehaltserhöhung | phrase | — | She got a pay rise for her good work. | — | pay rise |
| g4u10.w.pesticide | pesticide | Pestizid ; Insektenbekämpfungsmittel | phrase | — | Pesticides are used to stop insects and fungus destroying crops. | — | pesticide |
| g4u10.w.select | select | auswählen | phrase | — | Only the best beans are selected. | — | select |
| g4u10.w.agreement | agreement | Vereinbarung | phrase | — | Fair Trade is an international agreement. | — | agreement |
| g4u10.w.increase | increase | steigen ; erhöhen | phrase | — | The world's population increases each year. | — | increase |
| g4u10.w.rate | rate | Rate | phrase | — | The number of crimes is increasing at an alarming rate. | — | rate |
| g4u10.w.brother-in-law | brother-in-law | Schwager | phrase | — | The man who married my sister is my brother-in-law. | — | brother-in-law |
| g4u10.w.defeat | defeat | besiegen ; überwältigen | phrase | — | He defeated the champion in three sets. | — | defeat |
| g4u10.w.harmony | harmony | Harmonie | phrase | — | Our dream is that all the peoples of the world should live in harmony. | — | harmony |
| g4u10.w.human-being | human being | Mensch | phrase | — | Human beings are the people on this planet Earth. | — | human being |
| g4u10.w.hurtful | hurtful | verletzend | phrase | — | He was horrible. He said some hurtful things. | — | hurtful |
| g4u10.w.ignorance | ignorance | Ignoranz | phrase | — | Their ignorance makes them do stupid things. | — | ignorance |
| g4u10.w.overcome | overcome | besiegen ; überwinden | phrase | — | I want to overcome my fear of flying. | — | overcome |
| g4u10.w.painful | painful | schmerzhaft | phrase | — | I hurt my ankle yesterday. It's still very painful. | — | painful |
| g4u10.w.racism | racism | Rassismus | phrase | — | Martin Luther King Jr. led the anti-racism movement for civil rights in America. | — | racism |
| g4u10.w.racist | racist | rassistisch | phrase | — | He made racist comments about black people. | — | racist |
| g4u10.w.recognition | recognition | Anerkennung ; Bestätigung | phrase | — | She got a lot of recognition for her work. | — | recognition |
| g4u10.w.slavery | slavery | Sklaverei | phrase | — | For two hundred years Africans were sold into slavery in America. | — | slavery |
| g4u10.w.son-in-law | son-in-law | Schwiegersohn | phrase | — | Your son-in-law is your daughter's husband. | — | son-in-law |
| g4u10.w.angry | angry | wütend | phrase | — | The passengers were angry because of the delay. | — | angry |
| g4u10.w.annoy | annoy | verärgern | phrase | — | Don't phone at home. You'll annoy my parents. | — | annoy |
| g4u10.w.helpless | helpless | hilflos | phrase | — | The gang attacked a helpless victim in the park. | — | helpless |
| g4u10.w.hurt | hurt | verletzen | phrase | — | It hurt me to think that he would lie. | — | hurt |
| g4u10.w.misunderstood | misunderstood | missverstanden | phrase | — | No one really believes me. I'm misunderstood by everyone. | — | misunderstood |
| g4u10.w.proud | proud | stolz | phrase | — | She was proud that her daughter had so much talent. | — | proud |
| g4u10.w.shocked | shocked | schockiert | phrase | — | Many people were shocked by the nude scene in the film. | — | shocked |
| g4u10.w.surprised | surprised | überrascht | phrase | — | She looked surprised when I told her the news. | — | surprised |
| g4u10.w.claim | claim | behaupten | phrase | — | She claims she saw an old friend on her train last night. | — | claim |
| g4u10.w.bicycle | bicycle | Fahrrad | phrase | — | "Bike" is the short form of the word "bicycle". | — | bicycle |
| g4u10.w.fairness | fairness | Gerechtigkeit ; Fairness | phrase | — | We think other people should be fair to us, so we should show fairness to them, too. | — | fairness |
| g4u10.w.hell | hell | Hölle | phrase | — | Hell is the opposite of heaven. | — | hell |
| g4u10.w.introduction | introduction | Einleitung | phrase | — | In a short introduction, he explains the background to his book. | — | introduction |
| g4u10.w.pollution | pollution | Verschmutzung | phrase | — | Pollution of the environment is a big problem for everyone. | — | pollution |
...
- `g4u10.w.oil` ← v1 `oil`: d="A thick, dark liquid found underground, used as fuel or for making products" · s="Many countries depend on _____ to run their factories and cars." · a=[] · mc=["gas","coal","fuel"]
- `g4u10.w.fair-trade` ← v1 `Fair Trade`: d="A system that pays farmers and workers in poor countries a just price for their goods" · s="When you buy _____ chocolate, the cocoa farmers get a better price." · a=["fair trade","Fairtrade"] · mc=["free trade","foreign trade","local trade"]
- `g4u10.w.farmer` ← v1 `farmer`: d="A person who owns or works on a farm, growing crops or raising animals" · s="The _____ wakes up early every morning to feed the animals." · a=["farmers"] · mc=["gardener","rancher","merchant"]
- `g4u10.w.make-a-living` ← v1 `make a living`: d="To earn enough money to pay for the things you need in life" · s="It is hard to _____ as a musician because you don't earn enough money to pay the rent." · a=["make a living","living"] · mc=["make a fortune","make a profit","make a deal"]
- `g4u10.w.pay-rise` ← v1 `pay rise`: d="An increase in the amount of money you receive for your work" · s="After working there for two years, she finally asked her boss for a _____." · a=["pay raise"] · mc=["pay cut","bonus","promotion"]
- `g4u10.w.pesticide` ← v1 `pesticide`: d="A chemical substance used to kill insects and other pests that damage crops" · s="Some people prefer organic food because it is grown without _____." · a=["pesticide","pesticides"] · mc=["fertiliser","herbicide","insecticide"]
- `g4u10.w.select` ← v1 `select`: d="To choose someone or something carefully from a group" · s="The coach will _____ the best players for the school team tomorrow." · a=["select","selected"] · mc=["collect","prefer","sort"]
- `g4u10.w.agreement` ← v1 `agreement`: d="An arrangement or decision made between two or more people or groups" · s="The two countries signed an _____ to work together on climate change." · a=["agreements"] · mc=["arrangement","contract","compromise"]
- `g4u10.w.increase` ← v1 `increase`: d="To become larger in amount, number, or level" · s="Temperatures _____ in summer and many people head to the lakes." · a=["increase","increases"] · mc=["improve","expand","rise"]
- `g4u10.w.rate` ← v1 `rate`: d="The speed at which something happens, or the amount compared to something else" · s="The birth _____ in many European countries has been falling for years." · a=["rates"] · mc=["level","percentage","ratio"]
- `g4u10.w.brother-in-law` ← v1 `brother-in-law`: d="The brother of your husband or wife, or the husband of your sister" · s="My sister got married last year, so now I have a _____." · a=["brothers-in-law"] · mc=["father-in-law","son-in-law","stepbrother"]
- `g4u10.w.defeat` ← v1 `defeat`: d="To win against someone in a fight, war, or competition" · s="Our school team managed to _____ last year's champions in the final." · a=["defeat","defeated"] · mc=["beat","destroy","surrender"]
- `g4u10.w.harmony` ← v1 `harmony`: d="A state of peaceful agreement and cooperation" · s="People of different cultures can live together in _____ if they respect each other." · a=[] · mc=["unity","peace","balance"]
- `g4u10.w.human-being` ← v1 `human being`: d="A man, woman, or child; a person" · s="Every _____ deserves to be treated with respect and dignity." · a=["human being","human beings"] · mc=["human race","human nature","human right"]
- `g4u10.w.hurtful` ← v1 `hurtful`: d="Causing emotional pain or upset" · s="She regretted saying those _____ words to her best friend." · a=[] · mc=["harmful","painful","offensive"]
- `g4u10.w.ignorance` ← v1 `ignorance`: d="A lack of knowledge or information about something" · s="His _____ about other cultures sometimes leads to misunderstandings." · a=[] · mc=["innocence","arrogance","carelessness"]
- `g4u10.w.overcome` ← v1 `overcome`: d="To succeed in dealing with a problem or difficulty" · s="She worked hard to _____ her shyness and speak in front of the class." · a=[] · mc=["avoid","endure","conquer"]
- `g4u10.w.painful` ← v1 `painful`: d="Causing physical or emotional pain" · s="The dentist said the treatment might be a little _____." · a=[] · mc=["hurtful","uncomfortable","sore"]
- `g4u10.w.racism` ← v1 `racism`: d="The unfair treatment of people because of their race or ethnic background" · s="Schools should teach students that _____ is wrong and harmful to society." · a=[] · mc=["discrimination","prejudice","bullying"]
- `g4u10.w.racist` ← v1 `racist`: d="Showing hatred or unfair treatment towards people of a different race" · s="The football player was banned for making _____ remarks during the match." · a=[] · mc=["prejudiced","unfair","biased"]
- `g4u10.w.recognition` ← v1 `recognition`: d="The act of being acknowledged or praised for something you have done" · s="The volunteer group received _____ from the mayor for helping after the flood." · a=[] · mc=["reputation","appreciation","attention"]
- `g4u10.w.slavery` ← v1 `slavery`: d="The system of owning people as property and forcing them to work" · s="In the 19th century, many people fought to end _____ in the United States." · a=[] · mc=["poverty","imprisonment","colonialism"]
- `g4u10.w.son-in-law` ← v1 `son-in-law`: d="The husband of your daughter" · s="My parents really like my sister's husband. He is a wonderful _____." · a=["sons-in-law"] · mc=["brother-in-law","father-in-law","stepson"]
- `g4u10.w.angry` ← v1 `angry`: d="Feeling strong displeasure about something unfair or wrong" · s="He gets _____ very easily — even small things make him shout." · a=[] · mc=["furious","annoyed","irritated"]
- `g4u10.w.annoy` ← v1 `annoy`: d="To make someone feel slightly angry or irritated" · s="Please stop tapping your pen — it really starts to _____ me." · a=[] · mc=["bother","disturb","irritate"]
- `g4u10.w.helpless` ← v1 `helpless`: d="Unable to do anything to help yourself or others" · s="Without his glasses, he felt completely _____ and could not read the signs." · a=[] · mc=["hopeless","powerless","useless"]
- `g4u10.w.hurt` ← v1 `hurt`: d="To cause physical or emotional pain to someone" · s="His unkind words really _____ her feelings." · a=[] · mc=["harm","damage","wound"]
- `g4u10.w.misunderstood` ← v1 `misunderstood`: d="Not correctly interpreted or appreciated by other people" · s="She often feels _____ -- people think she is unfriendly, but actually she is just shy." · a=[] · mc=["mistreated","misjudged","misled"]
- `g4u10.w.proud` ← v1 `proud`: d="Feeling pleased and satisfied about something you or someone connected to you has achieved" · s="My parents were very _____ when I won the science competition." · a=[] · mc=["arrogant","confident","pleased"]
- `g4u10.w.shocked` ← v1 `shocked`: d="Very surprised and upset by something unexpected and unpleasant" · s="Everyone was _____ when they heard about the accident on the motorway." · a=[] · mc=["stunned","surprised","frightened"]
- `g4u10.w.surprised` ← v1 `surprised`: d="Feeling amazement because something unexpected happened" · s="I was really _____ to find a birthday cake waiting for me at school." · a=[] · mc=["amazed","confused","impressed"]
- `g4u10.w.claim` ← v1 `claim`: d="To say that something is true, even though it might not be proven" · s="He _____ that he can speak five languages, but nobody believes him because he has never proved it." · a=["claim","claims"] · mc=["argue","insist","state"]
- `g4u10.w.bicycle` ← v1 `bicycle`: d="A vehicle with two wheels that you ride by pushing pedals with your feet" · s="She rides her _____ to school every day because it is faster than the bus." · a=["bicycles","bike"] · mc=["scooter","motorcycle","tricycle"]
- `g4u10.w.fairness` ← v1 `fairness`: d="The quality of treating people equally and in a reasonable way" · s="The referee must always show _____ and treat both teams the same." · a=[] · mc=["justice","equality","honesty"]
- `g4u10.w.hell` ← v1 `hell`: d="In some religions, a place of punishment after death; also used to mean a terrible situation" · s="In many religions, people believe that bad souls are sent to _____." · a=[] · mc=["heaven","purgatory","doom"]
- `g4u10.w.introduction` ← v1 `introduction`: d="The first part of a book, speech, or presentation that explains what it is about" · s="The _____ of her essay explains what the topic is about." · a=["introductions"] · mc=["conclusion","summary","preface"]
- `g4u10.w.pollution` ← v1 `pollution`: d="Damage caused to the environment by harmful substances or waste" · s="Air _____ from cars and factories is a serious problem in many cities." · a=[] · mc=["contamination","emission","radiation"]
...
Write `content/corpus/units/g4-u10/gen/vocab.draft.json`:
