# Vocab generation brief — g3-u11 (MORE! 3, Unit 11)

<!-- domigo:gen vocab g3-u11 bank=d6e86622941b prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g3u11.w.canyon | canyon | Schlucht ; Canyon | wordfile | Places and Sights in Death Valley | — | — | canyon |
| g3u11.w.dirt-road | dirt road | unbefestigte Straße | wordfile | Places and Sights in Death Valley | — | — | dirt road |
| g3u11.w.ridge | ridge | Bergrücken ; Grat | wordfile | Places and Sights in Death Valley | — | — | ridge |
| g3u11.w.headquarters | headquarters (pl) | Hauptquartier | wordfile | Places and Sights in Death Valley | — | — | headquarters |
| g3u11.w.to-spot-sth | to spot sth. | etw. entdecken | wordfile | Places and Sights in Death Valley | — | spot sth. | to spot sth. ; spot sth. |
| g3u11.w.a-dry-place | a dry place | ein trockener Ort | wordfile | Places and Sights in Death Valley | — | — | a dry place |
| g3u11.w.to-have-no-signal | to have no signal | kein Signal haben | wordfile | Places and Sights in Death Valley | — | have no signal | to have no signal ; have no signal |
| g3u11.w.backpack | backpack | Rucksack | wordfile | Places and Sights in Death Valley | — | — | backpack |
| g3u11.w.fabulous | fabulous | fabelhaft | phrase | — | Don't forget our fabulous national parks. | — | fabulous |
| g3u11.w.height | height | Höhe | phrase | — | The giant redwood trees can reach heights of more than 100 m. | — | height |
| g3u11.w.capital | capital | Hauptstadt | phrase | — | Which city is the state capital of California? | — | capital |
| g3u11.w.independent | independent | unabhängig | phrase | — | California was an independent country for one month in 1846. | — | independent |
| g3u11.w.innovation | innovation | Neuerung ; Innovation | phrase | — | California is famous for its innovations. | — | innovation |
| g3u11.w.state | state | Staat | phrase | — | There are about 40 million people living in the state of California. | — | state |
| g3u11.w.to-commute | to commute | pendeln | phrase | — | My mum commuted to the Valley every day. | commute | to commute ; commute |
| g3u11.w.connection | connection | Verbindung | phrase | — | His internet connection was slow. | — | connection |
| g3u11.w.programmer | programmer | Programmierer/Programmiererin | phrase | — | Your mum works as a programmer. | — | programmer |
| g3u11.w.steep | steep | steil | phrase | — | A canyon is deep with steep sides of rock. | — | steep |
| g3u11.w.to-crack | to crack | aufbrechen ; zerbrechen | phrase | — | My mouth was dry and my lips began to crack. | crack | to crack ; crack |
| g3u11.w.four-wheel-drive | four-wheel drive | Allradantrieb | phrase | — | We need a jeep with four-wheel drive in the desert. | — | four-wheel drive |
| g3u11.w.gold-digger | gold digger | Goldgräber/Goldgräberin | phrase | — | Gold diggers were the people trying to find gold. | — | gold digger |
| g3u11.w.gold-rush | gold rush | Goldrausch | phrase | — | The California gold rush began in 1849. | — | gold rush |
| g3u11.w.lip | lip | Lippe | phrase | — | Her lips were shaking and she started to cry. | — | lip |
| g3u11.w.mountain-range | mountain range | Bergkette | phrase | — | The valley is situated between two mountain ranges. | — | mountain range |
| g3u11.w.shade | shade (no pl) | Schatten | phrase | — | I stayed in the shade of a giant rock. | — | shade ; shade no pl |
| g3u11.w.to-be-situated | to be situated | liegen ; sich befinden | phrase | — | Where is Death Valley situated? | be situated | to be situated ; be situated |
| g3u11.w.thirst | thirst | Durst | phrase | — | A group of gold diggers got lost in the valley and died of thirst. | — | thirst |
| g3u11.w.criminal | criminal | Krimineller/Kriminelle | phrase | — | Alcatraz was home to some famous criminals. | — | criminal |
| g3u11.w.cyclist | cyclist | Radfahrer/Radfahrerin | phrase | — | On Sundays, the road is only open to cyclists and roller skaters. | — | cyclist |
| g3u11.w.familiar | familiar | vertraut ; bekannt | phrase | — | The Golden Gate Bridge is one of the most familiar sights of San Francisco. | — | familiar |
| g3u11.w.ferry | ferry | Fähre | phrase | — | You can take a ferry to Alcatraz Island. | — | ferry |
| g3u11.w.guided | guided | geführt ; geleitet | phrase | — | These days you can go on a guided tour to Alcatraz Island. | — | guided |
| g3u11.w.to-take-over | to take over | übernehmen | phrase | — | On Sundays, the cyclists and roller skaters take over the street. | take over | to take over ; take over |
| g3u11.w.to-catch | to catch (the train) | (den Zug) erwischen | phrase | — | They have to go to the platform to catch the train. | catch | to catch ; catch ; to catch the train ; catch the train |
| g3u11.w.information-office | information office | Informationsbüro ; Auskunftsbüro | phrase | — | If you need help, you can ask someone in the information office. | — | information office |
| g3u11.w.railway | railway | Zug ; Eisenbahn | phrase | — | The railway service to Manchester is leaving from platform 3. | — | railway |
| g3u11.w.totally | totally | total | phrase | — | You are totally right about this. | — | totally |
...
- `g3u11.w.canyon` ← v1 `canyon`: d="A deep, narrow valley with steep sides, made by a river" · s="The huge Grand _____ was so incredibly deep that we couldn't see the tiny river at the bottom." · a=["canyons"] · mc=["small ditch","little hole","shallow puddle"]
- `g3u11.w.dirt-road` ← v1 `dirt road`: d="A path made of earth, not covered with tar" · s="The car bumped along the narrow brown _____ through the countryside to the farm — there was no asphalt or tarmac." · a=["dirt road","dirt roads"] · mc=["motorway","highway","city street"]
- `g3u11.w.ridge` ← v1 `ridge`: d="A long, narrow top of a mountain or hill" · s="From the high mountain _____ at the top, we could see down into the deep valleys on both the left and right sides." · a=["ridges"] · mc=["valley floor","cave","basement"]
- `g3u11.w.headquarters` ← v1 `headquarters (pl)`: d="The main office of an organisation" · s="The famous computer company's main _____ is located in sunny Silicon Valley in California, where the CEO and executives work." · a=["headquarters"] · mc=["branch office","factory","warehouse"]
- `g3u11.w.to-spot-sth` ← v1 `to spot sth.`: d="To see or notice something, especially something that is hard to find" · s="She carefully _____ a small brown bird hiding in the green leafy tree that nobody else noticed." · a=["spot","spotted"] · mc=["to overlook","to miss","to fail to see"]
- `g3u11.w.a-dry-place` ← v1 `a dry place`: d="A location with very little rain" · s="You should always store matches in _____ in the cupboard so they don't get wet and fail to light when you need them." · a=["a dry place","dry place"] · mc=["a wet place","a damp place","under water"]
- `g3u11.w.to-have-no-signal` ← v1 `to have no signal`: d="When your device cannot connect because there is no reception" · s="Way up in the mountains we _____ at all, so calling anyone for help was impossible until we hiked back down." · a=["have no signal","had no signal"] · mc=["to have full signal","to have strong reception","to have fast internet"]
- `g3u11.w.backpack` ← v1 `backpack`: d="A bag you carry on your back" · s="Put your water bottle, snacks, and map into your large _____ that you carry on your shoulders during the long hike." · a=["backpacks"] · mc=["handbag","wallet","purse"]
- `g3u11.w.fabulous` ← v1 `fabulous`: d="Wonderful, extremely good" · s="We had a truly _____ time at the beach yesterday — the weather was perfect, the sea was warm, and the sand was clean." · a=[] · mc=["awful","terrible","miserable"]
- `g3u11.w.height` ← v1 `height`: d="How tall something is, measured from bottom to top" · s="The _____ of the new skyscraper building in Vienna is over 50 metres from the ground floor to the top roof." · a=["heights"] · mc=["width","depth","area"]
- `g3u11.w.capital` ← v1 `capital`: d="The most important city of a country or state" · s="Vienna is the _____ of Austria — the most important city where the parliament and government of the country are located." · a=["capitals"] · mc=["village","suburb","countryside"]
- `g3u11.w.independent` ← v1 `independent`: d="Free and not controlled by others" · s="She is very _____ and likes to do everything on her own without asking her parents or friends for help." · a=[] · mc=["dependent","helpless","clingy"]
- `g3u11.w.innovation` ← v1 `innovation`: d="A new idea, method or invention" · s="The invention of the smartphone was a huge technological _____ that completely changed how we communicate and live our lives." · a=["innovations"] · mc=["tradition","repetition","old way"]
- `g3u11.w.state` ← v1 `state`: d="A country, or a part of a country with its own government" · s="California is the largest _____ — an area of land within a country — in the western United States with cities like Los Angeles." · a=["states"] · mc=["city","village","country"]
- `g3u11.w.to-commute` ← v1 `to commute`: d="To travel regularly between home and work" · s="My dad _____ to his office job in the city by train every weekday morning at 7 am and comes home at 6 pm." · a=["commute","commuted","commutes"] · mc=["to stay at home","to work from bed","to walk around the garden"]
- `g3u11.w.connection` ← v1 `connection`: d="A link between two things, or an internet link" · s="The WiFi _____ in the old hotel room was very slow and kept dropping out when we tried to watch videos online." · a=["connections"] · mc=["furniture","view","wallpaper"]
- `g3u11.w.programmer` ← v1 `programmer`: d="A person who writes code for computers" · s="She works as a computer _____ at a big software company, writing code in Python and JavaScript to build websites." · a=["programmers"] · mc=["chef","gardener","teacher"]
- `g3u11.w.steep` ← v1 `steep`: d="Going up or down at a very sharp angle" · s="The mountain hill was too _____ to ride my bike up without getting off and pushing — it was almost vertical in places." · a=[] · mc=["flat","level","gentle"]
- `g3u11.w.to-crack` ← v1 `to crack`: d="To break or split, often with a sharp sound" · s="The frozen ice on the lake started to _____ loudly with sharp snapping noises when the warm spring weather arrived." · a=["crack","cracked"] · mc=["to heal","to repair itself","to stay solid"]
- `g3u11.w.four-wheel-drive` ← v1 `four-wheel drive`: d="A car system where all four wheels get power" · s="You definitely need a tough car with _____ to drive safely on this rough bumpy dirt road through the mountains." · a=["four-wheel drive"] · mc=["one-wheel only","no wheels","two flat tyres"]
- `g3u11.w.gold-digger` ← v1 `gold digger`: d="A person who searches for precious metal in the earth" · s="In the 1800s, thousands of _____ with shovels and pans came to California hoping to find valuable gold in the rivers." · a=["gold digger","gold diggers"] · mc=["farmer","tourist","shopkeeper"]
- `g3u11.w.gold-rush` ← v1 `gold rush`: d="A time when many people hurried to find precious metal" · s="The California _____ brought tens of thousands of people to the American West looking for quick riches in 1849." · a=["gold rush"] · mc=["peace and quiet","slow migration","empty desert"]
- `g3u11.w.lip` ← v1 `lip`: d="One of the two soft parts around your mouth" · s="Her _____ on her mouth were dry, red, and cracked from the freezing cold winter wind outside in January." · a=["lip","lips"] · mc=["ear","nose","eye"]
- `g3u11.w.mountain-range` ← v1 `mountain range`: d="A long line of mountains connected together" · s="The Alps are the largest and longest _____ in Europe, stretching across seven different countries from France to Slovenia." · a=["mountain range","mountain ranges"] · mc=["city","lake","river"]
- `g3u11.w.shade` ← v1 `shade (no pl)`: d="An area that is not in direct sunlight" · s="Let's sit in the cool _____ under that big leafy oak tree — it's far too hot standing in the direct sun today." · a=[] · mc=["direct sun","open field","middle of the road"]
- `g3u11.w.to-be-situated` ← v1 `to be situated`: d="To be in a particular place or position" · s="The new school building _____ very conveniently near the centre of town, just five minutes' walk from the train station." · a=["be situated","situated"] · mc=["to be far from","to be hidden from","to have nothing to do with"]
- `g3u11.w.thirst` ← v1 `thirst`: d="The feeling of needing a drink" · s="After running in the burning hot sun for 30 minutes, my _____ was absolutely terrible — I needed cold water so badly." · a=[] · mc=["hunger","tiredness","boredom"]
- `g3u11.w.criminal` ← v1 `criminal`: d="A person who breaks the law" · s="The _____ who robbed three banks in the city was finally caught by the police after two days of searching." · a=["criminals"] · mc=["police officer","judge","lawyer"]
- `g3u11.w.cyclist` ← v1 `cyclist`: d="A person who rides a bicycle" · s="There is a special painted lane just for _____ with their bicycles along the busy main road to keep them safe from cars." · a=["cyclist","cyclists"] · mc=["car driver","pedestrian","bus passenger"]
- `g3u11.w.familiar` ← v1 `familiar`: d="Well known to you, easy to recognise" · s="This old song on the radio sounds very _____ to me — I think I've definitely heard it somewhere before, maybe at my grandma's house." · a=[] · mc=["completely new","never-before-heard","unknown"]
- `g3u11.w.ferry` ← v1 `ferry`: d="A boat that carries people and cars across water" · s="We took a big _____ boat across the wide lake to the small island on the other side in 20 minutes." · a=["ferries"] · mc=["car","train","bicycle"]
- `g3u11.w.guided` ← v1 `guided`: d="Led by someone who shows you around and explains things" · s="The _____ tour of the old medieval castle with a professional guide explaining every room lasted about one full hour." · a=[] · mc=["self-led","alone","unsupervised"]
- `g3u11.w.to-take-over` ← v1 `to take over`: d="To get control of something" · s="The new teacher from England will _____ our class from next Monday because our old teacher is retiring at the weekend." · a=["take over","took over","taken over"] · mc=["to leave behind","to abandon","to walk away from"]
- `g3u11.w.to-catch` ← v1 `to catch (the train)`: d="To arrive on time to board your bus, tram or plane" · s="We need to hurry to the station right now if we want to _____ the 3:15 pm train to Vienna before it leaves." · a=["catch","caught"] · mc=["to miss","to wave at","to wait for"]
- `g3u11.w.information-office` ← v1 `information office`: d="A place where you can ask for help and directions" · s="Go to the _____ at the train station if you need a free map of the city or timetables for the buses." · a=["information office"] · mc=["lost and found","snack bar","restroom"]
- `g3u11.w.railway` ← v1 `railway`: d="A system of trains and tracks" · s="The _____ station with all the train platforms is just five minutes walking distance from our comfortable hotel." · a=["railways"] · mc=["bus","airport","harbour"]
- `g3u11.w.totally` ← v1 `totally`: d="Completely, 100%" · s="I _____ agree with everything you just said — that's a brilliant idea and we should definitely do it as soon as possible." · a=[] · mc=["partly","barely","slightly"]
...
Write `content/corpus/units/g3-u11/gen/vocab.draft.json`:
