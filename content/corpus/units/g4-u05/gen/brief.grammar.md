# Grammar generation brief — g4-u05 (MORE! 4, Unit 5)

<!-- domigo:gen grammar g4-u05 bank=d475a7bb945f prompt=4b9164076103 -->
...
### `g4u05.s.past-perfect-connectors` — Past perfect with just / after / before (revision) (Past perfect mit just / after / before (Wiederholung))

Revision of the past perfect plus its use with the time connectors after, before and just to put two past events in the right order, and connecting ideas with because, although, however, in order to and so that.

v1 floor for this structure: **40 item(s)** — generate at least that many, ≥3 formats, difficulties 1–3.

- rule [after-had-past-participle]: Use the past perfect for the first event and the past simple for the second. After + subject + had + past participle marks the earlier action.
  - DE: Du verwendest das Past perfect für das erste Ereignis und das Past simple für das zweite. After + Subjekt + had + Partizip Perfekt markiert die frühere Handlung.
  - "After James had eaten the two pizzas, he felt very ill." — "Nachdem James die zwei Pizzen gegessen hatte, fühlte er sich sehr schlecht."
  - "After they had finished dinner, they went for a walk." — "Nachdem sie das Abendessen beendet hatten, gingen sie spazieren."
- rule [just-and-before]: Put just between had and the past participle for an event that happened shortly before another. After before you usually do not need the past perfect, because before already shows the order.
  - DE: Du stellst just zwischen had und das Partizip Perfekt für ein Ereignis, das kurz vor einem anderen geschah. Nach before brauchst du meist kein Past perfect, weil before die Reihenfolge schon zeigt.
  - "Sally had just finished her meal when Tom came home." — "Sally hatte gerade ihr Essen beendet, als Tom nach Hause kam."
  - "My friends had left before I got there." — "Meine Freunde waren gegangen, bevor ich dort ankam."
- rule [connecting-ideas]: Link ideas with connectors: because / because of (cause), although / however (contrast), in order to / so that (purpose).
  - DE: Verknüpfe Gedanken mit Konnektoren: because / because of (Ursache), although / however (Gegensatz), in order to / so that (Absicht).
  - "Children will live shorter lives because of the food they eat." — "Kinder werden wegen des Essens, das sie essen, ein kürzeres Leben haben."
  - "He did a TV programme in order to educate people about food." — "Er machte eine Fernsehsendung, um die Leute über Essen aufzuklären."

common errors:
- Using the past simple instead of the past perfect after 'after': ✗ "After I ate dinner, I went to bed." → ✓ "After I had eaten dinner, I went to bed."
- Putting 'just' in the wrong position: ✗ "I had finished just my meal when she arrived." → ✓ "I had just finished my meal when she arrived."
- Using two contrast connectors together (although ... but): ✗ "Although it was raining, but we went out." → ✓ "Although it was raining, we went out."

SB box `g4/sb/More 4 SB Unit 5.txt#grammar-1` — Past perfect (Revision):
```
...
- `m4-u5-past-perfect-connectors-gf-001` [gap-fill, d1]: p="After she ___ (finish) her homework, she watched TV." c="had finished" a=["had finished"] ds=["finished","has finished","was finishing"]
- `m4-u5-past-perfect-connectors-gf-002` [gap-fill, d2]: p="By the time we arrived, the concert ___ (start)." c="had started" a=["had started","had already started"] ds=["started","has started","was starting"]
- `m4-u5-past-perfect-connectors-gf-003` [gap-fill, d2]: p="Before I ___ (go) to bed, I had brushed my teeth." c="went" a=["went"] ds=["had gone","have gone","was going"]
- `m4-u5-past-perfect-connectors-gf-004` [gap-fill, d3]: p="As soon as the bell ___ (ring), the students ran outside." c="had rung" a=["had rung"] ds=["rang","has rung","rung"]
- `m4-u5-past-perfect-connectors-gf-005` [gap-fill, d4]: p="When I got to the bus stop, the bus ___ already ___ (leave)." c="had ... left" a=["had ... left","had already left"] ds=["has ... left","was ... leaving","did ... leave"]
- `m4-u5-past-perfect-connectors-gf-006` [gap-fill, d3]: p="___ the time the ambulance arrived, the man had recovered." c="By" a=["By"] ds=["At","In","After"]
- `m4-u5-past-perfect-connectors-mc-001` [multiple-choice, d3]: p="You're reading a detective story. Which sentence correctly describes the sequence of events?" c="After they had eaten dinner, they went for a walk." a=["After they had eaten dinner, they went for a walk."] ds=["After they ate dinner, they had gone for a walk.","After they had eaten dinner, they had gone for a walk.","After they have eaten dinner, they went for a walk."]
- `m4-u5-past-perfect-connectors-mc-002` [multiple-choice, d4]: p="Choose the correct sentence:" c="By the time she got home, her family had already had dinner." a=["By the time she got home, her family had already had dinner."] ds=["By the time she had got home, her family already had dinner.","By the time she got home, her family already has dinner.","By the time she gets home, her family had already had dinner."]
- `m4-u5-past-perfect-connectors-mc-003` [multiple-choice, d1]: p="Which connector best completes the sentence? '___ she had read the book, she returned it to the library.'" c="After" a=["After"] ds=["Before","Until","During"]
- `m4-u5-past-perfect-connectors-ec-001` [error-correction, d2]: p="Find and fix the mistake: After he finished the race, he had drunk some water." c="After he had finished the race, he drank some water." a=["After he had finished the race, he drank some water.","After he had finished the race, he drank water.","After he had finished the race he drank some water."] ds=[]
- `m4-u5-past-perfect-connectors-ec-002` [error-correction, d3]: p="Find and fix the mistake: By the time we got there, the shop already closed." c="By the time we got there, the shop had already closed." a=["By the time we got there, the shop had already closed.","By the time we got there the shop had already closed.","By the time we arrived, the shop had already closed."] ds=[]
- `m4-u5-past-perfect-connectors-ec-003` [error-correction, d4]: p="Find and fix the mistake: Before she had left the house, she checked all the windows." c="Before she left the house, she had checked all the windows." a=["Before she left the house, she had checked all the windows.","Before she left the house she had checked all the windows.","She had checked all the windows before she left the house."] ds=[]
- `m4-u5-past-perfect-connectors-tf-001` [transformation, d3]: p="Tell your friend about your evening: 'After I ___ (do) my homework, I ___ (go) out to play football.'" c="had done ... went" a=["had done ... went","had done, went"] ds=[]
- `m4-u5-past-perfect-connectors-tf-002` [transformation, d4]: p="You arrived late to the station. Tell your parents: 'By the time I ___ (get) to the station, the train ___ already ___ (leave).'" c="got ... had already left" a=["got ... had already left","got, had already left"] ds=[]
- `m4-u5-past-perfect-connectors-tf-003` [transformation, d5]: p="Describe what happened after the rain stopped: 'As soon as it ___ (stop) raining, the children ___ (run) outside to play.'" c="had stopped ... ran" a=["had stopped ... ran","had stopped, ran","stopped ... ran"] ds=[]
- `m4-u5-past-perfect-connectors-tr-001` [translation, d2]: p="🇩🇪 Nachdem er gegessen hatte, ging er spazieren." c="After he had eaten, he went for a walk." a=["After he had eaten, he went for a walk.","After he had eaten he went for a walk.","He went for a walk after he had eaten.","After he'd eaten, he went for a walk."] ds=[]
- `m4-u5-past-perfect-connectors-tr-002` [translation, d5]: p="🇩🇪 Als wir ankamen, hatte das Spiel schon begonnen." c="When we arrived, the game had already started." a=["When we arrived, the game had already started.","By the time we arrived, the game had already started.","The game had already started when we arrived.","When we arrived the game had already started."] ds=[]
- `m4-u5-past-perfect-connectors-sb-001` [sentence-building, d2]: p="Put the words in the correct order: left / had / he / after / he / the house / locked / the door" c="After he had locked the door, he left the house." a=["After he had locked the door, he left the house.","After he had locked the door he left the house.","He left the house after he had locked the door."] ds=[]
- `m4-u5-past-perfect-connectors-mt-001` [matching, d3]: p="Match each sentence beginning with its correct ending:" c="{\"1\":\"c\",\"2\":\"d\",\"3\":\"a\",\"4\":\"b\"}" a=["{\"1\":\"c\",\"2\":\"d\",\"3\":\"a\",\"4\":\"b\"}"] ds=["1: After she had packed her bag,|2: By the time the teacher arrived,|3: As soon as it had stopped snowing,|4: Before he went to sleep,","a: we went outside to build a snowman.|b: he had brushed his teeth.|c: she walked to school.|d: the students had already sat down."]
- `m4-u5-past-perfect-connectors-cp-001` [context-picker, d2]: p="Tom did his homework at 4pm. He went to the park at 5pm. Which sentence is correct?" c="After he had done his homework, he went to the park." a=["After he had done his homework, he went to the park."] ds=["After he did his homework, he had gone to the park.","After he has done his homework, he went to the park.","After he was doing his homework, he went to the park."]
- `m4-u5-past-perfect-connectors-gf-007` [gap-fill, d1]: p="After I ___ (eat) breakfast, I left for school." c="had eaten" a=["had eaten"] ds=["ate","have eaten","was eating"]
- `m4-u5-past-perfect-connectors-gf-008` [gap-fill, d2]: p="She didn't recognise him ___ he had changed so much." c="because" a=["because","as"] ds=["although","before","so that"]
- `m4-u5-past-perfect-connectors-gf-009` [gap-fill, d2]: p="___ she had locked the door, she realised her keys were inside." c="After" a=["After"] ds=["Before","Although","While"]
- `m4-u5-past-perfect-connectors-gf-010` [gap-fill, d3]: p="He didn't go to the party ___ he hadn't been invited." c="because" a=["because","as","since"] ds=["although","so","until"]
- `m4-u5-past-perfect-connectors-gf-011` [gap-fill, d4]: p="___ he had saved enough money, he bought a new guitar." c="As soon as" a=["As soon as","Once","When"] ds=["Although","While","So that"]
- `m4-u5-past-perfect-connectors-gf-012` [gap-fill, d5]: p="___ they had checked in at the hotel, they ___ (go) to the beach. They had a great time ___ the weather was beautiful." c="After ... went ... because" a=["After ... went ... because","Once ... went ... because"] ds=["Before ... went ... although","After ... had gone ... because","After ... went ... however"]
- `m4-u5-past-perfect-connectors-mc-004` [multiple-choice, d1]: p="Choose the correct connector: ___ he had done his homework, he played video games." c="After" a=["After"] ds=["While","Although","So that"]
- `m4-u5-past-perfect-connectors-mc-005` [multiple-choice, d3]: p="Which sentence correctly uses 'although' with past perfect?" c="Although he had studied hard, he didn't pass the test." a=["Although he had studied hard, he didn't pass the test."] ds=["Although he had studied hard, he passed the test.","Although he studied hard, he didn't pass the test.","Although he was studying hard, he hadn't passed the test."]
- `m4-u5-past-perfect-connectors-mc-006` [multiple-choice, d4]: p="Choose the correct option: ___ I had never travelled abroad, I was nervous about the flight." c="Since" a=["Since","Because"] ds=["Although","Until","Before"]
- `m4-u5-past-perfect-connectors-ec-004` [error-correction, d2]: p="Find and fix the mistake: After we arrived at the cinema, the film started." c="After we had arrived at the cinema, the film started." a=["After we had arrived at the cinema, the film started.","The film started after we had arrived at the cinema.","After we had arrived, the film started."] ds=[]
- `m4-u5-past-perfect-connectors-ec-005` [error-correction, d3]: p="Find and fix the mistake: She was happy because she has got a good mark." c="She was happy because she had got a good mark." a=["She was happy because she had got a good mark.","She was happy because she had gotten a good mark.","She was happy because she had got a good mark"] ds=[]
- `m4-u5-past-perfect-connectors-ec-006` [error-correction, d5]: p="Find and fix the mistake: Although he had practised every day, but he didn't win the competition." c="Although he had practised every day, he didn't win the competition." a=["Although he had practised every day, he didn't win the competition.","Although he had practised every day, he didn't win the competition","He had practised every day, but he didn't win the competition."] ds=[]
- `m4-u5-past-perfect-connectors-tf-004` [transformation, d3]: p="Two things happened: 1) The rain stopped. 2) We went for a walk. Write one sentence using 'as soon as'." c="As soon as the rain had stopped, we went for a walk." a=["As soon as the rain had stopped, we went for a walk.","We went for a walk as soon as the rain had stopped.","As soon as it had stopped raining, we went for a walk."] ds=[]
- `m4-u5-past-perfect-connectors-tf-005` [transformation, d4]: p="Tom studied very hard. He still failed the exam. This was surprising. Write one sentence using 'although'." c="Although Tom had studied very hard, he still failed the exam." a=["Although Tom had studied very hard, he still failed the exam.","Tom still failed the exam although he had studied very hard.","Although Tom had studied very hard, he failed the exam."] ds=[]
- `m4-u5-past-perfect-connectors-tr-003` [translation, d3]: p="🇩🇪 Bevor sie ins Bett ging, hatte sie ihre Zaehne geputzt." c="Before she went to bed, she had brushed her teeth." a=["Before she went to bed, she had brushed her teeth.","She had brushed her teeth before she went to bed.","Before she went to bed she had brushed her teeth."] ds=[]
- `m4-u5-past-perfect-connectors-tr-004` [translation, d5]: p="🇩🇪 Obwohl er das Buch schon gelesen hatte, schaute er sich trotzdem den Film an." c="Although he had already read the book, he still watched the film." a=["Although he had already read the book, he still watched the film.","Although he had already read the book, he watched the film anyway.","He still watched the film although he had already read the book.","Even though he had already read the book, he still watched the film."] ds=[]
- `m4-u5-past-perfect-connectors-sb-002` [sentence-building, d2]: p="Put the words in the correct order: as / as / the / had / soon / bell / rung / everyone / left / the / classroom" c="As soon as the bell had rung, everyone left the classroom." a=["As soon as the bell had rung, everyone left the classroom.","Everyone left the classroom as soon as the bell had rung.","As soon as the bell had rung everyone left the classroom."] ds=[]
- `m4-u5-past-perfect-connectors-sb-003` [sentence-building, d4]: p="Put the words in the correct order: although / had / they / early / arrived / were / no / there / seats / left" c="Although they had arrived early, there were no seats left." a=["Although they had arrived early, there were no seats left.","Although they had arrived early there were no seats left.","There were no seats left although they had arrived early."] ds=[]
- `m4-u5-past-perfect-connectors-mt-002` [matching, d3]: p="Match each sentence beginning with the correct ending. 1: After the teacher had explained the exercise, 2: Although they had practised all week, 3: Because she hadn't eaten all day, 4: As soon as the match had finished," c="{\"1\":\"c\",\"2\":\"d\",\"3\":\"a\",\"4\":\"b\"}" a=["{\"1\":\"c\",\"2\":\"d\",\"3\":\"a\",\"4\":\"b\"}"] ds=["a: she was very hungry.","b: the players shook hands.","c: the students started working.","d: they still lost the game."]
- `m4-u5-past-perfect-connectors-cp-002` [context-picker, d3]: p="Lisa came to school very late. She missed the first two lessons. She was upset. What happened?" c="She was upset because she had missed the first two lessons." a=["She was upset because she had missed the first two lessons."] ds=["She was upset although she had missed the first two lessons.","She was upset before she had missed the first two lessons.","She was upset so that she had missed the first two lessons."]
...
Write `content/corpus/units/g4-u05/gen/grammar.draft.json`:
...
```jsonc
{
  ...
  "items": [
    {
      "structureId": "g4u05.s.past-perfect-connectors",
