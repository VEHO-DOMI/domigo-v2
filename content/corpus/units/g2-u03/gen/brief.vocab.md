# Vocab generation brief — g2-u03 (MORE! 2, Unit 3)

<!-- domigo:gen vocab g2-u03 bank=6dc22386a63c prompt=346902f9f0f1 -->
...
|---|---|---|---|---|---|---|---|
| g2u03.w.witch | witch | Hexe | wordfile | Halloween | — | — | witch |
| g2u03.w.ghost | ghost | Geist | wordfile | Halloween | — | — | ghost |
| g2u03.w.pumpkin-bucket | pumpkin bucket | Kürbiseimer | wordfile | Halloween | — | — | pumpkin bucket |
| g2u03.w.vampire | vampire | Vampir | wordfile | Halloween | — | — | vampire |
| g2u03.w.trick-or-treat | trick or treat | Süßes oder Saures | wordfile | Halloween | — | — | trick or treat |
| g2u03.w.apple-bobbing | apple bobbing | Äpfeltauchen | wordfile | Halloween | — | — | apple bobbing |
| g2u03.w.mask | mask | Maske | wordfile | Halloween | — | — | mask |
| g2u03.w.tradition | tradition | Tradition | phrase | — | What's your favourite Halloween tradition? | — | tradition |
| g2u03.w.to-fear | to fear | (sich) fürchten (vor) | phrase | — | We do not fear the zombies. | fear | to fear ; fear |
| g2u03.w.to-cut-off | to cut off | abschneiden | phrase | — | We cut off the top of the pumpkin. | cut off | to cut off ; cut off |
| g2u03.w.front-window | front window | Vorderfenster | phrase | — | We put some vampire stickers on his front window. | — | front window |
| g2u03.w.to-keep | to keep | (be-)halten | phrase | — | Let's keep the pumpkin for our Halloween party. | keep | to keep ; keep |
| g2u03.w.to-be-proud | to be proud (of) | stolz sein (auf) | phrase | — | I was very proud. | be proud | to be proud ; be proud ; to be proud of ; be proud of |
| g2u03.w.stairs | stairs | Treppe | phrase | — | We walk up the stairs in the dark. | — | stairs |
| g2u03.w.sticker | sticker | Aufkleber ; Sticker | phrase | — | I put a vampire sticker on his window. | — | sticker |
| g2u03.w.sweets | sweets | Süßigkeiten | phrase | — | Children get sweets for Halloween. | — | sweets |
| g2u03.w.trick-or-treat-2 | Trick or treat! | Süßes oder Saures (Frage beim Halloween-Umzug) | phrase | — | We knock on people's doors and say "Trick or treat!". | — | Trick or treat! |
| g2u03.w.knife | knife (pl knives) | Messer | phrase | — | I need a knife to cut vegetables. | — | knife ; knives |
| g2u03.w.century | century | Jahrhundert | phrase | — | She was dressed like a girl from the 19th century. | — | century |
| g2u03.w.costume | costume | Kostüm | phrase | — | Her costume looks great. She looks like a real vampire. | — | costume |
| g2u03.w.couldn-t | couldn't | konnte/n nicht | phrase | — | Laura couldn't stop. | — | couldn't |
| g2u03.w.cute | cute | niedlich ; süß | phrase | — | Look at my cat. Isn't it cute? | — | cute |
| g2u03.w.dress | dress | Kleid | phrase | — | The dress is beautiful. You can wear it to the party. | — | dress |
| g2u03.w.graveyard | graveyard | Friedhof | phrase | — | The house is next to the graveyard. | — | graveyard |
| g2u03.w.myself | myself | mich selbst ; mir selbst | phrase | — | I often talk to myself. | — | myself |
| g2u03.w.shall | shall | sollen ; wollen | phrase | — | Where shall we go? | — | shall |
| g2u03.w.sick | sick | übel ; krank | phrase | — | I feel a bit sick. I ate too many sweets. | — | sick |
| g2u03.w.superheroine | superheroine | Superheldin | phrase | — | She was dressed up as her favourite superheroine. | — | superheroine |
| g2u03.w.wild | wild | wild | phrase | — | You shouldn't play many wild games. | — | wild |
| g2u03.w.to-scare | to scare | Angst machen ; erschrecken | phrase | — | At Halloween, some costumes really scare me. | scare | to scare ; scare |
| g2u03.w.cycle-helmet | cycle helmet | Fahrradhelm | phrase | — | You should always wear a cycle helmet. | — | cycle helmet |
| g2u03.w.guys | guys | Leute | phrase | — | Come on, guys. Don't look. Promise. | — | guys |
| g2u03.w.to-lose | to lose | verlieren | phrase | — | I don't want to lose my phone. | lose | to lose ; lose |
| g2u03.w.picnic | picnic | Picknick | phrase | — | Let's have a picnic in the park. | — | picnic |
...
- `g2u03.w.witch` ← v1 `witch`: d="A woman in stories who does magic" · s="The _____ flew across the sky on her broom." · a=["witches"] · mc=["wizard","ghost","vampire"]
- `g2u03.w.ghost` ← v1 `ghost`: d="The spirit of a dead person that you can sometimes see" · s="My little brother is afraid of the _____ in this story." · a=["ghosts"] · mc=["vampire","witch","monster"]
- `g2u03.w.pumpkin-bucket` ← v1 `pumpkin bucket`: d="A small container shaped like a pumpkin, used to collect sweets" · s="The children carry a _____ to collect sweets." · a=["pumpkin bucket","pumpkin buckets"] · mc=["trick or treat","candy bag","sweet box"]
- `g2u03.w.vampire` ← v1 `vampire`: d="A creature in stories that comes out at night and drinks blood" · s="He dressed up as a _____ with a long black cape." · a=["vampires"] · mc=["ghost","witch","zombie"]
- `g2u03.w.trick-or-treat` ← v1 `trick or treat`: d="Words children say at doors to get sweets on 31 October" · s="The kids shouted _____ at every house on the street." · a=["trick or treat"] · mc=["apple bobbing","fancy dress party","hide and seek"]
- `g2u03.w.apple-bobbing` ← v1 `apple bobbing`: d="A game where you try to catch fruit in water with your mouth" · s="We tried to catch apples in water with our teeth — that game is called _____." · a=["apple bobbing"] · mc=["trick or treat","treasure hunt","egg and spoon race"]
- `g2u03.w.mask` ← v1 `mask`: d="Something you wear over your face to look different" · s="She wore a scary _____ over her face and nobody could see who she was underneath." · a=["masks"] · mc=["scarf","tie","belt"]
- `g2u03.w.tradition` ← v1 `tradition`: d="Something people do every year because they always did it" · s="Singing carols at Christmas is a nice _____ that families do every year." · a=["traditions"] · mc=["surprise","accident","mistake"]
- `g2u03.w.to-fear` ← v1 `to fear`: d="To be afraid of something" · s="My dog _____ loud noises like thunder — he hides under the bed." · a=["fear","fears","feared"] · mc=["to enjoy","to ignore","to love"]
- `g2u03.w.to-cut-off` ← v1 `to cut off`: d="To remove a piece of something with a sharp tool" · s="Dad _____ the top of the orange vegetable with a big knife." · a=["cut off","cuts off"] · mc=["to cut out","to chop up","to tear off"]
- `g2u03.w.front-window` ← v1 `front window`: d="The glass at the front of a house that you look through" · s="We put candles on the _____ so people outside could see them." · a=["front window","front windows"] · mc=["front door","back door","side window"]
- `g2u03.w.to-keep` ← v1 `to keep`: d="To not give away or throw away" · s="Can I _____ this book forever? I don't want to give it back." · a=["keep","keeps","kept"] · mc=["to borrow","to return","to read"]
- `g2u03.w.stairs` ← v1 `stairs`: d="Steps inside a building that go up or down" · s="I ran up the wooden _____ step by step to my room on the second floor." · a=[] · mc=["floor","wall","door"]
- `g2u03.w.sticker` ← v1 `sticker`: d="A small piece of paper with a picture that you can stick on things" · s="I put a star _____ on my notebook." · a=["stickers"] · mc=["poster","stamp","badge"]
- `g2u03.w.sweets` ← v1 `sweets`: d="Small sugary foods like chocolate or gummy bears" · s="I ate too many _____ and now my tummy hurts." · a=[] · mc=["biscuits","crisps","chocolate"]
- `g2u03.w.trick-or-treat-2` ← v1 `trick or treat`: d="Words children say at doors to get sweets on 31 October" · s="The kids shouted _____ at every house on the street." · a=["trick or treat"] · mc=["apple bobbing","fancy dress party","hide and seek"]
- `g2u03.w.knife` ← v1 `knife (pl knives)`: d="A sharp tool you use to cut food" · s="Be careful with that _____! It is very sharp." · a=["knife","knives"] · mc=["fork","spoon","scissors"]
- `g2u03.w.century` ← v1 `century`: d="A hundred years" · s="We live in the 21st _____. One hundred years ago, people had no phones." · a=["centuries"] · mc=["decade","year","millennium"]
- `g2u03.w.costume` ← v1 `costume`: d="Special clothes you wear to look like someone else" · s="She wore a cat _____ with ears and a tail." · a=["costumes"] · mc=["uniform","mask","dress"]
- `g2u03.w.couldn-t` ← v1 `couldn't`: d="Was not able to" · s="I searched everywhere but I _____ find my keys this morning." · a=["could not"] · mc=["wouldn't","shouldn't","mustn't"]
- `g2u03.w.cute` ← v1 `cute`: d="Pretty and lovely to look at" · s="Look at that tiny puppy! It is so _____ with its small paws and floppy ears." · a=["cuter","cutest"] · mc=["big","ugly","scary"]
- `g2u03.w.dress` ← v1 `dress`: d="A piece of clothing for girls that covers the body and legs" · s="She wore a red _____ to the school dance." · a=["dresses"] · mc=["skirt","blouse","costume"]
- `g2u03.w.graveyard` ← v1 `graveyard`: d="A place where dead people are put under the ground" · s="The old _____ full of tombstones next to the church looks spooky at night." · a=["graveyards"] · mc=["garden","park","playground"]
- `g2u03.w.myself` ← v1 `myself`: d="A word for 'me' when you do something alone" · s="I made this birthday card all by _____." · a=[] · mc=["yourself","himself","herself"]
- `g2u03.w.shall` ← v1 `shall`: d="A word to ask about what to do next" · s="_____ we go to the park or stay at home?" · a=["shall"] · mc=["should","will","could"]
- `g2u03.w.sick` ← v1 `sick`: d="Not feeling well in your body" · s="I feel _____ today. I think I ate something bad and now my stomach hurts." · a=[] · mc=["happy","strong","excited"]
- `g2u03.w.superheroine` ← v1 `superheroine`: d="A strong woman in a story who saves people" · s="My favourite _____ is a brave woman who saves people and can fly." · a=["superheroines"] · mc=["superhero","princess","heroine"]
- `g2u03.w.wild` ← v1 `wild`: d="Not calm or gentle; full of energy" · s="The children were very _____ at the party, jumping everywhere and shouting loudly." · a=["wilder","wildest"] · mc=["quiet","sleepy","polite"]
- `g2u03.w.to-scare` ← v1 `to scare`: d="To make someone feel afraid" · s="My brother likes to hide behind doors and _____ me in the dark." · a=["scare","scares","scared"] · mc=["to help","to call","to wake"]
- `g2u03.w.cycle-helmet` ← v1 `cycle helmet`: d="A hard hat you wear on your head when riding a bike" · s="Always wear your _____ when you ride your bike." · a=["cycle helmet","cycle helmets","bike helmet"] · mc=["hard hat","cap","life jacket"]
- `g2u03.w.guys` ← v1 `guys`: d="A friendly word for a group of people" · s="Hey _____ — Tom, Max, and Jack — do you want to play football after school?" · a=[] · mc=["sir","madam","teacher"]
- `g2u03.w.to-lose` ← v1 `to lose`: d="To not have something any more because you cannot find it" · s="Don't _____ your phone again and leave it somewhere by mistake! Keep it safe in your bag." · a=["lose","loses","lost"] · mc=["to use","to charge","to buy"]
...
Write `content/corpus/units/g2-u03/gen/vocab.draft.json`:
