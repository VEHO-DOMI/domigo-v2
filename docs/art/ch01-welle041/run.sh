...
#    python3 make_ref.py merle_a      /tmp/m/caged0_ref.png   (settle0 the same; caged1 = originals/merle_caged0_edit.png)
...
python3 composite_merle.py originals/merle_settle0_edit.png references/merle_settle0_ref.json merle_a     '{"x0":0,"y0":0,"x1":1,"y1":0.80}'   $O/merle_settle0.png
