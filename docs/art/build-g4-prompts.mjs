...
card("01", "card_ch01", "An assembly in full cheer — three week posters on easels (pure imagery: green Irish hills, Carinthian mountains over a lake, old Vienna roofs); in the foreground Leo's camera screen frames a fourth poster in an office window, and his thumb pauses on the record button.", ["leo", "huber"], W.aula, grade.warm);
...
card("05", "card_ch05", "The schoolyard pizza stand in full swing; Ben mid-review holds a slice like a microphone, delighted; behind him Brandt shakes an adult's hand, and a small sun-over-mountains logo shape sits on the stand's corner (abstract mark, no text).", ["ben", "brandt"], W.yard, grade.warm);
...
card("07", "card_ch07", "The Carinthia file: catalogue pages spread across the studio desk, Leo's finger on the one page that exists; blue evening light, the wall timeline growing behind.", ["leo", "sara"], W.studio, grade.cool);
