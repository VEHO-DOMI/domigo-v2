...
CH06 = ("Our Voice", "Unsere Stimme", link([
    ...
    sc(6, 16, "ben",
       "For the record: I will vote for whichever option has fewer meetings.",
       "Fürs Protokoll: Ich stimme für die Option mit weniger Meetings.",
       [("record", "Protokoll"), ("fewer", "weniger"), ("option", "Option")],
       next_="END"),
])[:])

# ═══════════════════════════════════════════════════════════════════════════
# ch07 · u07 Travelling Down Under — "The Carinthia File" (+ w06 callbacks)
# ═══════════════════════════════════════════════════════════════════════════
CH07 = ("The Carinthia File", "Die Kärnten-Akte", link([
    sc(7, 1, "narrator",
       "The last pitch round: Carinthia. Class 2B opens with a joke from our English book — 'our dream week' — a real didgeridoo and a slideshow of the outback at sunset.",
       "Letzte Pitch-Runde: Kärnten. Die 2B beginnt mit einem Scherz aus unserem Englischbuch — „unsere Traumwoche“ — einem echten Didgeridoo und einer Slideshow vom Outback bei Sonnenuntergang.",
       [("outback", "Outback"), ("sunset", "Sonnenuntergang"), ("slideshow", "Slideshow")]),
    sc(7, 2, "ben",
       "Red earth, ancient stories, spiders the size of my hand. Australia is amazing AND terrifying. Ten out of ten.",
       "Rote Erde, uralte Geschichten, Spinnen so groß wie meine Hand. Australien ist großartig UND furchteinflößend. Zehn von zehn.",
       [("earth", "Erde"), ("ancient", "uralt"), ("spiders", "Spinnen"), ("terrifying", "furchteinflößend"), ("amazing", "großartig")]),
    sc(7, 3, "sara",
       "The joke pitch teaches the real Australia too — the Aborigines' heritage, the walkabout, the land itself telling stories.",
       "Der Scherz-Pitch zeigt auch das echte Australien — das Erbe der Aborigines, den Walkabout, das Land selbst, das Geschichten erzählt.",
       [("heritage", "Erbe"), ("land", "Land"), ("itself", "selbst")],
       slots=[("name-it", "g4u07.w.heritage")]),
    sc(7, 4, "narrator",
       "Then 2B shows Carinthia: mountains, a lake, hiking maps. After the assembly, the crew opens the SunWays catalogue Leo photographed at the pizza stand.",
       "Dann zeigt die 2B Kärnten: Berge, einen See, Wanderkarten. Nach der Versammlung öffnet die Crew den SunWays-Katalog, den Leo am Pizzastand fotografiert hat.",
       [("catalogue", "Katalog"), ("photographed", "fotografiert")]),
    sc(7, 5, "leo",
       "Language week in Dublin: no school package. Project week in Vienna: no school package. Hiking week in Carinthia: 'School Special — train, mountain guides, full service, contact Herr Brandt.'",
       "Sprachwoche in Dublin: kein Schulpaket. Projektwoche in Wien: kein Schulpaket. Wanderwoche in Kärnten: „Schul-Spezial — Zug, Bergführer, Komplettservice, Kontakt Herr Brandt.“",
       [("package", "Paket"), ("contact", "Kontakt"), ("full service", "Komplettservice")]),
    sc(7, 6, "sara",
       "So SunWays can sell only ONE week — and for Carinthia it sells everything: the train, the guides, the beds. The train leaves for Carinthia before anyone votes.",
       "SunWays kann also nur EINE Woche verkaufen — und für Kärnten verkauft es alles: den Zug, die Bergführer, die Betten. Der Zug fährt nach Kärnten, bevor irgendwer abstimmt.",
       [],
    ...
    sc(7, 11, "narrator",
       "Under the fake stars of pitch season, the real question finally has a shape: not which week — whose signature.",
       "Unter den falschen Sternen der Pitch-Saison hat die echte Frage endlich eine Form: nicht welche Woche — wessen Unterschrift.",
...
CH10 = ("The Reason", "Der Grund", link([
    ...
    sc(10, 9, "you",
       "Tomorrow we sit across from him. The file is complete for now. The question is not WHETHER he answers — it is how we hand him the question.",
       "Morgen sitzen wir ihm gegenüber. Die Akte ist fürs Erste vollständig. Die Frage ist nicht, OB er antwortet — sondern wie wir ihm die Frage reichen.",
...
CI_ITEMS = [
    ci("g4u06.ci.the-question.mc.001",
       ...
       ["Which week has the best pizza?", "When does the train leave?", "Who runs the community chat?"],
       [("fake", "fake"), ("vote", "Abstimmung / abstimmen"), ("community", "Community"), ("chat", "Chat")],
    ...
    ci("g4u07.ci.the-package.mc.001",
       ...
       "Only Carinthia has a ready school package.",
       ["All three weeks have school packages.", "The catalogue is eight years old.", "Dublin is the cheapest week."],
       [("catalogue", "Katalog"), ("package", "Paket"), ("ready", "fertig"), ("cheapest", "billigste")],
       "Dublin: nichts. Wien: nichts. Kärnten: „Schul-Spezial — Bergführer, Komplettservice.“",
       "Nur EINE der drei Wochen existiert als fertiges SunWays-Produkt — die Woche in Kärnten war geplant, bevor irgendwer abgestimmt hat."),
    ...
    ci("g4u10.ci.the-reason.mc.001",
       ...
       ["He wants a free week in Carinthia himself.", "Brandt is his old school friend.", "The Direktorin ordered him to sign."],
