...
CH07 = ("The Carinthia File", "Die Kärnten-Akte", link([
    ...
    sc(7, 5, "leo",
       "Dublin: no school package. Vienna: no school package. Carinthia: 'School Special — mountain guides, full service, contact Herr Brandt.'",
       "Dublin: kein Schulpaket. Wien: kein Schulpaket. Kärnten: „Schul-Spezial — Bergführer, Komplettservice, Kontakt Herr Brandt.“",
       [("package", "Paket"), ("contact", "Kontakt"), ("full service", "Komplettservice")]),
    sc(7, 6, "sara",
       "So whichever week wins, the school books through SunWays — but only ONE week has a ready-made product. The train leaves for Carinthia before anyone votes.",
       "Egal welche Woche gewinnt, die Schule bucht über SunWays — aber nur EINE Woche hat ein fertiges Produkt. Der Zug fährt nach Kärnten, bevor irgendwer abstimmt.",
