...
CH03 = ("The Second Pitch", "Der zweite Pitch", [
    ...
    sc(3, 2, "leah",
       ...
       "Ihr Projekt handelt von Helden — und ihr Video beginnt mit einer Geschichte aus unserem Englischbuch: dem Flugzeug auf dem Hudson. Die ganze Aula wird still.",
       [("plane", "Flugzeug"), ("river", "Fluss"), ("silent", "still"), ("hall", "Aula"), ("heroes", "Helden"), ("project", "Projekt")]),
    sc(3, 3, "ben",
