...
CH02 = ("How to Ask Questions", "Wie man Fragen stellt", [
    ...
    sc(2, 6, "you",
       "I write the three words on the studio wall. Under them, one question: who wins if Carinthia wins?",
       "Ich schreibe die drei Wörter an die Studiowand. Darunter eine Frage: Wer gewinnt, wenn Kärnten gewinnt?",
...
# ═══════════════════════════════════════════════════════════════════════════
# ch03 · u03 (book unit: New York, New York) — "The Second Pitch" · Fassung A: the Vienna project-week round; the Hudson landing is 4B's "heroes" project
# The NY pitch retells the Hudson landing (the unit's own story); first anomaly:
# the "random" pitch assignments gave the loudest classes to Carinthia.
# ═══════════════════════════════════════════════════════════════════════════
CH03 = ("The Second Pitch", "Der zweite Pitch", [
    ...
    sc(3, 2, "leah",
       "Their project is about heroes, and the video is GOOD: the plane on the Hudson river. The whole hall goes silent.",
       "Ihr Projekt handelt von Helden, und das Video ist GUT: das Flugzeug auf dem Hudson. Die ganze Aula wird still.",
       [("plane", "Flugzeug"), ("river", "Fluss"), ("silent", "still"), ("hall", "Aula"), ("heroes", "Helden")]),
    sc(3, 3, "ben",
       "An emergency landing on water, and every single person got out. Vienna wins my heart, honestly.",
       "Eine Notlandung auf dem Wasser, und wirklich jeder kam raus. Wien gewinnt mein Herz, ehrlich.",
    ...
    sc(3, 6, "leo",
       "The pitch lists. Every class was given a week — 'randomly', they said. I wrote down who got what.",
       "Die Pitch-Listen. Jede Klasse hat eine Woche bekommen — „zufällig“, hieß es. Ich habe aufgeschrieben, wer was bekommen hat.",
       [("randomly", "zufällig"), ("lists", "Listen"), ("wrote down", "aufgeschrieben")]),
    sc(3, 7, "leo",
       "The three loudest classes, the ones everyone listens to? All three got Carinthia. Random does not look like this.",
       "Die drei lautesten Klassen, auf die alle hören? Alle drei haben Kärnten bekommen. Zufall sieht nicht so aus.",
    ...
    sc(3, 9, "sara",
       "Kevin from 3C told me his class had wanted Dublin. They got Carinthia anyway — 'the list said so.'",
       "Kevin aus der 3C hat mir erzählt, seine Klasse hätte Dublin gewollt. Sie haben trotzdem Kärnten bekommen — „die Liste hat es so gesagt.“",
    ...
    sc(3, 12, "you",
       "I add a line to the wall: the loud classes pitch Carinthia. Somebody planned the noise.",
       "Ich schreibe eine Zeile an die Wand: Die lauten Klassen pitchen Kärnten. Jemand hat den Lärm geplant.",
    ...
    sc(3, 14, "leah",
       "Vienna got my heart today. The list is trying to give it to Carinthia. Let it try.",
       "Wien hat heute mein Herz gewonnen. Die Liste versucht, es Kärnten zu geben. Soll sie es versuchen.",
       [("trying", "versucht")],
       next_="END"),
])
...
CH05 = ("Free Pizza", "Gratis Pizza", [
    ...
    sc(5, 5, "narrator",
       "On the stand, small and polite, a logo: a yellow sun over mountains. SunWays.",
       "Am Stand, klein und höflich, ein Logo: eine gelbe Sonne über Bergen. SunWays.",
       [("polite", "höflich"), ("logo", "Logo"), ("sun", "Sonne")]),
    sc(5, 6, "brandt",
    ...
    sc(5, 10, "leo",
       "Look at the vote posters by the gate. Bottom corner. The sun-and-mountains logo — it had been printed on them all along.",
       "Schaut euch die Abstimmungsplakate beim Tor an. Untere Ecke. Das Sonne-und-Berge-Logo — es war die ganze Zeit daraufgedruckt.",
    ...
    sc(5, 15, "narrator",
       "On the studio wall, the question changes. Not 'who wins if Carinthia wins?' — 'who is MAKING Carinthia win?'",
       "An der Studiowand ändert sich die Frage. Nicht mehr „Wer gewinnt, wenn Kärnten gewinnt?“ — „Wer LÄSST Kärnten gewinnen?“",
       [("changes", "ändert sich")],
...
CI_ITEMS = [
    ci("g4u02.ci.the-method.mc.001",
       ...
       ["Camera, lights, microphone.", "Dublin, Carinthia, Vienna.", "Pizza, poster, printer."],
    ...
    ci("g4u03.ci.the-lists.mc.001",
       ...
       "The loudest classes all got Carinthia.",
       ["Every class got its favourite week.", "The lists were written in English.", "Vienna was not on the lists."],
       [("loudest", "lautesten"), ("lists", "Listen"), ("notice", "bemerken"), ("favourite", "Lieblings-"), ("classes", "Klassen")],
       "Leo hat aufgeschrieben, wer welche Woche bekommen hat — und ein Muster gesehen.",
       "Die drei lautesten Klassen haben alle Kärnten bekommen. Zufall sieht anders aus — das ist das erste Muster der Investigation."),
    ...
    ci("g4u05.ci.the-stand.mc.001",
       ...
       "Schau auf das kleine Logo am Stand: eine Sonne über Bergen.",
