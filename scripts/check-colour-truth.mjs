...
export const READINGS = {
  obj_book: { word: "blue", family: "blue", warmCentre: null,
    why: "Blau mit Gold-Ecken. Gemessen 2026-08-15: blau 74 %, Verhältnis 2,8. Kokis Befund vom 15.08.: »Das Buch ist blau, aber es will rot.« R41s Zielpalette will es rot — das ist AQ12s Auftrag, nicht der der Karte." },
  eraser: { word: "blue", family: "blue", warmCentre: null,
    why: "Blaues Band, cremefarbenes Oberteil. Gemessen: blau 100 %. Karte war schon richtig." },
  ...
  obj_schoolbag: { word: "brown", family: "warm", warmCentre: 35.9,
    why: "SCHWÄCHSTE Lesung der neun: cremefarbener Rucksack mit petrolfarbenem Besatz. Gemessen: warm 66 % / grün 26 %, Verhältnis 2,5 — und 51 % der Fläche fällt als Pergament weg. Das Blatt trägt kein sattes Braun; die Familie stimmt, der Ton ist Kunst-Schuld (D-133, AQ12)." },
  pen: { word: "yellow", family: "warm", warmCentre: 39.1,
    why: "Holzfarbener Körper, oliver Deckel, graue Manschette. Gemessen: warm 88 % / grün 10 %, Mitte 39,1°, Median-Chroma 0,40 (matt), 44 % Pergament. Familie stimmt; ob ein Kind hier »gelb« sagt, ist offen — und das Blatt zeigt ohnehin keine Füllfeder (D-134, AQ12)." },
};
