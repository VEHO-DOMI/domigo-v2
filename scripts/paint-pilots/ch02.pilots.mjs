...
export const PILOTS = {
  ...
  // läuft 5 Stationen (450 Takte) und fragt → GRIFF 2 Voliere c28 (7 Zeilen über dem Dach)
  ...
  p1: {
    ...
    program: [
      ...
      ["walkTo", 15], ["settle"], ["wait", 480],                 // ZUSCHAUEN: 5 Stationen à 90 Takte, dann fragt sie (auto-gelöst)
      ...
      ["walkTo", 50], ["settle"], ["wait", 400],                 // ZUSCHAUEN: 4 Stationen, dann fragt Buddy (auto-gelöst)
