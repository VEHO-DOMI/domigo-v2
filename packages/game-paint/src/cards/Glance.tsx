...
/** welle-041 · THE BACK MARKS. The back used to carry a digit 1–8 (R5-W1 ·
 ...
 *  asks for. One ink colour for all of them: colour IS a task in this book. */
export const CARD_BACK_MARKS: readonly { name: string; d: string }[] = [
  // Sixteen, because a memory card may deal up to eight pairs (content-schema
  // `pairs … .max(8)`): no two backs of one tray ever share a mark. The plain
  // geometric shapes come first — a small tray (ch04's feelings memory deals
  // six) never shows a heart or a tear-like drop beside `happy`/`sad`.
  ...
  { name: "Raute", d: "M12 8.4L16.2 12.8L12 17.2L7.8 12.8Z" },
  { name: "Kreuz", d: "M10.6 8.6h2.8v2.8h2.8v2.8h-2.8v2.8h-2.8v-2.8h-2.8v-2.8h2.8Z" },
  { name: "Ring", d: "M7.9 12.8a4.1 4.1 0 1 0 8.2 0a4.1 4.1 0 1 0 -8.2 0ZM10.1 12.8a1.9 1.9 0 1 0 3.8 0a1.9 1.9 0 1 0 -3.8 0Z" },
  { name: "Sechseck", d: "M16.3 12.8L14.15 16.52H9.85L7.7 12.8L9.85 9.08H14.15Z" },
  { name: "Mond", d: "M14.4 8.7A4.3 4.3 0 1 0 14.4 17.1A5.4 5.4 0 0 1 14.4 8.7Z" },
  { name: "Blatt", d: "M7.6 16.8C7.6 11.2 10.8 8.6 16.4 8.6C16.4 14.2 13.4 16.8 7.6 16.8Z" },
  { name: "Wolke", d: "M8.6 16.2a2.4 2.4 0 0 1 0.2-4.8a3.1 3.1 0 0 1 6-0.6a2.7 2.7 0 0 1 0.9 5.4Z" },
  { name: "Blitz", d: "M13.4 8.2L8.6 13.8H11.6L10.6 17.6L15.4 11.8H12.4Z" },
  { name: "Pfeil", d: "M7.6 11.6H12.2V8.9L16.6 12.8L12.2 16.7V14H7.6Z" },
  { name: "Welle", d: "M7.4 11.9c1.5-1.6 3-1.6 4.6 0s3.1 1.6 4.6 0v2.6c-1.5 1.6-3 1.6-4.6 0s-3.1-1.6-4.6 0Z" },
...
export const cardBackMarkOf = (i: number): { name: string; d: string } => CARD_BACK_MARKS[((i % CARD_BACK_MARKS.length) + CARD_BACK_MARKS.length) % CARD_BACK_MARKS.length]!;
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" role="img"
      ...
      {m === undefined ? (
        ...
        <path d={m.d} fill="#5e4a24" fillRule="evenodd" stroke="#5e4a24" strokeWidth="0.9" strokeLinejoin="round" strokeLinecap="round" />
      )}
    </svg>
  );
};
