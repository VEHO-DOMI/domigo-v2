...
const render = (which: string, karte?: string, empty = false) => renderToStaticMarkup(React.createElement(CardGallery, {
  level, tasks: empty ? [] : tasks, art: { l1_p1_a: "/background.png", l1_p2_a: "/background.png", zookaefig_a15: "/cage.png", zookaefig_a16: "/complete-pass.png", captive_ticket: "/captive-ticket.png" }, Overlay: () => React.createElement("div"), which, karte,
}));
