...
.pb-game-shell[data-mobile="true"] .pb-game-hud{flex:0 0 auto;gap:6px!important;padding:0!important;position:relative;z-index:90;opacity:1;filter:none}
.pb-game-shell[data-mobile="true"] .pb-game-hud>span:first-child{font-size:13px!important;max-width:110px}
.pb-game-shell[data-mobile="true"] .pb-game-hud>span:last-child{gap:4px!important;min-width:0;flex-wrap:nowrap!important;justify-content:flex-start!important;overflow-x:auto;scrollbar-width:thin}
.pb-game-shell[data-mobile="true"] .pb-game-hud>span:last-child>*{flex-shrink:0}
...
.pb-game-shell[data-mobile="true"] .pb-veil{
  position:fixed!important;inset:0!important;top:calc(var(--pb-viewport-top,0px) + var(--pb-hud-space,56px))!important;
  height:calc(var(--pb-viewport-height,100dvh) - var(--pb-hud-space,56px));box-sizing:border-box;z-index:80;
...
@media(max-width:600px){
  .pb-game-shell[data-mobile="true"] .pb-game-hud{flex-direction:column;align-items:stretch!important;gap:2px!important}
  .pb-game-shell[data-mobile="true"] .pb-game-hud>span:first-child{max-width:none;font-size:12px!important}
  .pb-game-shell[data-mobile="true"] .pb-game-hud>span:last-child{padding-bottom:3px}
}
