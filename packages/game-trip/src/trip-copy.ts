...
const FOURTEEN_LIVE: TripCopy = {
  ...
  dayStamp: {
    ...
    "g4.st.fourteen-live.ch07": "Only one week was ever for sale. The file wrote itself.",
    ...
    "g4.st.fourteen-live.ch13": "You told all four layers. Same week, different school — that's the whole story.",
  },
  hubNoun: "Segment",
