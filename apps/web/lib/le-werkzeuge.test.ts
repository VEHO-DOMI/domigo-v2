 ...
 * Fassung 3 vom 2026-09-18: fünf Einträge, nur »veho« ist allein für Lehrkräfte) und hier als
...
describe("Eintragsregeln", () => {
  ...
  it("Titel aus der Liste, Fassung 3 (Kokis Namen 18.09.)", () => {
  ...
  it("nur »live« wird ein Link — »kommt später« und »zieht um« nie", () => {
    ...
    // Fassung 3: veho und konto stehen auf »live«, pup bleibt »kommt später«.
