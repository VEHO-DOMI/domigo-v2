 ...
 * the narrative FLAGS (story-scoped) — still cosmetic: losing it replays with
 * the authored neutral defaults, never losing progress (Law 2). Raises a
 * pause-on-blur veil for classroom tablets (Law 9), like the other clients.
 */
