/**
 * dach-018 / dach-108 · /signin — one button and a bridge for a class code.
 *
 * DomiGo verifies no password of its own (Koki 19.09., E-3): the account at
 * Lauter Einser does the asking. What is left is the button and the bridge for
 * a printed class code, which leads to the join page at konto. No form here
 * takes a PIN, and nothing on this page changes with a date.
 */
...
export default async function SignInPage({
  ...
  // A printed class code still has to lead somewhere: to konto. The list is
  ...
  return (
    <main style={{ maxWidth: 400, margin: "0 auto", padding: "24px 20px 48px", fontFamily: "var(--font-body)", color: "var(--text)" }}>
      ...
      <p style={{ color: "var(--text-secondary)", marginTop: 0 }}>
        DomiGo uses your Lauter Einser account.
      </p>
      {error && (
