 ...
 *
 * dach-074 · main's manager, back as a DATED FALLBACK: app/admin/classes/page.tsx
 * renders it only until the switch-over day (lib/konto/rueckfall.ts). From that
 * day the page renders ClassesManager.tsx — the list with the Lehrer-Raum link —
 * and the four routes this file calls answer 405 anyway.
 */
...
export default function ClassesManagerRueckfall({
  initialClasses,
  initialArchived,
}: {
